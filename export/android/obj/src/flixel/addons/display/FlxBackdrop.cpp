...
bool RepeatY = __o_RepeatY.Default(true);
{
	...
	HX_STACK_LINE(46)
	{
		...
		HX_STACK_LINE(46)
		_g = ::flixel::FlxG_obj::bitmap->addWithSpaces(Graphic,(int)0,(int)0,(int)1,(int)1,Unique,null());
	}
	HX_STACK_LINE(46)
	...
	if ((!(::Std_obj::is(Graphic,hx::ClassOf< ::flixel::util::loaders::TextureRegion >())))){
		HX_STACK_LINE(50)
		int _g1 = this->cachedGraphics->bitmap->get_width();		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(50)
		int _g2 = this->cachedGraphics->bitmap->get_height();		HX_STACK_VAR(_g2,"_g2");
		HX_STACK_LINE(50)
		::flixel::system::layer::Region _g3 = ::flixel::system::layer::Region_obj::__new((int)0,(int)0,_g1,_g2,null(),null(),null(),null());		HX_STACK_VAR(_g3,"_g3");
		HX_STACK_LINE(50)
		this->region = _g3;
		HX_STACK_LINE(51)
		int _g4 = this->cachedGraphics->bitmap->get_width();		HX_STACK_VAR(_g4,"_g4");
		HX_STACK_LINE(51)
		this->region->width = _g4;
		HX_STACK_LINE(52)
		int _g5 = this->cachedGraphics->bitmap->get_height();		HX_STACK_VAR(_g5,"_g5");
		HX_STACK_LINE(52)
		this->region->height = _g5;
	}
	else{
		HX_STACK_LINE(56)
		::flixel::system::layer::Region _g6 = (hx::TCast< flixel::util::loaders::TextureRegion >::cast(Graphic))->region->clone();		HX_STACK_VAR(_g6,"_g6");
		HX_STACK_LINE(56)
		this->region = _g6;
	}
	HX_STACK_LINE(59)
	...
	HX_STACK_LINE(74)
	::openfl::_v2::geom::Point _g7 = ::openfl::_v2::geom::Point_obj::__new(null(),null());		HX_STACK_VAR(_g7,"_g7");
	HX_STACK_LINE(74)
	this->_ppoint = _g7;
	HX_STACK_LINE(76)
		...
		while((true)){
			...
			HX_STACK_LINE(174)
			{
				...
				while((true)){
					...
					HX_STACK_LINE(179)
					currDrawData[_g4] = (this->_ppoint->x + currTileX);
					HX_STACK_LINE(180)
					int _g11 = (currIndex)++;		HX_STACK_VAR(_g11,"_g11");
					HX_STACK_LINE(180)
					currDrawData[_g11] = (this->_ppoint->y + currTileY);
					HX_STACK_LINE(181)
					int _g21 = (currIndex)++;		HX_STACK_VAR(_g21,"_g21");
					HX_STACK_LINE(181)
					currDrawData[_g21] = this->_tileID;
					HX_STACK_LINE(183)
					int _g31 = (currIndex)++;		HX_STACK_VAR(_g31,"_g31");
					HX_STACK_LINE(183)
					currDrawData[_g31] = (int)1;
					HX_STACK_LINE(184)
					int _g41 = (currIndex)++;		HX_STACK_VAR(_g41,"_g41");
					HX_STACK_LINE(184)
					currDrawData[_g41] = (int)0;
					HX_STACK_LINE(185)
					int _g5 = (currIndex)++;		HX_STACK_VAR(_g5,"_g5");
					HX_STACK_LINE(185)
					currDrawData[_g5] = (int)0;
					HX_STACK_LINE(186)
					int _g6 = (currIndex)++;		HX_STACK_VAR(_g6,"_g6");
					HX_STACK_LINE(186)
					currDrawData[_g6] = (int)1;
					HX_STACK_LINE(189)
					int _g7 = (currIndex)++;		HX_STACK_VAR(_g7,"_g7");
					HX_STACK_LINE(189)
					currDrawData[_g7] = 1.0;
				}
			}
			HX_STACK_LINE(192)
