...
{
HX_STACK_FRAME("flixel.ui._FlxVirtualPad.GraphicB","new",0xbd780077,"flixel.ui._FlxVirtualPad.GraphicB.new","openfl/_v2/Assets.hx",1654,0x2846aac8)
HX_STACK_THIS(this)
...
Dynamic fillRGBA = __o_fillRGBA.Default(-1);
{
	...
	HX_STACK_LINE(1722)
	::haxe::io::Bytes _g = ::haxe::Resource_obj::getBytes(::flixel::ui::_FlxVirtualPad::GraphicB_obj::resourceName);		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(1722)
...
{  hx::ObjectPtr< GraphicB_obj > result = new GraphicB_obj();
...
Dynamic GraphicB_obj::__Field(const ::String &inName,bool inCallProp)
{
...
Dynamic GraphicB_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 12:
...
void GraphicB_obj::__GetFields(Array< ::String> &outFields)
{
...
Class GraphicB_obj::__mClass;

void GraphicB_obj::__register()
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("flixel.ui._FlxVirtualPad.GraphicB"), hx::TCanCast< GraphicB_obj> ,sStaticFields,sMemberFields,
...
{
	resourceName= HX_CSTRING("__ASSET__:bitmap_flixel_ui__FlxVirtualPad_GraphicB");
}
