...
::nape::callbacks::CbType CbTypeList_obj::at( int index){
	...
	if (((bool((index < this->zpp_inner->at_index)) || bool((this->zpp_inner->at_ite == null()))))){
		...
		HX_STACK_LINE(374)
		::zpp_nape::util::ZNPNode_ZPP_CbType _g3 = this->zpp_inner->inner->iterator_at(index);		HX_STACK_VAR(_g3,"_g3");
		HX_STACK_LINE(374)
...
{
		HX_STACK_FRAME("nape.callbacks.CbTypeList","clear",0x77ad331c,"nape.callbacks.CbTypeList.clear","nape/callbacks/CbTypeList.hx",618,0x80c6cd9f)
		HX_STACK_THIS(this)
		HX_STACK_LINE(618)
		if ((this->zpp_inner->reverse_flag)){
			HX_STACK_LINE(619)
	...
	HX_STACK_ARG(deep,"deep")
{
		...
		HX_STACK_LINE(664)
		{
			...
			while((true)){
				...
				HX_STACK_LINE(664)
				ret->push((  ((deep)) ? ::nape::callbacks::CbType(null()) : ::nape::callbacks::CbType(i) ));
			}
		}
		HX_STACK_LINE(671)
		return ret;
...
{
		HX_STACK_FRAME("nape.callbacks.CbTypeList","merge",0x35186447,"nape.callbacks.CbTypeList.merge","nape/callbacks/CbTypeList.hx",688,0x80c6cd9f)
		HX_STACK_THIS(this)
		HX_STACK_ARG(xs,"xs")
		HX_STACK_LINE(688)
		::nape::callbacks::CbTypeIterator _g;		HX_STACK_VAR(_g,"_g");
