...
{  hx::ObjectPtr< ListenerIterator_obj > result = new ListenerIterator_obj();
	result->__construct();
	return result;}
...
bool ListenerIterator_obj::hasNext( ){
	...
	{
		HX_STACK_LINE(244)
		::nape::callbacks::ListenerList _this = this->zpp_inner;		HX_STACK_VAR(_this,"_this");
		HX_STACK_LINE(244)
	...
	if (((this->zpp_i < length))){
		...
		{
			HX_STACK_LINE(251)
			this->zpp_next = ::nape::callbacks::ListenerIterator_obj::zpp_pool;
			HX_STACK_LINE(252)
...
::nape::callbacks::ListenerIterator ListenerIterator_obj::get( ::nape::callbacks::ListenerList list){
	...
	HX_STACK_LINE(218)
	::nape::callbacks::ListenerIterator ret;		HX_STACK_VAR(ret,"ret");
	HX_STACK_LINE(218)
	if (((::nape::callbacks::ListenerIterator_obj::zpp_pool == null()))){
		HX_STACK_LINE(219)
		::zpp_nape::util::ZPP_ListenerList_obj::internal = true;
		HX_STACK_LINE(220)
		::nape::callbacks::ListenerIterator ret1 = ::nape::callbacks::ListenerIterator_obj::__new();		HX_STACK_VAR(ret1,"ret1");
		HX_STACK_LINE(221)
		...
		HX_STACK_LINE(225)
		::nape::callbacks::ListenerIterator r = ::nape::callbacks::ListenerIterator_obj::zpp_pool;		HX_STACK_VAR(r,"r");
		HX_STACK_LINE(226)
...
Dynamic ListenerIterator_obj::__Field(const ::String &inName,bool inCallProp)
{
...
Dynamic ListenerIterator_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 5:
		...
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"zpp_pool") ) { zpp_pool=inValue.Cast< ::nape::callbacks::ListenerIterator >(); return inValue; }
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::nape::callbacks::ListenerList*/ ,(int)offsetof(ListenerIterator_obj,zpp_inner),HX_CSTRING("zpp_inner")},
	{hx::fsInt,(int)offsetof(ListenerIterator_obj,zpp_i),HX_CSTRING("zpp_i")},
	{hx::fsBool,(int)offsetof(ListenerIterator_obj,zpp_critical),HX_CSTRING("zpp_critical")},
	{hx::fsObject /*::nape::callbacks::ListenerIterator*/ ,(int)offsetof(ListenerIterator_obj,zpp_next),HX_CSTRING("zpp_next")},
	{ hx::fsUnknown, 0, null()}
};
#endif
...
Class ListenerIterator_obj::__mClass;

void ListenerIterator_obj::__register()
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("nape.callbacks.ListenerIterator"), hx::TCanCast< ListenerIterator_obj> ,sStaticFields,sMemberFields,
