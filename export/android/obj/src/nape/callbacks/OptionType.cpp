...
HX_STACK_ARG(excludes,"excludes")
{
	...
	this->zpp_inner = null();
	HX_STACK_LINE(248)
	::zpp_nape::callbacks::ZPP_OptionType _g = ::zpp_nape::callbacks::ZPP_OptionType_obj::__new();		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(248)
	this->zpp_inner = _g;
	HX_STACK_LINE(249)
...
::String OptionType_obj::toString( ){
	...
	struct _Function_1_1{
		inline static ::nape::callbacks::CbTypeList Block( hx::ObjectPtr< ::nape::callbacks::OptionType_obj > __this){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/callbacks/OptionType.hx",293,0x9382bdc7)
			{
				HX_STACK_LINE(293)
	...
	struct _Function_1_2{
		inline static ::nape::callbacks::CbTypeList Block( hx::ObjectPtr< ::nape::callbacks::OptionType_obj > __this){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/callbacks/OptionType.hx",294,0x9382bdc7)
			{
				HX_STACK_LINE(294)
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::zpp_nape::callbacks::ZPP_OptionType*/ ,(int)offsetof(OptionType_obj,zpp_inner),HX_CSTRING("zpp_inner")},
	{ hx::fsUnknown, 0, null()}
};
#endif
