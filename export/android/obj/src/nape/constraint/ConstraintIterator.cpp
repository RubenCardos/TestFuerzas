...
bool ConstraintIterator_obj::hasNext( ){
	...
	{
		HX_STACK_LINE(244)
		::nape::constraint::ConstraintList _this = this->zpp_inner;		HX_STACK_VAR(_this,"_this");
		HX_STACK_LINE(244)
...
::nape::constraint::ConstraintIterator ConstraintIterator_obj::get( ::nape::constraint::ConstraintList list){
	...
	HX_STACK_LINE(218)
	::nape::constraint::ConstraintIterator ret;		HX_STACK_VAR(ret,"ret");
	HX_STACK_LINE(218)
	if (((::nape::constraint::ConstraintIterator_obj::zpp_pool == null()))){
		HX_STACK_LINE(219)
		::zpp_nape::util::ZPP_ConstraintList_obj::internal = true;
		HX_STACK_LINE(220)
		::nape::constraint::ConstraintIterator ret1 = ::nape::constraint::ConstraintIterator_obj::__new();		HX_STACK_VAR(ret1,"ret1");
		HX_STACK_LINE(221)
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::nape::constraint::ConstraintList*/ ,(int)offsetof(ConstraintIterator_obj,zpp_inner),HX_CSTRING("zpp_inner")},
	{hx::fsInt,(int)offsetof(ConstraintIterator_obj,zpp_i),HX_CSTRING("zpp_i")},
	{hx::fsBool,(int)offsetof(ConstraintIterator_obj,zpp_critical),HX_CSTRING("zpp_critical")},
	{hx::fsObject /*::nape::constraint::ConstraintIterator*/ ,(int)offsetof(ConstraintIterator_obj,zpp_next),HX_CSTRING("zpp_next")},
	{ hx::fsUnknown, 0, null()}
};
#endif
