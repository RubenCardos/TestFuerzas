...
HX_STACK_THIS(this)
{
	...
	this->zpp_inner = null();
	HX_STACK_LINE(696)
	::zpp_nape::util::ZPP_ConstraintList _g = ::zpp_nape::util::ZPP_ConstraintList_obj::__new();		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(696)
	this->zpp_inner = _g;
	HX_STACK_LINE(697)
...
::nape::constraint::Constraint ConstraintList_obj::at( int index){
	...
	if (((bool((index < this->zpp_inner->at_index)) || bool((this->zpp_inner->at_ite == null()))))){
		...
		HX_STACK_LINE(374)
		::zpp_nape::util::ZNPNode_ZPP_Constraint _g3 = this->zpp_inner->inner->iterator_at(index);		HX_STACK_VAR(_g3,"_g3");
		HX_STACK_LINE(374)
	...
	if ((cont)){
		...
		if ((this->zpp_inner->reverse_flag)){
			...
			if (((this->zpp_inner->push_ite == null()))){
				HX_STACK_LINE(428)
				::zpp_nape::util::ZNPNode_ZPP_Constraint _g3;		HX_STACK_VAR(_g3,"_g3");
				HX_STACK_LINE(428)
			...
			HX_STACK_LINE(429)
			::zpp_nape::util::ZNPNode_ZPP_Constraint _g4 = this->zpp_inner->inner->insert(this->zpp_inner->push_ite,obj->zpp_inner);		HX_STACK_VAR(_g4,"_g4");
			HX_STACK_LINE(429)
...
::nape::constraint::Constraint ConstraintList_obj::pop( ){
	...
	if ((this->zpp_inner->reverse_flag)){
		...
		HX_STACK_LINE(498)
		::zpp_nape::util::ZNPNode_ZPP_Constraint ite;		HX_STACK_VAR(ite,"ite");
		HX_STACK_LINE(498)
		if (((_g == (int)1))){
			HX_STACK_LINE(498)
			ite = null();
...
bool ConstraintList_obj::add( ::nape::constraint::Constraint obj){
	HX_STACK_FRAME("nape.constraint.ConstraintList","add",0xe2832719,"nape.constraint.ConstraintList.add","nape/constraint/ConstraintList.hx",564,0x16122b78)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(564)
	if ((this->zpp_inner->reverse_flag)){
...
{
		HX_STACK_FRAME("nape.constraint.ConstraintList","clear",0x1305d485,"nape.constraint.ConstraintList.clear","nape/constraint/ConstraintList.hx",618,0x16122b78)
		HX_STACK_THIS(this)
		HX_STACK_LINE(618)
		if ((this->zpp_inner->reverse_flag)){
			HX_STACK_LINE(619)
	...
	HX_STACK_ARG(deep,"deep")
{
		...
		HX_STACK_LINE(664)
		{
			...
			HX_STACK_LINE(664)
			{
				...
				this->zpp_inner->valmod();
				HX_STACK_LINE(664)
				_g = ::nape::constraint::ConstraintIterator_obj::get(hx::ObjectPtr<OBJ_>(this));
			}
			HX_STACK_LINE(664)
			while((true)){
				struct _Function_3_1{
					inline static bool Block( ::nape::constraint::ConstraintIterator &_g){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/constraint/ConstraintList.hx",664,0x16122b78)
						{
							HX_STACK_LINE(664)
				...
				HX_STACK_LINE(664)
				::nape::constraint::Constraint i;		HX_STACK_VAR(i,"i");
				HX_STACK_LINE(664)
				{
					HX_STACK_LINE(664)
				...
				HX_STACK_LINE(664)
				ret->push((  ((deep)) ? ::nape::constraint::Constraint(null()) : ::nape::constraint::Constraint(i) ));
			}
		}
		HX_STACK_LINE(671)
		return ret;
...
{
		HX_STACK_FRAME("nape.constraint.ConstraintList","merge",0xd07105b0,"nape.constraint.ConstraintList.merge","nape/constraint/ConstraintList.hx",688,0x16122b78)
		HX_STACK_THIS(this)
		HX_STACK_ARG(xs,"xs")
		HX_STACK_LINE(688)
		::nape::constraint::ConstraintIterator _g;		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(688)
		{
			...
			xs->zpp_inner->valmod();
			HX_STACK_LINE(688)
			_g = ::nape::constraint::ConstraintIterator_obj::get(xs);
		}
		HX_STACK_LINE(688)
		while((true)){
			struct _Function_2_1{
				inline static bool Block( ::nape::constraint::ConstraintIterator &_g){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/constraint/ConstraintList.hx",688,0x16122b78)
					{
						HX_STACK_LINE(688)
						_g->zpp_inner->zpp_inner->valmod();
						HX_STACK_LINE(688)
			...
			HX_STACK_LINE(688)
			::nape::constraint::Constraint x;		HX_STACK_VAR(x,"x");
			HX_STACK_LINE(688)
			{
				HX_STACK_LINE(688)
				_g->zpp_critical = false;
...
::String ConstraintList_obj::toString( ){
	...
	HX_STACK_LINE(705)
	{
		...
		while((true)){
			struct _Function_3_1{
				inline static bool Block( ::nape::constraint::ConstraintIterator &_g){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/constraint/ConstraintList.hx",705,0x16122b78)
					{
						HX_STACK_LINE(705)
						_g->zpp_inner->zpp_inner->valmod();
						HX_STACK_LINE(705)
...
::nape::constraint::ConstraintList ConstraintList_obj::foreach( Dynamic lambda){
	...
	HX_STACK_LINE(736)
	::nape::constraint::ConstraintIterator it;		HX_STACK_VAR(it,"it");
	HX_STACK_LINE(736)
	{
		HX_STACK_LINE(736)
		this->zpp_inner->valmod();
		HX_STACK_LINE(736)
		it = ::nape::constraint::ConstraintIterator_obj::get(hx::ObjectPtr<OBJ_>(this));
	}
	HX_STACK_LINE(737)
	while((true)){
		struct _Function_2_1{
			inline static bool Block( ::nape::constraint::ConstraintIterator &it){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/constraint/ConstraintList.hx",737,0x16122b78)
				{
					HX_STACK_LINE(737)
		...
		{
			HX_STACK_LINE(739)
			::nape::constraint::Constraint _g1;		HX_STACK_VAR(_g1,"_g1");
			HX_STACK_LINE(739)
			{
				HX_STACK_LINE(739)
...
::nape::constraint::ConstraintList ConstraintList_obj::fromArray( Array< ::Dynamic > array){
	...
	HX_STACK_LINE(311)
	{
		...
		while((true)){
			...
			HX_STACK_LINE(311)
			::nape::constraint::Constraint i = array->__get(_g).StaticCast< ::nape::constraint::Constraint >();		HX_STACK_VAR(i,"i");
			HX_STACK_LINE(311)
			++(_g);
			HX_STACK_LINE(316)
			ret->push(i);
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::zpp_nape::util::ZPP_ConstraintList*/ ,(int)offsetof(ConstraintList_obj,zpp_inner),HX_CSTRING("zpp_inner")},
	{ hx::fsUnknown, 0, null()}
};
#endif
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("nape.constraint.ConstraintList"), hx::TCanCast< ConstraintList_obj> ,sStaticFields,sMemberFields,
