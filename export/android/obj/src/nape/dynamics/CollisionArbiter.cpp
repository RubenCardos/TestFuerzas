...
Float CollisionArbiter_obj::get_radius( ){
	HX_STACK_FRAME("nape.dynamics.CollisionArbiter","get_radius",0xb577fb5e,"nape.dynamics.CollisionArbiter.get_radius","nape/dynamics/CollisionArbiter.hx",217,0xb8178f73)
	HX_STACK_THIS(this)
	HX_STACK_LINE(217)
...
::nape::shape::Edge CollisionArbiter_obj::get_referenceEdge1( ){
	...
	HX_STACK_LINE(230)
	if (((bool((edge != null())) && bool(((bool(!(((((  (((this->zpp_inner->ws1->id > this->zpp_inner->ws2->id))) ? ::nape::shape::Shape(this->zpp_inner->ws2->outer) : ::nape::shape::Shape(this->zpp_inner->ws1->outer) ))->zpp_inner->type == ::zpp_nape::util::ZPP_Flags_obj::id_ShapeType_POLYGON)))) || bool((((  (((this->zpp_inner->ws1->id > this->zpp_inner->ws2->id))) ? ::nape::shape::Shape(this->zpp_inner->ws2->outer) : ::nape::shape::Shape(this->zpp_inner->ws1->outer) ))->zpp_inner != edge->polygon)))))))){
		HX_STACK_LINE(230)
...
::nape::shape::Edge CollisionArbiter_obj::get_referenceEdge2( ){
	...
	::zpp_nape::shape::ZPP_Edge edge = this->zpp_inner->colarb->__ref_edge1;		HX_STACK_VAR(edge,"edge");
	HX_STACK_LINE(244)
	if (((bool((edge != null())) && bool(((bool(!(((((  (((this->zpp_inner->ws1->id > this->zpp_inner->ws2->id))) ? ::nape::shape::Shape(this->zpp_inner->ws1->outer) : ::nape::shape::Shape(this->zpp_inner->ws2->outer) ))->zpp_inner->type == ::zpp_nape::util::ZPP_Flags_obj::id_ShapeType_POLYGON)))) || bool((((  (((this->zpp_inner->ws1->id > this->zpp_inner->ws2->id))) ? ::nape::shape::Shape(this->zpp_inner->ws1->outer) : ::nape::shape::Shape(this->zpp_inner->ws2->outer) ))->zpp_inner != edge->polygon)))))))){
		HX_STACK_LINE(244)
		edge = this->zpp_inner->colarb->__ref_edge2;
	}
	HX_STACK_LINE(245)
			...
			if (((bool(!(freshOnly)) || bool(colarb->oc2->fresh)))){
				...
				HX_STACK_LINE(353)
				{
					...
					HX_STACK_LINE(355)
					{
						...
						HX_STACK_LINE(365)
						Float _g7 = (_g6 * t1);		HX_STACK_VAR(_g7,"_g7");
						HX_STACK_LINE(365)
						hx::AddEq(retx,_g7);
						HX_STACK_LINE(366)
