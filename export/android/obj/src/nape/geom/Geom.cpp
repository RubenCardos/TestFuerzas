					...
					if (((best < 1e100))){
						...
						if (((best >= (int)0))){
							...
							if (((d1 < e1))){
								...
								HX_STACK_LINE(337)
								Float _g1 = ::Math_obj::sqrt(d1);		HX_STACK_VAR(_g1,"_g1");
								HX_STACK_LINE(337)
								best = _g1;
							}
							else{
								...
								HX_STACK_LINE(337)
								Float _g2 = ::Math_obj::sqrt(e1);		HX_STACK_VAR(_g2,"_g2");
								HX_STACK_LINE(337)
								best = _g2;
							}
							HX_STACK_LINE(337)
...
bool Geom_obj::intersectsBody( ::nape::phys::Body body1,::nape::phys::Body body2){
	...
	struct _Function_1_1{
		inline static bool Block( ::nape::phys::Body &body1,::nape::phys::Body &body2){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/geom/Geom.hx",390,0xa217fc96)
			{
				HX_STACK_LINE(390)
	...
	HX_STACK_LINE(390)
	if ((!(_Function_1_1::Block(body1,body2)))){
		HX_STACK_LINE(391)
		return false;
	}
	else{
...
bool Geom_obj::intersects( ::nape::shape::Shape shape1,::nape::shape::Shape shape2){
	...
	struct _Function_1_1{
		inline static bool Block( ::nape::shape::Shape &shape1,::nape::shape::Shape &shape2){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/geom/Geom.hx",441,0xa217fc96)
			{
				HX_STACK_LINE(441)
	...
	HX_STACK_LINE(441)
	if ((_Function_1_1::Block(shape1,shape2))){
		HX_STACK_LINE(441)
		return ::zpp_nape::geom::ZPP_Collide_obj::testCollide_safe(shape1->zpp_inner,shape2->zpp_inner);
	}
	else{
		HX_STACK_LINE(441)
		return false;
