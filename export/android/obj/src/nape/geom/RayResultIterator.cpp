...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::nape::geom::RayResultList*/ ,(int)offsetof(RayResultIterator_obj,zpp_inner),HX_CSTRING("zpp_inner")},
	{hx::fsInt,(int)offsetof(RayResultIterator_obj,zpp_i),HX_CSTRING("zpp_i")},
	{hx::fsBool,(int)offsetof(RayResultIterator_obj,zpp_critical),HX_CSTRING("zpp_critical")},
	{hx::fsObject /*::nape::geom::RayResultIterator*/ ,(int)offsetof(RayResultIterator_obj,zpp_next),HX_CSTRING("zpp_next")},
	{ hx::fsUnknown, 0, null()}
};
#endif
