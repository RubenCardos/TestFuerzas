...
HX_STACK_THIS(this)
{
	...
	this->zpp_inner = null();
	HX_STACK_LINE(696)
	::zpp_nape::util::ZPP_BodyList _g = ::zpp_nape::util::ZPP_BodyList_obj::__new();		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(696)
	this->zpp_inner = _g;
	HX_STACK_LINE(697)
...
{  hx::ObjectPtr< BodyList_obj > result = new BodyList_obj();
	result->__construct();
	return result;}
...
::nape::phys::Body BodyList_obj::at( int index){
	...
	if (((bool((index < this->zpp_inner->at_index)) || bool((this->zpp_inner->at_ite == null()))))){
		...
		HX_STACK_LINE(374)
		::zpp_nape::util::ZNPNode_ZPP_Body _g3 = this->zpp_inner->inner->iterator_at(index);		HX_STACK_VAR(_g3,"_g3");
		HX_STACK_LINE(374)
	...
	if ((cont)){
		...
		if ((this->zpp_inner->reverse_flag)){
			...
			if (((this->zpp_inner->push_ite == null()))){
				HX_STACK_LINE(428)
				::zpp_nape::util::ZNPNode_ZPP_Body _g3;		HX_STACK_VAR(_g3,"_g3");
				HX_STACK_LINE(428)
			...
			HX_STACK_LINE(429)
			::zpp_nape::util::ZNPNode_ZPP_Body _g4 = this->zpp_inner->inner->insert(this->zpp_inner->push_ite,obj->zpp_inner);		HX_STACK_VAR(_g4,"_g4");
			HX_STACK_LINE(429)
...
::nape::phys::Body BodyList_obj::pop( ){
	...
	if ((this->zpp_inner->reverse_flag)){
		...
		HX_STACK_LINE(498)
		::zpp_nape::util::ZNPNode_ZPP_Body ite;		HX_STACK_VAR(ite,"ite");
		HX_STACK_LINE(498)
		if (((_g == (int)1))){
			HX_STACK_LINE(498)
			ite = null();
...
bool BodyList_obj::add( ::nape::phys::Body obj){
	HX_STACK_FRAME("nape.phys.BodyList","add",0x73d52e09,"nape.phys.BodyList.add","nape/phys/BodyList.hx",564,0x9d0a53c8)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(564)
	if ((this->zpp_inner->reverse_flag)){
...
bool BodyList_obj::remove( ::nape::phys::Body obj){
	...
	HX_STACK_LINE(585)
	{
		...
		{
			HX_STACK_LINE(588)
			::zpp_nape::util::ZNPNode_ZPP_Body cx_ite = this->zpp_inner->inner->head;		HX_STACK_VAR(cx_ite,"cx_ite");
			HX_STACK_LINE(589)
			while((true)){
				HX_STACK_LINE(589)
				if ((!(((cx_ite != null()))))){
...
{
		HX_STACK_FRAME("nape.phys.BodyList","clear",0x221b7775,"nape.phys.BodyList.clear","nape/phys/BodyList.hx",618,0x9d0a53c8)
		HX_STACK_THIS(this)
		HX_STACK_LINE(618)
		if ((this->zpp_inner->reverse_flag)){
			HX_STACK_LINE(619)
...
::nape::phys::BodyIterator BodyList_obj::iterator( ){
	...
	this->zpp_inner->valmod();
	HX_STACK_LINE(651)
	return ::nape::phys::BodyIterator_obj::get(hx::ObjectPtr<OBJ_>(this));
}
	...
	HX_STACK_ARG(deep,"deep")
{
		...
		HX_STACK_LINE(664)
		{
			...
			HX_STACK_LINE(664)
			{
				...
				this->zpp_inner->valmod();
				HX_STACK_LINE(664)
				_g = ::nape::phys::BodyIterator_obj::get(hx::ObjectPtr<OBJ_>(this));
			}
			HX_STACK_LINE(664)
			while((true)){
				struct _Function_3_1{
					inline static bool Block( ::nape::phys::BodyIterator &_g){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/phys/BodyList.hx",664,0x9d0a53c8)
						{
							HX_STACK_LINE(664)
				...
				HX_STACK_LINE(664)
				::nape::phys::Body i;		HX_STACK_VAR(i,"i");
				HX_STACK_LINE(664)
				{
					HX_STACK_LINE(664)
				...
				HX_STACK_LINE(664)
				ret->push((  ((deep)) ? ::nape::phys::Body(null()) : ::nape::phys::Body(i) ));
			}
		}
		HX_STACK_LINE(671)
		return ret;
...
Void BodyList_obj::merge( ::nape::phys::BodyList xs){
{
		...
		HX_STACK_LINE(688)
		{
			...
			xs->zpp_inner->valmod();
			HX_STACK_LINE(688)
			_g = ::nape::phys::BodyIterator_obj::get(xs);
		}
		HX_STACK_LINE(688)
		while((true)){
			struct _Function_2_1{
				inline static bool Block( ::nape::phys::BodyIterator &_g){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/phys/BodyList.hx",688,0x9d0a53c8)
					{
						HX_STACK_LINE(688)
						_g->zpp_inner->zpp_inner->valmod();
						HX_STACK_LINE(688)
			...
			HX_STACK_LINE(688)
			::nape::phys::Body x;		HX_STACK_VAR(x,"x");
			HX_STACK_LINE(688)
			{
				HX_STACK_LINE(688)
				_g->zpp_critical = false;
...
::String BodyList_obj::toString( ){
	...
	HX_STACK_LINE(705)
	{
		...
		while((true)){
			struct _Function_3_1{
				inline static bool Block( ::nape::phys::BodyIterator &_g){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/phys/BodyList.hx",705,0x9d0a53c8)
					{
						HX_STACK_LINE(705)
						_g->zpp_inner->zpp_inner->valmod();
						HX_STACK_LINE(705)
...
::nape::phys::BodyList BodyList_obj::foreach( Dynamic lambda){
	...
	HX_STACK_LINE(736)
	::nape::phys::BodyIterator it;		HX_STACK_VAR(it,"it");
	HX_STACK_LINE(736)
	{
		HX_STACK_LINE(736)
		this->zpp_inner->valmod();
		HX_STACK_LINE(736)
		it = ::nape::phys::BodyIterator_obj::get(hx::ObjectPtr<OBJ_>(this));
	}
	HX_STACK_LINE(737)
	while((true)){
		struct _Function_2_1{
			inline static bool Block( ::nape::phys::BodyIterator &it){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/phys/BodyList.hx",737,0x9d0a53c8)
				{
					HX_STACK_LINE(737)
...
::nape::phys::BodyList BodyList_obj::filter( Dynamic lambda){
	...
	while((true)){
		...
		HX_STACK_LINE(785)
		::nape::phys::Body x = this->at(i);		HX_STACK_VAR(x,"x");
		HX_STACK_LINE(786)
		try
		{
		HX_STACK_CATCHABLE(Dynamic, 0);
...
::nape::phys::BodyList BodyList_obj::fromArray( Array< ::Dynamic > array){
	...
	HX_STACK_LINE(311)
	{
		...
		while((true)){
			...
			HX_STACK_LINE(311)
			::nape::phys::Body i = array->__get(_g).StaticCast< ::nape::phys::Body >();		HX_STACK_VAR(i,"i");
			HX_STACK_LINE(311)
			++(_g);
			HX_STACK_LINE(316)
			ret->push(i);
...
Dynamic BodyList_obj::__Field(const ::String &inName,bool inCallProp)
{
...
Dynamic BodyList_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 9:
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::zpp_nape::util::ZPP_BodyList*/ ,(int)offsetof(BodyList_obj,zpp_inner),HX_CSTRING("zpp_inner")},
	{ hx::fsUnknown, 0, null()}
};
#endif
...
Class BodyList_obj::__mClass;

void BodyList_obj::__register()
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("nape.phys.BodyList"), hx::TCanCast< BodyList_obj> ,sStaticFields,sMemberFields,
