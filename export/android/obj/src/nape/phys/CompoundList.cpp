...
::nape::phys::Compound CompoundList_obj::at( int index){
	...
	if (((bool((index < this->zpp_inner->at_index)) || bool((this->zpp_inner->at_ite == null()))))){
		...
		HX_STACK_LINE(374)
		::zpp_nape::util::ZNPNode_ZPP_Compound _g3 = this->zpp_inner->inner->iterator_at(index);		HX_STACK_VAR(_g3,"_g3");
		HX_STACK_LINE(374)
...
{
		HX_STACK_FRAME("nape.phys.CompoundList","clear",0xf5d5887e,"nape.phys.CompoundList.clear","nape/phys/CompoundList.hx",618,0xaf0f831f)
		HX_STACK_THIS(this)
		HX_STACK_LINE(618)
		if ((this->zpp_inner->reverse_flag)){
			HX_STACK_LINE(619)
	...
	HX_STACK_ARG(deep,"deep")
{
		...
		HX_STACK_LINE(664)
		{
			...
			while((true)){
				...
				HX_STACK_LINE(664)
				ret->push((  ((deep)) ? ::nape::phys::Compound(null()) : ::nape::phys::Compound(i) ));
			}
		}
		HX_STACK_LINE(671)
		return ret;
...
{
		HX_STACK_FRAME("nape.phys.CompoundList","merge",0xb340b9a9,"nape.phys.CompoundList.merge","nape/phys/CompoundList.hx",688,0xaf0f831f)
		HX_STACK_THIS(this)
		HX_STACK_ARG(xs,"xs")
		HX_STACK_LINE(688)
		::nape::phys::CompoundIterator _g;		HX_STACK_VAR(_g,"_g");
