...
HX_STACK_THIS(this)
{
	...
	this->zpp_inner = null();
	HX_STACK_LINE(696)
	::zpp_nape::util::ZPP_InteractorList _g = ::zpp_nape::util::ZPP_InteractorList_obj::__new();		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(696)
	this->zpp_inner = _g;
	HX_STACK_LINE(697)
...
::nape::phys::Interactor InteractorList_obj::at( int index){
	...
	if (((bool((index < this->zpp_inner->at_index)) || bool((this->zpp_inner->at_ite == null()))))){
		...
		HX_STACK_LINE(374)
		::zpp_nape::util::ZNPNode_ZPP_Interactor _g3 = this->zpp_inner->inner->iterator_at(index);		HX_STACK_VAR(_g3,"_g3");
		HX_STACK_LINE(374)
	...
	if ((cont)){
		...
		if ((this->zpp_inner->reverse_flag)){
			...
			if (((this->zpp_inner->push_ite == null()))){
				HX_STACK_LINE(428)
				::zpp_nape::util::ZNPNode_ZPP_Interactor _g3;		HX_STACK_VAR(_g3,"_g3");
				HX_STACK_LINE(428)
			...
			HX_STACK_LINE(429)
			::zpp_nape::util::ZNPNode_ZPP_Interactor _g4 = this->zpp_inner->inner->insert(this->zpp_inner->push_ite,obj->zpp_inner_i);		HX_STACK_VAR(_g4,"_g4");
			HX_STACK_LINE(429)
...
::nape::phys::Interactor InteractorList_obj::pop( ){
	...
	if ((this->zpp_inner->reverse_flag)){
		...
		HX_STACK_LINE(498)
		::zpp_nape::util::ZNPNode_ZPP_Interactor ite;		HX_STACK_VAR(ite,"ite");
		HX_STACK_LINE(498)
		if (((_g == (int)1))){
			HX_STACK_LINE(498)
			ite = null();
...
bool InteractorList_obj::add( ::nape::phys::Interactor obj){
	HX_STACK_FRAME("nape.phys.InteractorList","add",0x6866d540,"nape.phys.InteractorList.add","nape/phys/InteractorList.hx",564,0x3e1b3871)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(564)
	if ((this->zpp_inner->reverse_flag)){
...
{
		HX_STACK_FRAME("nape.phys.InteractorList","clear",0x9bce9a6c,"nape.phys.InteractorList.clear","nape/phys/InteractorList.hx",618,0x3e1b3871)
		HX_STACK_THIS(this)
		HX_STACK_LINE(618)
		if ((this->zpp_inner->reverse_flag)){
			HX_STACK_LINE(619)
	...
	HX_STACK_ARG(deep,"deep")
{
		...
		{
			HX_STACK_LINE(664)
			::nape::phys::InteractorIterator _g;		HX_STACK_VAR(_g,"_g");
			HX_STACK_LINE(664)
			{
				HX_STACK_LINE(664)
				this->zpp_inner->valmod();
				HX_STACK_LINE(664)
				_g = ::nape::phys::InteractorIterator_obj::get(hx::ObjectPtr<OBJ_>(this));
			}
			HX_STACK_LINE(664)
			while((true)){
				struct _Function_3_1{
					inline static bool Block( ::nape::phys::InteractorIterator &_g){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/phys/InteractorList.hx",664,0x3e1b3871)
						{
							HX_STACK_LINE(664)
							...
							struct _Function_4_1{
								inline static bool Block( ::nape::phys::InteractorIterator &_g){
									HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/phys/InteractorList.hx",664,0x3e1b3871)
									{
										...
										{
											HX_STACK_LINE(664)
											_g->zpp_next = ::nape::phys::InteractorIterator_obj::zpp_pool;
											HX_STACK_LINE(664)
				...
				HX_STACK_LINE(664)
				::nape::phys::Interactor i;		HX_STACK_VAR(i,"i");
				HX_STACK_LINE(664)
				{
					HX_STACK_LINE(664)
				...
				HX_STACK_LINE(664)
				ret->push((  ((deep)) ? ::nape::phys::Interactor(null()) : ::nape::phys::Interactor(i) ));
			}
		}
		HX_STACK_LINE(671)
		return ret;
...
{
		HX_STACK_FRAME("nape.phys.InteractorList","merge",0x5939cb97,"nape.phys.InteractorList.merge","nape/phys/InteractorList.hx",688,0x3e1b3871)
		HX_STACK_THIS(this)
		HX_STACK_ARG(xs,"xs")
		HX_STACK_LINE(688)
		::nape::phys::InteractorIterator _g;		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(688)
		{
			...
			xs->zpp_inner->valmod();
			HX_STACK_LINE(688)
			_g = ::nape::phys::InteractorIterator_obj::get(xs);
		}
		HX_STACK_LINE(688)
		while((true)){
			struct _Function_2_1{
				inline static bool Block( ::nape::phys::InteractorIterator &_g){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/phys/InteractorList.hx",688,0x3e1b3871)
					{
						HX_STACK_LINE(688)
						_g->zpp_inner->zpp_inner->valmod();
						HX_STACK_LINE(688)
			...
			HX_STACK_LINE(688)
			::nape::phys::Interactor x;		HX_STACK_VAR(x,"x");
			HX_STACK_LINE(688)
			{
				HX_STACK_LINE(688)
				_g->zpp_critical = false;
...
::String InteractorList_obj::toString( ){
	...
	HX_STACK_LINE(705)
	{
		...
		while((true)){
			struct _Function_3_1{
				inline static bool Block( ::nape::phys::InteractorIterator &_g){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/phys/InteractorList.hx",705,0x3e1b3871)
					{
						HX_STACK_LINE(705)
						_g->zpp_inner->zpp_inner->valmod();
						HX_STACK_LINE(705)
...
::nape::phys::InteractorList InteractorList_obj::foreach( Dynamic lambda){
	...
	HX_STACK_LINE(736)
	::nape::phys::InteractorIterator it;		HX_STACK_VAR(it,"it");
	HX_STACK_LINE(736)
	{
		HX_STACK_LINE(736)
		this->zpp_inner->valmod();
		HX_STACK_LINE(736)
		it = ::nape::phys::InteractorIterator_obj::get(hx::ObjectPtr<OBJ_>(this));
	}
	HX_STACK_LINE(737)
	while((true)){
		struct _Function_2_1{
			inline static bool Block( ::nape::phys::InteractorIterator &it){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/phys/InteractorList.hx",737,0x3e1b3871)
				{
					HX_STACK_LINE(737)
		...
		{
			HX_STACK_LINE(739)
			::nape::phys::Interactor _g1;		HX_STACK_VAR(_g1,"_g1");
			HX_STACK_LINE(739)
			{
				HX_STACK_LINE(739)
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::zpp_nape::util::ZPP_InteractorList*/ ,(int)offsetof(InteractorList_obj,zpp_inner),HX_CSTRING("zpp_inner")},
	{ hx::fsUnknown, 0, null()}
};
#endif
