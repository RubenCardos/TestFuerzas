...
bool ShapeIterator_obj::hasNext( ){
	...
	{
		HX_STACK_LINE(244)
		::nape::shape::ShapeList _this = this->zpp_inner;		HX_STACK_VAR(_this,"_this");
		HX_STACK_LINE(244)
...
::nape::shape::ShapeIterator ShapeIterator_obj::get( ::nape::shape::ShapeList list){
	...
	HX_STACK_LINE(218)
	::nape::shape::ShapeIterator ret;		HX_STACK_VAR(ret,"ret");
	HX_STACK_LINE(218)
	if (((::nape::shape::ShapeIterator_obj::zpp_pool == null()))){
		HX_STACK_LINE(219)
		::zpp_nape::util::ZPP_ShapeList_obj::internal = true;
		HX_STACK_LINE(220)
		::nape::shape::ShapeIterator ret1 = ::nape::shape::ShapeIterator_obj::__new();		HX_STACK_VAR(ret1,"ret1");
		HX_STACK_LINE(221)
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::nape::shape::ShapeList*/ ,(int)offsetof(ShapeIterator_obj,zpp_inner),HX_CSTRING("zpp_inner")},
	{hx::fsInt,(int)offsetof(ShapeIterator_obj,zpp_i),HX_CSTRING("zpp_i")},
	{hx::fsBool,(int)offsetof(ShapeIterator_obj,zpp_critical),HX_CSTRING("zpp_critical")},
	{hx::fsObject /*::nape::shape::ShapeIterator*/ ,(int)offsetof(ShapeIterator_obj,zpp_next),HX_CSTRING("zpp_next")},
	{ hx::fsUnknown, 0, null()}
};
#endif
