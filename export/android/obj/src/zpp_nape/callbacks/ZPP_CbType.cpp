...
HX_STACK_THIS(this)
{
	...
	this->outer = null();
	HX_STACK_LINE(353)
	int _g = ::zpp_nape::ZPP_ID_obj::CbType();		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(353)
	this->id = _g;
	HX_STACK_LINE(355)
	...
	HX_STACK_LINE(360)
	::zpp_nape::util::ZNPList_ZPP_CbSet _g6 = ::zpp_nape::util::ZNPList_ZPP_CbSet_obj::__new();		HX_STACK_VAR(_g6,"_g6");
	HX_STACK_LINE(360)
	this->cbsets = _g6;
}
;
...
{
		HX_STACK_FRAME("zpp_nape.callbacks.ZPP_CbType","addConstraint",0x62255c2f,"zpp_nape.callbacks.ZPP_CbType.addConstraint","zpp_nape/callbacks/CbType.hx",190,0x45e9a502)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("zpp_nape.callbacks.ZPP_CbType","addInteractor",0x8cc9222b,"zpp_nape.callbacks.ZPP_CbType.addInteractor","zpp_nape/callbacks/CbType.hx",195,0x45e9a502)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("zpp_nape.callbacks.ZPP_CbType","remConstraint",0xcd7ee4a8,"zpp_nape.callbacks.ZPP_CbType.remConstraint","zpp_nape/callbacks/CbType.hx",200,0x45e9a502)
		HX_STACK_THIS(this)
		HX_STACK_ARG(con,"con")
		HX_STACK_LINE(200)
...
{
		HX_STACK_FRAME("zpp_nape.callbacks.ZPP_CbType","remInteractor",0xf822aaa4,"zpp_nape.callbacks.ZPP_CbType.remInteractor","zpp_nape/callbacks/CbType.hx",205,0x45e9a502)
		HX_STACK_THIS(this)
		HX_STACK_ARG(intx,"intx")
		HX_STACK_LINE(205)
...
bool ZPP_CbType_obj::setlt( ::zpp_nape::callbacks::ZPP_CbType a,::zpp_nape::callbacks::ZPP_CbType b){
	HX_STACK_FRAME("zpp_nape.callbacks.ZPP_CbType","setlt",0x2adc7ffb,"zpp_nape.callbacks.ZPP_CbType.setlt","zpp_nape/callbacks/CbType.hx",181,0x45e9a502)
	HX_STACK_ARG(a,"a")
	HX_STACK_ARG(b,"b")
	HX_STACK_LINE(181)
	return (a->id < b->id);
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::nape::callbacks::CbType*/ ,(int)offsetof(ZPP_CbType_obj,outer),HX_CSTRING("outer")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(ZPP_CbType_obj,userData),HX_CSTRING("userData")},
	{hx::fsInt,(int)offsetof(ZPP_CbType_obj,id),HX_CSTRING("id")},
	{hx::fsObject /*::zpp_nape::util::ZNPList_ZPP_CbSet*/ ,(int)offsetof(ZPP_CbType_obj,cbsets),HX_CSTRING("cbsets")},
	{hx::fsObject /*::zpp_nape::util::ZNPList_ZPP_Interactor*/ ,(int)offsetof(ZPP_CbType_obj,interactors),HX_CSTRING("interactors")},
	{hx::fsObject /*::nape::phys::InteractorList*/ ,(int)offsetof(ZPP_CbType_obj,wrap_interactors),HX_CSTRING("wrap_interactors")},
	{hx::fsObject /*::zpp_nape::util::ZNPList_ZPP_Constraint*/ ,(int)offsetof(ZPP_CbType_obj,constraints),HX_CSTRING("constraints")},
	{hx::fsObject /*::nape::constraint::ConstraintList*/ ,(int)offsetof(ZPP_CbType_obj,wrap_constraints),HX_CSTRING("wrap_constraints")},
	{hx::fsObject /*::zpp_nape::util::ZNPList_ZPP_InteractionListener*/ ,(int)offsetof(ZPP_CbType_obj,listeners),HX_CSTRING("listeners")},
	{hx::fsObject /*::zpp_nape::util::ZNPList_ZPP_BodyListener*/ ,(int)offsetof(ZPP_CbType_obj,bodylisteners),HX_CSTRING("bodylisteners")},
	{hx::fsObject /*::zpp_nape::util::ZNPList_ZPP_ConstraintListener*/ ,(int)offsetof(ZPP_CbType_obj,conlisteners),HX_CSTRING("conlisteners")},
	{ hx::fsUnknown, 0, null()}
};
#endif
