...
Void ZPP_OptionType_obj::setup_includes( ){
{
		...
		HX_STACK_THIS(this)
		HX_STACK_LINE(186)
		::nape::callbacks::CbTypeList _g = ::zpp_nape::util::ZPP_CbTypeList_obj::get(this->includes,true);		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(186)
		this->wrap_includes = _g;
	}
return null();
}
...
Void ZPP_OptionType_obj::setup_excludes( ){
{
		...
		HX_STACK_THIS(this)
		HX_STACK_LINE(189)
		::nape::callbacks::CbTypeList _g = ::zpp_nape::util::ZPP_CbTypeList_obj::get(this->excludes,true);		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(189)
		this->wrap_excludes = _g;
	}
return null();
}
...
bool ZPP_OptionType_obj::excluded( ::zpp_nape::util::ZNPList_ZPP_CbType xs){
	HX_STACK_FRAME("zpp_nape.callbacks.ZPP_OptionType","excluded",0xfa812a03,"zpp_nape.callbacks.ZPP_OptionType.excluded","zpp_nape/callbacks/OptionType.hx",193,0xf757a16c)
	HX_STACK_THIS(this)
	HX_STACK_ARG(xs,"xs")
	HX_STACK_LINE(193)
...
bool ZPP_OptionType_obj::included( ::zpp_nape::util::ZNPList_ZPP_CbType xs){
	HX_STACK_FRAME("zpp_nape.callbacks.ZPP_OptionType","included",0x3f744ef5,"zpp_nape.callbacks.ZPP_OptionType.included","zpp_nape/callbacks/OptionType.hx",197,0xf757a16c)
	HX_STACK_THIS(this)
	HX_STACK_ARG(xs,"xs")
	HX_STACK_LINE(197)
...
bool ZPP_OptionType_obj::compatible( ::zpp_nape::util::ZNPList_ZPP_CbType xs){
	HX_STACK_FRAME("zpp_nape.callbacks.ZPP_OptionType","compatible",0xadc8654d,"zpp_nape.callbacks.ZPP_OptionType.compatible","zpp_nape/callbacks/OptionType.hx",201,0xf757a16c)
	HX_STACK_THIS(this)
	HX_STACK_ARG(xs,"xs")
	HX_STACK_LINE(201)
...
bool ZPP_OptionType_obj::nonemptyintersection( ::zpp_nape::util::ZNPList_ZPP_CbType xs,::zpp_nape::util::ZNPList_ZPP_CbType ys){
	...
	while((true)){
		HX_STACK_LINE(207)
		if ((!(((bool((eite != null())) && bool((xite != null()))))))){
			HX_STACK_LINE(207)
			break;
		}
		HX_STACK_LINE(208)
...
{
		HX_STACK_FRAME("zpp_nape.callbacks.ZPP_OptionType","effect_change",0xa3a46445,"zpp_nape.callbacks.ZPP_OptionType.effect_change","zpp_nape/callbacks/OptionType.hx",226,0xf757a16c)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("zpp_nape.callbacks.ZPP_OptionType","append_type",0x24966666,"zpp_nape.callbacks.ZPP_OptionType.append_type","zpp_nape/callbacks/OptionType.hx",264,0xf757a16c)
		HX_STACK_THIS(this)
						...
						HX_STACK_LINE(280)
						{
							...
							HX_STACK_LINE(280)
							{
								...
								HX_STACK_LINE(280)
								{
									...
									if (((::zpp_nape::util::ZNPNode_ZPP_CbType_obj::zpp_pool == null()))){
										HX_STACK_LINE(280)
										::zpp_nape::util::ZNPNode_ZPP_CbType _g10 = ::zpp_nape::util::ZNPNode_ZPP_CbType_obj::__new();		HX_STACK_VAR(_g10,"_g10");
										HX_STACK_LINE(280)
										ret = _g10;
									}
									else{
							...
							HX_STACK_LINE(280)
							bool _g11 = _this->modified = true;		HX_STACK_VAR(_g11,"_g11");
							HX_STACK_LINE(280)
							_this->pushmod = _g11;
							HX_STACK_LINE(280)
							(_this->length)++;
...
{
		HX_STACK_FRAME("zpp_nape.callbacks.ZPP_OptionType","append",0xa21cbb53,"zpp_nape.callbacks.ZPP_OptionType.append","zpp_nape/callbacks/OptionType.hx",318,0xf757a16c)
		HX_STACK_THIS(this)
		HX_STACK_ARG(list,"list")
		HX_STACK_ARG(val,"val")
		HX_STACK_LINE(318)
			...
			if ((::Std_obj::is(val,hx::ClassOf< ::nape::callbacks::CbTypeList >()))){
				...
				HX_STACK_LINE(324)
				{
					...
					HX_STACK_LINE(324)
					{
						...
						HX_STACK_LINE(324)
						_g = ::nape::callbacks::CbTypeIterator_obj::get(cbs);
					}
					HX_STACK_LINE(324)
					while((true)){
						struct _Function_5_1{
							inline static bool Block( ::nape::callbacks::CbTypeIterator &_g){
								HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/callbacks/OptionType.hx",324,0xf757a16c)
								{
									HX_STACK_LINE(324)
									...
									HX_STACK_LINE(324)
									return (  (((_g->zpp_i < length))) ? bool(true) : bool(_Function_6_1::Block(_g)) );
								}
								return null();
							}
						};
						HX_STACK_LINE(324)
						if ((!(_Function_5_1::Block(_g)))){
							HX_STACK_LINE(324)
							break;
						}
						HX_STACK_LINE(324)
				...
				if ((::Std_obj::is(val,hx::ClassOf< Array<int> >()))){
					...
					HX_STACK_LINE(334)
					{
						...
						while((true)){
							HX_STACK_LINE(334)
							if ((!(((_g < cbs->__Field(HX_CSTRING("length"),true)))))){
								HX_STACK_LINE(334)
								break;
							}
							HX_STACK_LINE(334)
...
::nape::callbacks::OptionType ZPP_OptionType_obj::argument( Dynamic val){
	HX_STACK_FRAME("zpp_nape.callbacks.ZPP_OptionType","argument",0xdef65836,"zpp_nape.callbacks.ZPP_OptionType.argument","zpp_nape/callbacks/OptionType.hx",351,0xf757a16c)
	HX_STACK_ARG(val,"val")
	HX_STACK_LINE(351)
	if (((val == null()))){
		HX_STACK_LINE(351)
		return ::nape::callbacks::OptionType_obj::__new(null(),null());
	}
	else{
		HX_STACK_LINE(352)
		if ((::Std_obj::is(val,hx::ClassOf< ::nape::callbacks::OptionType >()))){
			HX_STACK_LINE(352)
			return val;
		}
		else{
			HX_STACK_LINE(353)
			return ::nape::callbacks::OptionType_obj::__new(null(),null())->including(val);
		}
	}
	HX_STACK_LINE(351)
	return null();
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::nape::callbacks::OptionType*/ ,(int)offsetof(ZPP_OptionType_obj,outer),HX_CSTRING("outer")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(ZPP_OptionType_obj,handler),HX_CSTRING("handler")},
	{hx::fsObject /*::zpp_nape::util::ZNPList_ZPP_CbType*/ ,(int)offsetof(ZPP_OptionType_obj,includes),HX_CSTRING("includes")},
	{hx::fsObject /*::zpp_nape::util::ZNPList_ZPP_CbType*/ ,(int)offsetof(ZPP_OptionType_obj,excludes),HX_CSTRING("excludes")},
	{hx::fsObject /*::nape::callbacks::CbTypeList*/ ,(int)offsetof(ZPP_OptionType_obj,wrap_includes),HX_CSTRING("wrap_includes")},
	{hx::fsObject /*::nape::callbacks::CbTypeList*/ ,(int)offsetof(ZPP_OptionType_obj,wrap_excludes),HX_CSTRING("wrap_excludes")},
	{ hx::fsUnknown, 0, null()}
};
#endif
