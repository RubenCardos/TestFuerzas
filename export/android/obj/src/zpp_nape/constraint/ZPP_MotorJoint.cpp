...
::nape::geom::Vec3 ZPP_MotorJoint_obj::bodyImpulse( ::zpp_nape::phys::ZPP_Body b){
	HX_STACK_FRAME("zpp_nape.constraint.ZPP_MotorJoint","bodyImpulse",0xa733fbcf,"zpp_nape.constraint.ZPP_MotorJoint.bodyImpulse","zpp_nape/constraint/MotorJoint.hx",179,0x608da4b9)
	HX_STACK_THIS(this)
	HX_STACK_ARG(b,"b")
	HX_STACK_LINE(179)
	if ((this->stepped)){
...
::nape::constraint::Constraint ZPP_MotorJoint_obj::copy( Array< ::Dynamic > dict,Array< ::Dynamic > todo){
	...
	if (((bool((dict != null())) && bool((this->b1 != null()))))){
		...
		if (((b != null()))){
			...
			Void run(::nape::phys::Body b1){
				HX_STACK_FRAME("*","_Function_3_1",0x520271b9,"*._Function_3_1","zpp_nape/constraint/MotorJoint.hx",228,0x608da4b9)
				HX_STACK_ARG(b1,"b1")
				{
					HX_STACK_LINE(228)
	...
	if (((bool((dict != null())) && bool((this->b2 != null()))))){
		...
		if (((b != null()))){
			...
			HX_BEGIN_LOCAL_FUNC_S1(hx::LocalFunc,_Function_3_1,Array< ::Dynamic >,ret)
			Void run(::nape::phys::Body b1){
				HX_STACK_FRAME("*","_Function_3_1",0x520271b9,"*._Function_3_1","zpp_nape/constraint/MotorJoint.hx",249,0x608da4b9)
				HX_STACK_ARG(b1,"b1")
				{
					HX_STACK_LINE(249)
...
Void ZPP_MotorJoint_obj::validate( ){
{
		...
		if (((this->b1 == this->b2))){
			HX_STACK_LINE(262)
			HX_STACK_DO_THROW(HX_CSTRING("Error: MotorJoint cannot be simulated with body1 == body2"));
		}
		HX_STACK_LINE(263)
...
bool ZPP_MotorJoint_obj::pair_exists( int id,int di){
	HX_STACK_FRAME("zpp_nape.constraint.ZPP_MotorJoint","pair_exists",0xb0e9f03d,"zpp_nape.constraint.ZPP_MotorJoint.pair_exists","zpp_nape/constraint/MotorJoint.hx",369,0x608da4b9)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
	HX_STACK_ARG(di,"di")
	HX_STACK_LINE(369)
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::nape::constraint::MotorJoint*/ ,(int)offsetof(ZPP_MotorJoint_obj,outer_zn),HX_CSTRING("outer_zn")},
	{hx::fsFloat,(int)offsetof(ZPP_MotorJoint_obj,ratio),HX_CSTRING("ratio")},
	{hx::fsFloat,(int)offsetof(ZPP_MotorJoint_obj,rate),HX_CSTRING("rate")},
	{hx::fsObject /*::zpp_nape::phys::ZPP_Body*/ ,(int)offsetof(ZPP_MotorJoint_obj,b1),HX_CSTRING("b1")},
	{hx::fsObject /*::zpp_nape::phys::ZPP_Body*/ ,(int)offsetof(ZPP_MotorJoint_obj,b2),HX_CSTRING("b2")},
	{hx::fsFloat,(int)offsetof(ZPP_MotorJoint_obj,kMass),HX_CSTRING("kMass")},
	{hx::fsFloat,(int)offsetof(ZPP_MotorJoint_obj,jAcc),HX_CSTRING("jAcc")},
	{hx::fsFloat,(int)offsetof(ZPP_MotorJoint_obj,jMax),HX_CSTRING("jMax")},
	{hx::fsBool,(int)offsetof(ZPP_MotorJoint_obj,stepped),HX_CSTRING("stepped")},
	{ hx::fsUnknown, 0, null()}
};
#endif
