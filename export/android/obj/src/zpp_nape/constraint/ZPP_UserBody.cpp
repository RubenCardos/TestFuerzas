...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsInt,(int)offsetof(ZPP_UserBody_obj,cnt),HX_CSTRING("cnt")},
	{hx::fsObject /*::zpp_nape::phys::ZPP_Body*/ ,(int)offsetof(ZPP_UserBody_obj,body),HX_CSTRING("body")},
	{ hx::fsUnknown, 0, null()}
};
#endif
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("zpp_nape.constraint.ZPP_UserBody"), hx::TCanCast< ZPP_UserBody_obj> ,sStaticFields,sMemberFields,
