...
::nape::dynamics::Arbiter ZPP_Arbiter_obj::wrapper( ){
	...
	if (((this->outer == null()))){
		...
		if (((this->type == ::zpp_nape::dynamics::ZPP_Arbiter_obj::COL))){
			HX_STACK_LINE(184)
			::nape::dynamics::CollisionArbiter _g = ::nape::dynamics::CollisionArbiter_obj::__new();		HX_STACK_VAR(_g,"_g");
			HX_STACK_LINE(184)
			this->colarb->outer_zn = _g;
			HX_STACK_LINE(185)
			...
			if (((this->type == ::zpp_nape::dynamics::ZPP_Arbiter_obj::FLUID))){
				HX_STACK_LINE(188)
				::nape::dynamics::FluidArbiter _g1 = ::nape::dynamics::FluidArbiter_obj::__new();		HX_STACK_VAR(_g1,"_g1");
				HX_STACK_LINE(188)
				this->fluidarb->outer_zn = _g1;
				HX_STACK_LINE(189)
				this->outer = this->fluidarb->outer_zn;
			}
			else{
				HX_STACK_LINE(191)
				::nape::dynamics::Arbiter _g2 = ::nape::dynamics::Arbiter_obj::__new();		HX_STACK_VAR(_g2,"_g2");
				HX_STACK_LINE(191)
				this->outer = _g2;
			}
		}
...
bool ZPP_Arbiter_obj::inactiveme( ){
	HX_STACK_FRAME("zpp_nape.dynamics.ZPP_Arbiter","inactiveme",0xa2bbcdc6,"zpp_nape.dynamics.ZPP_Arbiter.inactiveme","zpp_nape/dynamics/Arbiter.hx",200,0x26846f2e)
	HX_STACK_THIS(this)
	HX_STACK_LINE(200)
	return !(this->active);
}
...
bool ZPP_Arbiter_obj::acting( ){
	HX_STACK_FRAME("zpp_nape.dynamics.ZPP_Arbiter","acting",0x14a58393,"zpp_nape.dynamics.ZPP_Arbiter.acting","zpp_nape/dynamics/Arbiter.hx",225,0x26846f2e)
	HX_STACK_THIS(this)
	HX_STACK_LINE(225)
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::nape::dynamics::Arbiter*/ ,(int)offsetof(ZPP_Arbiter_obj,outer),HX_CSTRING("outer")},
	{hx::fsObject /*::zpp_nape::dynamics::ZPP_Arbiter*/ ,(int)offsetof(ZPP_Arbiter_obj,hnext),HX_CSTRING("hnext")},
	{hx::fsInt,(int)offsetof(ZPP_Arbiter_obj,id),HX_CSTRING("id")},
	{hx::fsInt,(int)offsetof(ZPP_Arbiter_obj,di),HX_CSTRING("di")},
	{hx::fsInt,(int)offsetof(ZPP_Arbiter_obj,stamp),HX_CSTRING("stamp")},
	{hx::fsInt,(int)offsetof(ZPP_Arbiter_obj,up_stamp),HX_CSTRING("up_stamp")},
	{hx::fsInt,(int)offsetof(ZPP_Arbiter_obj,sleep_stamp),HX_CSTRING("sleep_stamp")},
	{hx::fsInt,(int)offsetof(ZPP_Arbiter_obj,endGenerated),HX_CSTRING("endGenerated")},
	{hx::fsBool,(int)offsetof(ZPP_Arbiter_obj,active),HX_CSTRING("active")},
	{hx::fsBool,(int)offsetof(ZPP_Arbiter_obj,cleared),HX_CSTRING("cleared")},
	{hx::fsBool,(int)offsetof(ZPP_Arbiter_obj,sleeping),HX_CSTRING("sleeping")},
	{hx::fsInt,(int)offsetof(ZPP_Arbiter_obj,present),HX_CSTRING("present")},
	{hx::fsBool,(int)offsetof(ZPP_Arbiter_obj,intchange),HX_CSTRING("intchange")},
	{hx::fsBool,(int)offsetof(ZPP_Arbiter_obj,presentable),HX_CSTRING("presentable")},
	{hx::fsBool,(int)offsetof(ZPP_Arbiter_obj,continuous),HX_CSTRING("continuous")},
	{hx::fsBool,(int)offsetof(ZPP_Arbiter_obj,fresh),HX_CSTRING("fresh")},
	{hx::fsInt,(int)offsetof(ZPP_Arbiter_obj,immState),HX_CSTRING("immState")},
	{hx::fsBool,(int)offsetof(ZPP_Arbiter_obj,invalidated),HX_CSTRING("invalidated")},
	{hx::fsObject /*::zpp_nape::phys::ZPP_Body*/ ,(int)offsetof(ZPP_Arbiter_obj,b1),HX_CSTRING("b1")},
	{hx::fsObject /*::zpp_nape::phys::ZPP_Body*/ ,(int)offsetof(ZPP_Arbiter_obj,b2),HX_CSTRING("b2")},
	{hx::fsObject /*::zpp_nape::shape::ZPP_Shape*/ ,(int)offsetof(ZPP_Arbiter_obj,ws1),HX_CSTRING("ws1")},
	{hx::fsObject /*::zpp_nape::shape::ZPP_Shape*/ ,(int)offsetof(ZPP_Arbiter_obj,ws2),HX_CSTRING("ws2")},
	{hx::fsObject /*::zpp_nape::space::ZPP_AABBPair*/ ,(int)offsetof(ZPP_Arbiter_obj,pair),HX_CSTRING("pair")},
	{hx::fsInt,(int)offsetof(ZPP_Arbiter_obj,type),HX_CSTRING("type")},
	{hx::fsObject /*::zpp_nape::dynamics::ZPP_ColArbiter*/ ,(int)offsetof(ZPP_Arbiter_obj,colarb),HX_CSTRING("colarb")},
	{hx::fsObject /*::zpp_nape::dynamics::ZPP_FluidArbiter*/ ,(int)offsetof(ZPP_Arbiter_obj,fluidarb),HX_CSTRING("fluidarb")},
	{hx::fsObject /*::zpp_nape::dynamics::ZPP_SensorArbiter*/ ,(int)offsetof(ZPP_Arbiter_obj,sensorarb),HX_CSTRING("sensorarb")},
	{ hx::fsUnknown, 0, null()}
};
#endif
...
struct _Function_0_1{
	inline static Array< ::Dynamic > Block( ){
		HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/dynamics/Arbiter.hx",264,0x26846f2e)
		{
			...
			HX_STACK_LINE(264)
			return Array_obj< ::Dynamic >::__new().Add(null()).Add(_g1).Add(_g3).Add(null()).Add(_g5);
		}
		return null();
	}
};
