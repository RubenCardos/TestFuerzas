...
bool ZPP_SpaceArbiterList_obj::push( ::nape::dynamics::Arbiter obj){
	HX_STACK_FRAME("zpp_nape.dynamics.ZPP_SpaceArbiterList","push",0xc25c8489,"zpp_nape.dynamics.ZPP_SpaceArbiterList.push","zpp_nape/dynamics/SpaceArbiterList.hx",294,0x1150d7c4)
	HX_STACK_THIS(this)
...
::nape::dynamics::Arbiter ZPP_SpaceArbiterList_obj::pop( ){
	HX_STACK_FRAME("zpp_nape.dynamics.ZPP_SpaceArbiterList","pop",0xed5b15c2,"zpp_nape.dynamics.ZPP_SpaceArbiterList.pop","zpp_nape/dynamics/SpaceArbiterList.hx",300,0x1150d7c4)
	HX_STACK_THIS(this)
	HX_STACK_LINE(300)
	return null();
}
...
bool ZPP_SpaceArbiterList_obj::unshift( ::nape::dynamics::Arbiter obj){
	HX_STACK_FRAME("zpp_nape.dynamics.ZPP_SpaceArbiterList","unshift",0xbd98083a,"zpp_nape.dynamics.ZPP_SpaceArbiterList.unshift","zpp_nape/dynamics/SpaceArbiterList.hx",306,0x1150d7c4)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(306)
	return false;
...
::nape::dynamics::Arbiter ZPP_SpaceArbiterList_obj::shift( ){
	HX_STACK_FRAME("zpp_nape.dynamics.ZPP_SpaceArbiterList","shift",0x002bd2f3,"zpp_nape.dynamics.ZPP_SpaceArbiterList.shift","zpp_nape/dynamics/SpaceArbiterList.hx",312,0x1150d7c4)
	HX_STACK_THIS(this)
	HX_STACK_LINE(312)
	return null();
}
...
bool ZPP_SpaceArbiterList_obj::remove( ::nape::dynamics::Arbiter obj){
	HX_STACK_FRAME("zpp_nape.dynamics.ZPP_SpaceArbiterList","remove",0x084958b3,"zpp_nape.dynamics.ZPP_SpaceArbiterList.remove","zpp_nape/dynamics/SpaceArbiterList.hx",318,0x1150d7c4)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(318)
	return false;
...
{
		HX_STACK_FRAME("zpp_nape.dynamics.ZPP_SpaceArbiterList","clear",0xcc6457fe,"zpp_nape.dynamics.ZPP_SpaceArbiterList.clear","zpp_nape/dynamics/SpaceArbiterList.hx",320,0x1150d7c4)
		HX_STACK_THIS(this)
	}
return null();
}
...
::nape::dynamics::Arbiter ZPP_SpaceArbiterList_obj::at( int index){
	...
	if (((ret == null()))){
		...
		if (((index < (accum_length + this->lengths->__get((int)0))))){
			...
			HX_STACK_LINE(354)
			::nape::dynamics::Arbiter _g = this->ite_0->elt->wrapper();		HX_STACK_VAR(_g,"_g");
			HX_STACK_LINE(354)
			ret = _g;
		}
		else{
	...
	if (((ret == null()))){
		...
		if (((index < (accum_length + this->lengths->__get((int)1))))){
			...
			HX_STACK_LINE(379)
			::nape::dynamics::Arbiter _g1 = this->ite_1->elt->wrapper();		HX_STACK_VAR(_g1,"_g1");
			HX_STACK_LINE(379)
			ret = _g1;
		}
		else{
	...
	if (((ret == null()))){
		...
		if (((index < (accum_length + this->lengths->__get((int)2))))){
			...
			HX_STACK_LINE(404)
			::nape::dynamics::Arbiter _g2 = this->ite_2->elt->wrapper();		HX_STACK_VAR(_g2,"_g2");
			HX_STACK_LINE(404)
			ret = _g2;
		}
		else{
	...
	if (((ret == null()))){
		...
		if (((index < (accum_length + this->lengths->__get((int)3))))){
			...
			HX_STACK_LINE(429)
			::nape::dynamics::Arbiter _g3 = this->ite_3->elt->wrapper();		HX_STACK_VAR(_g3,"_g3");
			HX_STACK_LINE(429)
			ret = _g3;
		}
		else{
