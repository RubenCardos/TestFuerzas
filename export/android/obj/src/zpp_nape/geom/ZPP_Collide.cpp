...
bool ZPP_Collide_obj::shapeContains( ::zpp_nape::shape::ZPP_Shape s,::zpp_nape::geom::ZPP_Vec2 p){
	HX_STACK_FRAME("zpp_nape.geom.ZPP_Collide","shapeContains",0x93829e7a,"zpp_nape.geom.ZPP_Collide.shapeContains","zpp_nape/geom/Collide.hx",211,0x9b695611)
	HX_STACK_ARG(s,"s")
	HX_STACK_ARG(p,"p")
	HX_STACK_LINE(211)
	if (((s->type == ::zpp_nape::util::ZPP_Flags_obj::id_ShapeType_CIRCLE))){
		HX_STACK_LINE(211)
		return ::zpp_nape::geom::ZPP_Collide_obj::circleContains(s->circle,p);
	}
	else{
		HX_STACK_LINE(212)
		return ::zpp_nape::geom::ZPP_Collide_obj::polyContains(s->polygon,p);
	}
	HX_STACK_LINE(211)
	return false;
}
...
bool ZPP_Collide_obj::containTest( ::zpp_nape::shape::ZPP_Shape s1,::zpp_nape::shape::ZPP_Shape s2){
	HX_STACK_FRAME("zpp_nape.geom.ZPP_Collide","containTest",0xa0adefe0,"zpp_nape.geom.ZPP_Collide.containTest","zpp_nape/geom/Collide.hx",235,0x9b695611)
	HX_STACK_ARG(s1,"s1")
	HX_STACK_ARG(s2,"s2")
	struct _Function_1_1{
		inline static bool Block( ::zpp_nape::shape::ZPP_Shape &s2,::zpp_nape::shape::ZPP_Shape &s1){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Collide.hx",235,0x9b695611)
			{
				HX_STACK_LINE(235)
						...
						while((true)){
							...
							struct _Function_7_1{
								inline static bool Block( ::zpp_nape::geom::ZPP_Vec2 &p,::zpp_nape::shape::ZPP_Shape &s1){
									HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Collide.hx",257,0x9b695611)
									{
										HX_STACK_LINE(258)
						...
						while((true)){
							...
							struct _Function_7_1{
								inline static bool Block( ::zpp_nape::shape::ZPP_Shape &s2,::zpp_nape::shape::ZPP_Edge &a){
									HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Collide.hx",321,0x9b695611)
									{
										HX_STACK_LINE(322)
...
bool ZPP_Collide_obj::contactCollide( ::zpp_nape::shape::ZPP_Shape s1,::zpp_nape::shape::ZPP_Shape s2,::zpp_nape::dynamics::ZPP_ColArbiter arb,bool rev){
	HX_STACK_FRAME("zpp_nape.geom.ZPP_Collide","contactCollide",0x6ce46b64,"zpp_nape.geom.ZPP_Collide.contactCollide","zpp_nape/geom/Collide.hx",357,0x9b695611)
	HX_STACK_ARG(s1,"s1")
	HX_STACK_ARG(s2,"s2")
	...
	if (((s2->type == ::zpp_nape::util::ZPP_Flags_obj::id_ShapeType_POLYGON))){
		...
		if (((s1->type == ::zpp_nape::util::ZPP_Flags_obj::id_ShapeType_POLYGON))){
			...
			if ((cont)){
				...
				if ((!(cont))){
					...
					if (((bool((c0d > (int)0)) && bool((c1d > (int)0))))){
						...
						HX_STACK_LINE(591)
						::zpp_nape::dynamics::ZPP_Contact con;		HX_STACK_VAR(con,"con");
						HX_STACK_LINE(591)
						{
							HX_STACK_LINE(591)
						...
						HX_STACK_LINE(609)
						::zpp_nape::dynamics::ZPP_Contact _g4;		HX_STACK_VAR(_g4,"_g4");
						HX_STACK_LINE(609)
						{
							HX_STACK_LINE(609)
							int hash;		HX_STACK_VAR(hash,"hash");
							...
							if (((c == null()))){
								HX_STACK_LINE(609)
								{
									...
									if (((::zpp_nape::dynamics::ZPP_Contact_obj::zpp_pool == null()))){
										HX_STACK_LINE(609)
										::zpp_nape::dynamics::ZPP_Contact _g2 = ::zpp_nape::dynamics::ZPP_Contact_obj::__new();		HX_STACK_VAR(_g2,"_g2");
										HX_STACK_LINE(609)
										c = _g2;
									}
									else{
								...
								::zpp_nape::dynamics::ZPP_IContact ci = c->inner;		HX_STACK_VAR(ci,"ci");
								HX_STACK_LINE(609)
								Float _g3 = ci->jtAcc = (int)0;		HX_STACK_VAR(_g3,"_g3");
								HX_STACK_LINE(609)
								ci->jnAcc = _g3;
								HX_STACK_LINE(609)
								c->hash = hash;
			...
			if ((cont)){
				...
				HX_STACK_LINE(669)
				::zpp_nape::geom::ZPP_Vec2 v1;		HX_STACK_VAR(v1,"v1");
				HX_STACK_LINE(669)
				if (((vi->next == null()))){
					HX_STACK_LINE(669)
					v1 = s2->polygon->gverts->next;
				}
				else{
					HX_STACK_LINE(669)
					v1 = vi->next;
				...
				if (((dt <= ((v0->y * a0->gnormx) - (v0->x * a0->gnormy))))){
					HX_STACK_LINE(672)
					::zpp_nape::dynamics::ZPP_Contact co;		HX_STACK_VAR(co,"co");
					HX_STACK_LINE(672)
					{
						HX_STACK_LINE(673)
						Float minDist = s1->circle->radius;		HX_STACK_VAR(minDist,"minDist");
						...
						if (((distSqr > (minDist * minDist)))){
							...
							HX_STACK_LINE(682)
							if (((distSqr < (::nape::Config_obj::epsilon * ::nape::Config_obj::epsilon)))){
								HX_STACK_LINE(682)
								...
								if (((c == null()))){
									HX_STACK_LINE(682)
									{
										...
										if (((::zpp_nape::dynamics::ZPP_Contact_obj::zpp_pool == null()))){
											HX_STACK_LINE(682)
											::zpp_nape::dynamics::ZPP_Contact _g5 = ::zpp_nape::dynamics::ZPP_Contact_obj::__new();		HX_STACK_VAR(_g5,"_g5");
											HX_STACK_LINE(682)
											c = _g5;
										}
										else{
									...
									::zpp_nape::dynamics::ZPP_IContact ci = c->inner;		HX_STACK_VAR(ci,"ci");
									HX_STACK_LINE(682)
									Float _g6 = ci->jtAcc = (int)0;		HX_STACK_VAR(_g6,"_g6");
									HX_STACK_LINE(682)
									ci->jnAcc = _g6;
									HX_STACK_LINE(682)
									c->hash = (int)0;
								...
								HX_STACK_LINE(684)
								Float invDist;		HX_STACK_VAR(invDist,"invDist");
								HX_STACK_LINE(684)
								{
									HX_STACK_LINE(684)
									Float _g7 = ::Math_obj::sqrt(distSqr);		HX_STACK_VAR(_g7,"_g7");
									HX_STACK_LINE(684)
									invDist = (Float(1.0) / Float(_g7));
								}
								HX_STACK_LINE(685)
								Float dist;		HX_STACK_VAR(dist,"dist");
								HX_STACK_LINE(685)
								if (((invDist < ::nape::Config_obj::epsilon))){
									HX_STACK_LINE(685)
									dist = 1e100;
								}
								else{
									HX_STACK_LINE(685)
									dist = (Float(1.0) / Float(invDist));
								}
								HX_STACK_LINE(686)
								...
								if ((rev)){
									...
									if (((c == null()))){
										HX_STACK_LINE(687)
										{
											...
											if (((::zpp_nape::dynamics::ZPP_Contact_obj::zpp_pool == null()))){
												HX_STACK_LINE(687)
												::zpp_nape::dynamics::ZPP_Contact _g8 = ::zpp_nape::dynamics::ZPP_Contact_obj::__new();		HX_STACK_VAR(_g8,"_g8");
												HX_STACK_LINE(687)
												c = _g8;
											}
											else{
										...
										::zpp_nape::dynamics::ZPP_IContact ci = c->inner;		HX_STACK_VAR(ci,"ci");
										HX_STACK_LINE(687)
										Float _g9 = ci->jtAcc = (int)0;		HX_STACK_VAR(_g9,"_g9");
										HX_STACK_LINE(687)
										ci->jnAcc = _g9;
										HX_STACK_LINE(687)
										c->hash = (int)0;
									...
									if (((c == null()))){
										HX_STACK_LINE(688)
										{
											...
											if (((::zpp_nape::dynamics::ZPP_Contact_obj::zpp_pool == null()))){
												HX_STACK_LINE(688)
												::zpp_nape::dynamics::ZPP_Contact _g10 = ::zpp_nape::dynamics::ZPP_Contact_obj::__new();		HX_STACK_VAR(_g10,"_g10");
												HX_STACK_LINE(688)
												c = _g10;
											}
											else{
										...
										::zpp_nape::dynamics::ZPP_IContact ci = c->inner;		HX_STACK_VAR(ci,"ci");
										HX_STACK_LINE(688)
										Float _g11 = ci->jtAcc = (int)0;		HX_STACK_VAR(_g11,"_g11");
										HX_STACK_LINE(688)
										ci->jnAcc = _g11;
										HX_STACK_LINE(688)
										c->hash = (int)0;
								...
								if (((distSqr < (::nape::Config_obj::epsilon * ::nape::Config_obj::epsilon)))){
									...
									if (((c == null()))){
										HX_STACK_LINE(769)
										{
											...
											if (((::zpp_nape::dynamics::ZPP_Contact_obj::zpp_pool == null()))){
												HX_STACK_LINE(769)
												::zpp_nape::dynamics::ZPP_Contact _g12 = ::zpp_nape::dynamics::ZPP_Contact_obj::__new();		HX_STACK_VAR(_g12,"_g12");
												HX_STACK_LINE(769)
												c = _g12;
											}
											else{
										...
										::zpp_nape::dynamics::ZPP_IContact ci = c->inner;		HX_STACK_VAR(ci,"ci");
										HX_STACK_LINE(769)
										Float _g13 = ci->jtAcc = (int)0;		HX_STACK_VAR(_g13,"_g13");
										HX_STACK_LINE(769)
										ci->jnAcc = _g13;
										HX_STACK_LINE(769)
										c->hash = (int)0;
									...
									{
										HX_STACK_LINE(771)
										Float _g14 = ::Math_obj::sqrt(distSqr);		HX_STACK_VAR(_g14,"_g14");
										HX_STACK_LINE(771)
										invDist = (Float(1.0) / Float(_g14));
									}
									HX_STACK_LINE(772)
									Float dist;		HX_STACK_VAR(dist,"dist");
									HX_STACK_LINE(772)
									...
									if ((rev)){
										...
										if (((c == null()))){
											HX_STACK_LINE(774)
											{
												...
												if (((::zpp_nape::dynamics::ZPP_Contact_obj::zpp_pool == null()))){
													HX_STACK_LINE(774)
													::zpp_nape::dynamics::ZPP_Contact _g15 = ::zpp_nape::dynamics::ZPP_Contact_obj::__new();		HX_STACK_VAR(_g15,"_g15");
													HX_STACK_LINE(774)
													c = _g15;
												}
												else{
											...
											::zpp_nape::dynamics::ZPP_IContact ci = c->inner;		HX_STACK_VAR(ci,"ci");
											HX_STACK_LINE(774)
											Float _g16 = ci->jtAcc = (int)0;		HX_STACK_VAR(_g16,"_g16");
											HX_STACK_LINE(774)
											ci->jnAcc = _g16;
											HX_STACK_LINE(774)
											c->hash = (int)0;
										...
										if (((c == null()))){
											HX_STACK_LINE(775)
											{
												...
												if (((::zpp_nape::dynamics::ZPP_Contact_obj::zpp_pool == null()))){
													HX_STACK_LINE(775)
													::zpp_nape::dynamics::ZPP_Contact _g17 = ::zpp_nape::dynamics::ZPP_Contact_obj::__new();		HX_STACK_VAR(_g17,"_g17");
													HX_STACK_LINE(775)
													c = _g17;
												}
												else{
											...
											::zpp_nape::dynamics::ZPP_IContact ci = c->inner;		HX_STACK_VAR(ci,"ci");
											HX_STACK_LINE(775)
											Float _g18 = ci->jtAcc = (int)0;		HX_STACK_VAR(_g18,"_g18");
											HX_STACK_LINE(775)
											ci->jnAcc = _g18;
											HX_STACK_LINE(775)
											c->hash = (int)0;
						...
						if ((rev)){
							...
							if (((c == null()))){
								HX_STACK_LINE(867)
								{
									...
									if (((::zpp_nape::dynamics::ZPP_Contact_obj::zpp_pool == null()))){
										HX_STACK_LINE(867)
										::zpp_nape::dynamics::ZPP_Contact _g19 = ::zpp_nape::dynamics::ZPP_Contact_obj::__new();		HX_STACK_VAR(_g19,"_g19");
										HX_STACK_LINE(867)
										c = _g19;
									}
									else{
								...
								::zpp_nape::dynamics::ZPP_IContact ci = c->inner;		HX_STACK_VAR(ci,"ci");
								HX_STACK_LINE(867)
								Float _g20 = ci->jtAcc = (int)0;		HX_STACK_VAR(_g20,"_g20");
								HX_STACK_LINE(867)
								ci->jnAcc = _g20;
								HX_STACK_LINE(867)
								c->hash = (int)0;
							...
							if (((c == null()))){
								HX_STACK_LINE(868)
								{
									...
									if (((::zpp_nape::dynamics::ZPP_Contact_obj::zpp_pool == null()))){
										HX_STACK_LINE(868)
										::zpp_nape::dynamics::ZPP_Contact _g21 = ::zpp_nape::dynamics::ZPP_Contact_obj::__new();		HX_STACK_VAR(_g21,"_g21");
										HX_STACK_LINE(868)
										c = _g21;
									}
									else{
								...
								::zpp_nape::dynamics::ZPP_IContact ci = c->inner;		HX_STACK_VAR(ci,"ci");
								HX_STACK_LINE(868)
								Float _g22 = ci->jtAcc = (int)0;		HX_STACK_VAR(_g22,"_g22");
								HX_STACK_LINE(868)
								ci->jnAcc = _g22;
								HX_STACK_LINE(868)
								c->hash = (int)0;
				...
				if (((distSqr < (::nape::Config_obj::epsilon * ::nape::Config_obj::epsilon)))){
					...
					if (((c == null()))){
						HX_STACK_LINE(932)
						{
							...
							if (((::zpp_nape::dynamics::ZPP_Contact_obj::zpp_pool == null()))){
								HX_STACK_LINE(932)
								::zpp_nape::dynamics::ZPP_Contact _g23 = ::zpp_nape::dynamics::ZPP_Contact_obj::__new();		HX_STACK_VAR(_g23,"_g23");
								HX_STACK_LINE(932)
								c = _g23;
							}
							else{
						...
						::zpp_nape::dynamics::ZPP_IContact ci = c->inner;		HX_STACK_VAR(ci,"ci");
						HX_STACK_LINE(932)
						Float _g24 = ci->jtAcc = (int)0;		HX_STACK_VAR(_g24,"_g24");
						HX_STACK_LINE(932)
						ci->jnAcc = _g24;
						HX_STACK_LINE(932)
						c->hash = (int)0;
					...
					{
						HX_STACK_LINE(934)
						Float _g25 = ::Math_obj::sqrt(distSqr);		HX_STACK_VAR(_g25,"_g25");
						HX_STACK_LINE(934)
						invDist = (Float(1.0) / Float(_g25));
					}
					HX_STACK_LINE(935)
					Float dist;		HX_STACK_VAR(dist,"dist");
					HX_STACK_LINE(935)
					...
					if ((rev)){
						...
						if (((c == null()))){
							HX_STACK_LINE(937)
							{
								...
								if (((::zpp_nape::dynamics::ZPP_Contact_obj::zpp_pool == null()))){
									HX_STACK_LINE(937)
									::zpp_nape::dynamics::ZPP_Contact _g26 = ::zpp_nape::dynamics::ZPP_Contact_obj::__new();		HX_STACK_VAR(_g26,"_g26");
									HX_STACK_LINE(937)
									c = _g26;
								}
								else{
							...
							::zpp_nape::dynamics::ZPP_IContact ci = c->inner;		HX_STACK_VAR(ci,"ci");
							HX_STACK_LINE(937)
							Float _g27 = ci->jtAcc = (int)0;		HX_STACK_VAR(_g27,"_g27");
							HX_STACK_LINE(937)
							ci->jnAcc = _g27;
							HX_STACK_LINE(937)
							c->hash = (int)0;
						...
						if (((c == null()))){
							HX_STACK_LINE(938)
							{
								...
								if (((::zpp_nape::dynamics::ZPP_Contact_obj::zpp_pool == null()))){
									HX_STACK_LINE(938)
									::zpp_nape::dynamics::ZPP_Contact _g28 = ::zpp_nape::dynamics::ZPP_Contact_obj::__new();		HX_STACK_VAR(_g28,"_g28");
									HX_STACK_LINE(938)
									c = _g28;
								}
								else{
							...
							::zpp_nape::dynamics::ZPP_IContact ci = c->inner;		HX_STACK_VAR(ci,"ci");
							HX_STACK_LINE(938)
							Float _g29 = ci->jtAcc = (int)0;		HX_STACK_VAR(_g29,"_g29");
							HX_STACK_LINE(938)
							ci->jnAcc = _g29;
							HX_STACK_LINE(938)
							c->hash = (int)0;
...
bool ZPP_Collide_obj::testCollide( ::zpp_nape::shape::ZPP_Shape s1,::zpp_nape::shape::ZPP_Shape s2){
	HX_STACK_FRAME("zpp_nape.geom.ZPP_Collide","testCollide",0x3af49ee6,"zpp_nape.geom.ZPP_Collide.testCollide","zpp_nape/geom/Collide.hx",1043,0x9b695611)
	HX_STACK_ARG(s1,"s1")
	HX_STACK_ARG(s2,"s2")
	HX_STACK_LINE(1043)
	if (((s2->type == ::zpp_nape::util::ZPP_Flags_obj::id_ShapeType_POLYGON))){
...
bool ZPP_Collide_obj::flowCollide( ::zpp_nape::shape::ZPP_Shape s1,::zpp_nape::shape::ZPP_Shape s2,::zpp_nape::dynamics::ZPP_FluidArbiter arb){
	HX_STACK_FRAME("zpp_nape.geom.ZPP_Collide","flowCollide",0xd0a5baca,"zpp_nape.geom.ZPP_Collide.flowCollide","zpp_nape/geom/Collide.hx",1172,0x9b695611)
	HX_STACK_ARG(s1,"s1")
	HX_STACK_ARG(s2,"s2")
	HX_STACK_ARG(arb,"arb")
	HX_STACK_LINE(1172)
	if (((s2->type == ::zpp_nape::util::ZPP_Flags_obj::id_ShapeType_POLYGON))){
				...
				if ((cont)){
					...
					if ((total)){
						...
						if ((cont)){
													...
													HX_STACK_LINE(1322)
													{
														...
														struct _Function_14_1{
															inline static bool Block( ::zpp_nape::geom::ZPP_Vec2 &v,::zpp_nape::geom::ZPP_Vec2 &b,Float &t,::zpp_nape::geom::ZPP_Vec2 &u,::zpp_nape::geom::ZPP_Vec2 &a){
																HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Collide.hx",1324,0x9b695611)
																{
																	HX_STACK_LINE(1325)
																	...
																	struct _Function_15_1{
																		inline static bool Block( Float &_sx,Float &_sy,Float &_qy,Float &_vy,Float &_vx,Float &den,Float &t,Float &_qx){
																			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Collide.hx",1344,0x9b695611)
																			{
																				HX_STACK_LINE(1345)
																				...
																				struct _Function_16_1{
																					inline static bool Block( Float &_sx,Float &_sy,Float &_vy,Float &_vx,Float &txx,Float &den,Float &t){
																						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Collide.hx",1347,0x9b695611)
																						{
																							HX_STACK_LINE(1348)
																							Float sxx = ((((_vy * _sx) - (_vx * _sy))) * den);		HX_STACK_VAR(sxx,"sxx");
																							struct _Function_17_1{
																								inline static bool Block( Float &txx,Float &t){
																									HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Collide.hx",1349,0x9b695611)
																									{
																										HX_STACK_LINE(1350)
																										t = txx;
																										HX_STACK_LINE(1351)
												...
												if ((cx_cont1)){
													...
													while((true)){
														...
														HX_STACK_LINE(1375)
														{
															...
															struct _Function_15_1{
																inline static bool Block( ::zpp_nape::geom::ZPP_Vec2 &v,::zpp_nape::geom::ZPP_Vec2 &b,Float &t,::zpp_nape::geom::ZPP_Vec2 &u,::zpp_nape::geom::ZPP_Vec2 &a){
																	HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Collide.hx",1377,0x9b695611)
																	{
																		HX_STACK_LINE(1378)
																		Float _sx = 0.0;		HX_STACK_VAR(_sx,"_sx");
																		HX_STACK_LINE(1379)
																		...
																		struct _Function_16_1{
																			inline static bool Block( Float &_sx,Float &_sy,Float &_qy,Float &_vy,Float &_vx,Float &den,Float &t,Float &_qx){
																				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Collide.hx",1397,0x9b695611)
																				{
																					HX_STACK_LINE(1398)
																					den = (Float((int)1) / Float(den));
																					HX_STACK_LINE(1399)
																					...
																					struct _Function_17_1{
																						inline static bool Block( Float &_sx,Float &_sy,Float &_vy,Float &_vx,Float &txx,Float &den,Float &t){
																							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Collide.hx",1400,0x9b695611)
																							{
																								HX_STACK_LINE(1401)
																								Float sxx = ((((_vy * _sx) - (_vx * _sy))) * den);		HX_STACK_VAR(sxx,"sxx");
																								struct _Function_18_1{
																									inline static bool Block( Float &txx,Float &t){
																										HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Collide.hx",1402,0x9b695611)
																										{
																											HX_STACK_LINE(1403)
																											t = txx;
																											HX_STACK_LINE(1404)
																								...
																								HX_STACK_LINE(1402)
																								return (  (((bool((sxx > ::nape::Config_obj::epsilon)) && bool((sxx < ((int)1 - ::nape::Config_obj::epsilon)))))) ? bool(_Function_18_1::Block(txx,t)) : bool(false) );
																							}
																							return null();
																						}
																					};
																					HX_STACK_LINE(1400)
																					return (  (((bool((txx > ::nape::Config_obj::epsilon)) && bool((txx < ((int)1 - ::nape::Config_obj::epsilon)))))) ? bool(_Function_17_1::Block(_sx,_sy,_vy,_vx,txx,den,t)) : bool(false) );
																				}
																				return null();
																			}
																		};
																		HX_STACK_LINE(1397)
																		return (  ((((den * den) > (::nape::Config_obj::epsilon * ::nape::Config_obj::epsilon)))) ? bool(_Function_16_1::Block(_sx,_sy,_qy,_vy,_vx,den,t,_qx)) : bool(false) );
																	}
																	return null();
																}
															};
															HX_STACK_LINE(1377)
															if ((_Function_15_1::Block(v,b,t,u,a))){
																HX_STACK_LINE(1412)
																if (((t < min))){
																	HX_STACK_LINE(1413)
																	min = t;
												...
												HX_STACK_LINE(1460)
												{
													...
													while((true)){
														...
														HX_STACK_LINE(1467)
														{
															...
															struct _Function_15_1{
																inline static bool Block( ::zpp_nape::geom::ZPP_Vec2 &v,::zpp_nape::geom::ZPP_Vec2 &b,Float &t,::zpp_nape::geom::ZPP_Vec2 &u,::zpp_nape::geom::ZPP_Vec2 &a){
																	HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Collide.hx",1469,0x9b695611)
																	{
																		HX_STACK_LINE(1470)
																		Float _sx = 0.0;		HX_STACK_VAR(_sx,"_sx");
																		HX_STACK_LINE(1471)
																		...
																		struct _Function_16_1{
																			inline static bool Block( Float &_sx,Float &_sy,Float &_qy,Float &_vy,Float &_vx,Float &den,Float &t,Float &_qx){
																				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Collide.hx",1489,0x9b695611)
																				{
																					HX_STACK_LINE(1490)
																					den = (Float((int)1) / Float(den));
																					HX_STACK_LINE(1491)
																					...
																					struct _Function_17_1{
																						inline static bool Block( Float &_sx,Float &_sy,Float &_vy,Float &_vx,Float &txx,Float &den,Float &t){
																							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Collide.hx",1492,0x9b695611)
																							{
																								HX_STACK_LINE(1493)
																								Float sxx = ((((_vy * _sx) - (_vx * _sy))) * den);		HX_STACK_VAR(sxx,"sxx");
																								struct _Function_18_1{
																									inline static bool Block( Float &txx,Float &t){
																										HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Collide.hx",1494,0x9b695611)
																										{
																											HX_STACK_LINE(1495)
																											t = txx;
																											HX_STACK_LINE(1496)
													...
													if ((cx_cont1)){
														...
														while((true)){
															...
															HX_STACK_LINE(1520)
															{
																...
																struct _Function_16_1{
																	inline static bool Block( ::zpp_nape::geom::ZPP_Vec2 &v,::zpp_nape::geom::ZPP_Vec2 &b,Float &t,::zpp_nape::geom::ZPP_Vec2 &u,::zpp_nape::geom::ZPP_Vec2 &a){
																		HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Collide.hx",1522,0x9b695611)
																		{
																			HX_STACK_LINE(1523)
																			Float _sx = 0.0;		HX_STACK_VAR(_sx,"_sx");
																			HX_STACK_LINE(1524)
																			...
																			struct _Function_17_1{
																				inline static bool Block( Float &_sx,Float &_sy,Float &_qy,Float &_vy,Float &_vx,Float &den,Float &t,Float &_qx){
																					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Collide.hx",1542,0x9b695611)
																					{
																						HX_STACK_LINE(1543)
																						den = (Float((int)1) / Float(den));
																						HX_STACK_LINE(1544)
																						...
																						struct _Function_18_1{
																							inline static bool Block( Float &_sx,Float &_sy,Float &_vy,Float &_vx,Float &txx,Float &den,Float &t){
																								HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Collide.hx",1545,0x9b695611)
																								{
																									HX_STACK_LINE(1546)
																									Float sxx = ((((_vy * _sx) - (_vx * _sy))) * den);		HX_STACK_VAR(sxx,"sxx");
																									struct _Function_19_1{
																										inline static bool Block( Float &txx,Float &t){
																											HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Collide.hx",1547,0x9b695611)
																											{
																												HX_STACK_LINE(1548)
																												t = txx;
																												HX_STACK_LINE(1549)
																									...
																									HX_STACK_LINE(1547)
																									return (  (((bool((sxx > ::nape::Config_obj::epsilon)) && bool((sxx < ((int)1 - ::nape::Config_obj::epsilon)))))) ? bool(_Function_19_1::Block(txx,t)) : bool(false) );
																								}
																								return null();
																							}
																						};
																						HX_STACK_LINE(1545)
																						return (  (((bool((txx > ::nape::Config_obj::epsilon)) && bool((txx < ((int)1 - ::nape::Config_obj::epsilon)))))) ? bool(_Function_18_1::Block(_sx,_sy,_vy,_vx,txx,den,t)) : bool(false) );
																					}
																					return null();
																				}
																			};
																			HX_STACK_LINE(1542)
																			return (  ((((den * den) > (::nape::Config_obj::epsilon * ::nape::Config_obj::epsilon)))) ? bool(_Function_17_1::Block(_sx,_sy,_qy,_vy,_vx,den,t,_qx)) : bool(false) );
																		}
																		return null();
																	}
																};
																HX_STACK_LINE(1522)
																if ((_Function_16_1::Block(v,b,t,u,a))){
																	HX_STACK_LINE(1557)
																	if (((t < min))){
																		HX_STACK_LINE(1558)
																		min = t;
								...
								if ((poly1)){
									...
									if ((!(out1->__get(ind1)))){
										...
										struct _Function_10_1{
											inline static bool Block( ::zpp_nape::geom::ZPP_Vec2 &ex,::zpp_nape::geom::ZPP_Vec2 &fst_vert){
												HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Collide.hx",1606,0x9b695611)
												{
													HX_STACK_LINE(1606)
													...
													HX_STACK_LINE(1606)
													return (_g8 < ::nape::Config_obj::epsilon);
												}
												return null();
											}
										};
										HX_STACK_LINE(1606)
										if (((  (((fst_vert != null()))) ? bool(_Function_10_1::Block(ex,fst_vert)) : bool(false) ))){
											HX_STACK_LINE(1606)
											break;
										}
										HX_STACK_LINE(1607)
										...
										HX_STACK_LINE(1621)
										{
											...
											while((true)){
												...
												HX_STACK_LINE(1626)
												{
													...
													struct _Function_13_1{
														inline static bool Block( ::zpp_nape::geom::ZPP_Vec2 &v,::zpp_nape::geom::ZPP_Vec2 &b,Float &t,::zpp_nape::geom::ZPP_Vec2 &u,::zpp_nape::geom::ZPP_Vec2 &a){
															HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Collide.hx",1628,0x9b695611)
															{
																HX_STACK_LINE(1629)
																Float _sx = 0.0;		HX_STACK_VAR(_sx,"_sx");
																HX_STACK_LINE(1630)
																...
																struct _Function_14_1{
																	inline static bool Block( Float &_sx,Float &_sy,Float &_qy,Float &_vy,Float &_vx,Float &den,Float &t,Float &_qx){
																		HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Collide.hx",1648,0x9b695611)
																		{
																			HX_STACK_LINE(1649)
																			den = (Float((int)1) / Float(den));
																			HX_STACK_LINE(1650)
																			...
																			struct _Function_15_1{
																				inline static bool Block( Float &_sx,Float &_sy,Float &_vy,Float &_vx,Float &txx,Float &den,Float &t){
																					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Collide.hx",1651,0x9b695611)
																					{
																						HX_STACK_LINE(1652)
																						Float sxx = ((((_vy * _sx) - (_vx * _sy))) * den);		HX_STACK_VAR(sxx,"sxx");
																						struct _Function_16_1{
																							inline static bool Block( Float &txx,Float &t){
																								HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Collide.hx",1653,0x9b695611)
																								{
																									HX_STACK_LINE(1654)
																									t = txx;
																									HX_STACK_LINE(1655)
													...
													if ((_Function_13_1::Block(v,b,t,u,a))){
														...
														if (((t >= max))){
															...
															indo = ind2;
															HX_STACK_LINE(1666)
															int _g9 = ++(icnt);		HX_STACK_VAR(_g9,"_g9");
															HX_STACK_LINE(1666)
															if (((_g9 == cnt))){
																HX_STACK_LINE(1667)
																max = t;
											...
											while((true)){
												...
												HX_STACK_LINE(1687)
												{
													...
													struct _Function_13_1{
														inline static bool Block( ::zpp_nape::geom::ZPP_Vec2 &v,::zpp_nape::geom::ZPP_Vec2 &b,Float &t,::zpp_nape::geom::ZPP_Vec2 &u,::zpp_nape::geom::ZPP_Vec2 &a){
															HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Collide.hx",1689,0x9b695611)
															{
																HX_STACK_LINE(1690)
																Float _sx = 0.0;		HX_STACK_VAR(_sx,"_sx");
																HX_STACK_LINE(1691)
																...
																struct _Function_14_1{
																	inline static bool Block( Float &_sx,Float &_sy,Float &_qy,Float &_vy,Float &_vx,Float &den,Float &t,Float &_qx){
																		HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Collide.hx",1709,0x9b695611)
																		{
																			HX_STACK_LINE(1710)
																			den = (Float((int)1) / Float(den));
																			HX_STACK_LINE(1711)
																			...
																			struct _Function_15_1{
																				inline static bool Block( Float &_sx,Float &_sy,Float &_vy,Float &_vx,Float &txx,Float &den,Float &t){
																					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Collide.hx",1712,0x9b695611)
																					{
																						HX_STACK_LINE(1713)
																						Float sxx = ((((_vy * _sx) - (_vx * _sy))) * den);		HX_STACK_VAR(sxx,"sxx");
																						struct _Function_16_1{
																							inline static bool Block( Float &txx,Float &t){
																								HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Collide.hx",1714,0x9b695611)
																								{
																									HX_STACK_LINE(1715)
																									t = txx;
																									HX_STACK_LINE(1716)
													...
													if ((_Function_13_1::Block(v,b,t,u,a))){
														...
														if (((t >= max))){
															...
															indo = ind2;
															HX_STACK_LINE(1727)
															int _g10 = ++(icnt);		HX_STACK_VAR(_g10,"_g10");
															HX_STACK_LINE(1727)
															if (((_g10 == cnt))){
																HX_STACK_LINE(1728)
																max = t;
										...
										struct _Function_10_1{
											inline static bool Block( Float &cx,Float &cy,::zpp_nape::geom::ZPP_Vec2 &fst_vert){
												HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Collide.hx",1766,0x9b695611)
												{
													HX_STACK_LINE(1766)
													...
													HX_STACK_LINE(1766)
													return (_g11 < ::nape::Config_obj::epsilon);
												}
												return null();
											}
										};
										HX_STACK_LINE(1766)
										if (((  (((fst_vert != null()))) ? bool(_Function_10_1::Block(cx,cy,fst_vert)) : bool(false) ))){
											HX_STACK_LINE(1766)
											break;
										}
										HX_STACK_LINE(1767)
										...
										HX_STACK_LINE(1767)
										::zpp_nape::geom::ZPP_Collide_obj::flowpoly->add(_g13);
										HX_STACK_LINE(1768)
										if (((fst_vert == null()))){
											HX_STACK_LINE(1768)
											fst_vert = ::zpp_nape::geom::ZPP_Collide_obj::flowpoly->head->elt;
									...
									if ((!(out2->__get(ind2)))){
										...
										struct _Function_10_1{
											inline static bool Block( ::zpp_nape::geom::ZPP_Vec2 &ex,::zpp_nape::geom::ZPP_Vec2 &fst_vert){
												HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Collide.hx",1784,0x9b695611)
												{
													HX_STACK_LINE(1784)
													...
													HX_STACK_LINE(1784)
													return (_g14 < ::nape::Config_obj::epsilon);
												}
												return null();
											}
										};
										...
										HX_STACK_LINE(1799)
										{
											...
											while((true)){
												...
												HX_STACK_LINE(1804)
												{
													...
													struct _Function_13_1{
														inline static bool Block( ::zpp_nape::geom::ZPP_Vec2 &v,::zpp_nape::geom::ZPP_Vec2 &b,Float &t,::zpp_nape::geom::ZPP_Vec2 &u,::zpp_nape::geom::ZPP_Vec2 &a){
															HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Collide.hx",1806,0x9b695611)
															{
																HX_STACK_LINE(1807)
																Float _sx = 0.0;		HX_STACK_VAR(_sx,"_sx");
																HX_STACK_LINE(1808)
																...
																struct _Function_14_1{
																	inline static bool Block( Float &_sx,Float &_sy,Float &_qy,Float &_vy,Float &_vx,Float &den,Float &t,Float &_qx){
																		HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Collide.hx",1826,0x9b695611)
																		{
																			HX_STACK_LINE(1827)
																			den = (Float((int)1) / Float(den));
																			HX_STACK_LINE(1828)
																			...
																			struct _Function_15_1{
																				inline static bool Block( Float &_sx,Float &_sy,Float &_vy,Float &_vx,Float &txx,Float &den,Float &t){
																					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Collide.hx",1829,0x9b695611)
																					{
																						HX_STACK_LINE(1830)
																						Float sxx = ((((_vy * _sx) - (_vx * _sy))) * den);		HX_STACK_VAR(sxx,"sxx");
																						struct _Function_16_1{
																							inline static bool Block( Float &txx,Float &t){
																								HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Collide.hx",1831,0x9b695611)
																								{
																									HX_STACK_LINE(1832)
																									t = txx;
																									HX_STACK_LINE(1833)
													...
													if ((_Function_13_1::Block(v,b,t,u,a))){
														...
														if (((t >= max))){
															...
															indo = ind1;
															HX_STACK_LINE(1844)
															int _g15 = ++(icnt);		HX_STACK_VAR(_g15,"_g15");
															HX_STACK_LINE(1844)
															if (((_g15 == cnt))){
																HX_STACK_LINE(1845)
																max = t;
											...
											while((true)){
												...
												HX_STACK_LINE(1865)
												{
													...
													struct _Function_13_1{
														inline static bool Block( ::zpp_nape::geom::ZPP_Vec2 &v,::zpp_nape::geom::ZPP_Vec2 &b,Float &t,::zpp_nape::geom::ZPP_Vec2 &u,::zpp_nape::geom::ZPP_Vec2 &a){
															HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Collide.hx",1867,0x9b695611)
															{
																HX_STACK_LINE(1868)
																Float _sx = 0.0;		HX_STACK_VAR(_sx,"_sx");
																HX_STACK_LINE(1869)
																...
																struct _Function_14_1{
																	inline static bool Block( Float &_sx,Float &_sy,Float &_qy,Float &_vy,Float &_vx,Float &den,Float &t,Float &_qx){
																		HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Collide.hx",1887,0x9b695611)
																		{
																			HX_STACK_LINE(1888)
																			den = (Float((int)1) / Float(den));
																			HX_STACK_LINE(1889)
																			...
																			struct _Function_15_1{
																				inline static bool Block( Float &_sx,Float &_sy,Float &_vy,Float &_vx,Float &txx,Float &den,Float &t){
																					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Collide.hx",1890,0x9b695611)
																					{
																						HX_STACK_LINE(1891)
																						Float sxx = ((((_vy * _sx) - (_vx * _sy))) * den);		HX_STACK_VAR(sxx,"sxx");
																						struct _Function_16_1{
																							inline static bool Block( Float &txx,Float &t){
																								HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Collide.hx",1892,0x9b695611)
																								{
																									HX_STACK_LINE(1893)
																									t = txx;
																									HX_STACK_LINE(1894)
													...
													if ((_Function_13_1::Block(v,b,t,u,a))){
														...
														if (((t >= max))){
															...
															indo = ind1;
															HX_STACK_LINE(1905)
															int _g16 = ++(icnt);		HX_STACK_VAR(_g16,"_g16");
															HX_STACK_LINE(1905)
															if (((_g16 == cnt))){
																HX_STACK_LINE(1906)
																max = t;
										...
										struct _Function_10_1{
											inline static bool Block( Float &cx,Float &cy,::zpp_nape::geom::ZPP_Vec2 &fst_vert){
												HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Collide.hx",1944,0x9b695611)
												{
													HX_STACK_LINE(1944)
													...
													HX_STACK_LINE(1944)
													return (_g17 < ::nape::Config_obj::epsilon);
												}
												return null();
											}
										};
										...
										HX_STACK_LINE(1945)
										::zpp_nape::geom::ZPP_Vec2 _g19;		HX_STACK_VAR(_g19,"_g19");
										HX_STACK_LINE(1945)
										{
											HX_STACK_LINE(1945)
											bool immutable = false;		HX_STACK_VAR(immutable,"immutable");
											...
											HX_STACK_LINE(1945)
											{
												...
												if (((::zpp_nape::geom::ZPP_Vec2_obj::zpp_pool == null()))){
													HX_STACK_LINE(1945)
													::zpp_nape::geom::ZPP_Vec2 _g18 = ::zpp_nape::geom::ZPP_Vec2_obj::__new();		HX_STACK_VAR(_g18,"_g18");
													HX_STACK_LINE(1945)
													ret = _g18;
												}
												else{
										...
										HX_STACK_LINE(1945)
										::zpp_nape::geom::ZPP_Collide_obj::flowpoly->add(_g19);
										HX_STACK_LINE(1946)
										if (((fst_vert == null()))){
											HX_STACK_LINE(1946)
											fst_vert = ::zpp_nape::geom::ZPP_Collide_obj::flowpoly->head->elt;
							...
							HX_STACK_LINE(1954)
							if (((bool((bool((::zpp_nape::geom::ZPP_Collide_obj::flowpoly->head != null())) && bool((::zpp_nape::geom::ZPP_Collide_obj::flowpoly->head->next != null())))) && bool((::zpp_nape::geom::ZPP_Collide_obj::flowpoly->head->next->next != null()))))){
								HX_STACK_LINE(1955)
								Float area = 0.0;		HX_STACK_VAR(area,"area");
								HX_STACK_LINE(1956)
				...
				if ((total)){
					...
					struct _Function_5_1{
						inline static bool Block( ::zpp_nape::geom::ZPP_Vec2 &v0,::zpp_nape::shape::ZPP_Shape &s1){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Collide.hx",2085,0x9b695611)
							{
								HX_STACK_LINE(2086)
								Float minDist = s1->circle->radius;		HX_STACK_VAR(minDist,"minDist");
								HX_STACK_LINE(2087)
					...
					struct _Function_5_2{
						inline static bool Block( ::zpp_nape::geom::ZPP_Vec2 &v1,::zpp_nape::shape::ZPP_Shape &s1){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Collide.hx",2096,0x9b695611)
							{
								HX_STACK_LINE(2097)
								Float minDist = s1->circle->radius;		HX_STACK_VAR(minDist,"minDist");
								HX_STACK_LINE(2098)
					...
					HX_STACK_LINE(2085)
					if (((  (((dt <= ((v0->y * a0->gnormx) - (v0->x * a0->gnormy))))) ? bool(_Function_5_1::Block(v0,s1)) : bool((  (((dt >= ((v1->y * a0->gnormx) - (v1->x * a0->gnormy))))) ? bool(_Function_5_2::Block(v1,s1)) : bool(true) )) ))){
						HX_STACK_LINE(2108)
						...
						if ((total1)){
									...
									if (((_this->body != null()))){
										...
										HX_STACK_LINE(2130)
										{
											...
											if ((_this1->zip_axis)){
												...
												{
													HX_STACK_LINE(2130)
													Float _g20 = ::Math_obj::sin(_this1->rot);		HX_STACK_VAR(_g20,"_g20");
													HX_STACK_LINE(2130)
													_this1->axisx = _g20;
													HX_STACK_LINE(2130)
													Float _g21 = ::Math_obj::cos(_this1->rot);		HX_STACK_VAR(_g21,"_g21");
													HX_STACK_LINE(2130)
													_this1->axisy = _g21;
													HX_STACK_LINE(2130)
													Dynamic();
							...
							if (((vi1 == null()))){
								...
								HX_STACK_LINE(2162)
								::zpp_nape::geom::ZPP_Vec2 _g22 = fst_vert = vi1;		HX_STACK_VAR(_g22,"_g22");
								HX_STACK_LINE(2162)
								::zpp_nape::geom::ZPP_Collide_obj::flowpoly->add(_g22);
							}
							HX_STACK_LINE(2163)
							while((true)){
								HX_STACK_LINE(2163)
								...
								if (((state == (int)1))){
									...
									if ((ins->__get(vind))){
										...
										HX_STACK_LINE(2170)
										if (((_g23 < ::nape::Config_obj::epsilon))){
											HX_STACK_LINE(2170)
											break;
										}
										HX_STACK_LINE(2171)
										...
										HX_STACK_LINE(2176)
										Float tval;		HX_STACK_VAR(tval,"tval");
										HX_STACK_LINE(2176)
										{
											HX_STACK_LINE(2177)
											Float vx = 0.0;		HX_STACK_VAR(vx,"vx");
										...
										HX_STACK_LINE(2213)
										if (((_g24 < ::nape::Config_obj::epsilon))){
											HX_STACK_LINE(2213)
											break;
										}
										HX_STACK_LINE(2214)
										...
										HX_STACK_LINE(2214)
										::zpp_nape::geom::ZPP_Collide_obj::flowpoly->add(_g26);
										HX_STACK_LINE(2215)
										state = (int)2;
									}
								}
												...
												HX_STACK_LINE(2228)
												{
													...
													if ((inte->__get(vind))){
														...
														if ((ins->__get(vind2))){
															...
															HX_STACK_LINE(2270)
															if (((_g27 < ::nape::Config_obj::epsilon))){
																HX_STACK_LINE(2271)
																state = (int)0;
																HX_STACK_LINE(2272)
																{
															...
															HX_STACK_LINE(2277)
															::zpp_nape::geom::ZPP_Vec2 cp;		HX_STACK_VAR(cp,"cp");
															HX_STACK_LINE(2277)
															{
																HX_STACK_LINE(2277)
																bool immutable = false;		HX_STACK_VAR(immutable,"immutable");
																...
																HX_STACK_LINE(2277)
																{
																	...
																	if (((::zpp_nape::geom::ZPP_Vec2_obj::zpp_pool == null()))){
																		HX_STACK_LINE(2277)
																		::zpp_nape::geom::ZPP_Vec2 _g28 = ::zpp_nape::geom::ZPP_Vec2_obj::__new();		HX_STACK_VAR(_g28,"_g28");
																		HX_STACK_LINE(2277)
																		ret = _g28;
																	}
																	else{
															...
															HX_STACK_LINE(2290)
															{
																...
																HX_STACK_LINE(2307)
																if ((((D * D) < ::nape::Config_obj::epsilon))){
																	HX_STACK_LINE(2308)
																	if (((D < (int)0))){
																		HX_STACK_LINE(2308)
																		t0 = 10.0;
																		...
																		HX_STACK_LINE(2309)
																		Float _g29 = t1 = (Float(-(B)) / Float((((int)2 * A))));		HX_STACK_VAR(_g29,"_g29");
																		HX_STACK_LINE(2309)
																		t0 = _g29;
																	}
																	HX_STACK_LINE(2310)
																	...
																	HX_STACK_LINE(2313)
																	Float _g30 = ::Math_obj::sqrt(D);		HX_STACK_VAR(_g30,"_g30");
																	HX_STACK_LINE(2313)
																	D = _g30;
																	HX_STACK_LINE(2314)
																	A = (Float((int)1) / Float((((int)2 * A))));
															...
															if (((bool((t0 < ((int)1 - ::nape::Config_obj::epsilon))) && bool((t1 > ::nape::Config_obj::epsilon))))){
																...
																struct _Function_16_1{
																	inline static bool Block( Float &cx,Float &cy,::zpp_nape::geom::ZPP_Vec2 &fst_vert){
																		HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Collide.hx",2336,0x9b695611)
																		{
																			HX_STACK_LINE(2336)
																			...
																			HX_STACK_LINE(2336)
																			return (_g31 < ::nape::Config_obj::epsilon);
																		}
																		return null();
																	}
																};
																HX_STACK_LINE(2336)
																if (((  (((fst_vert != null()))) ? bool(_Function_16_1::Block(cx,cy,fst_vert)) : bool(false) ))){
																	HX_STACK_LINE(2337)
																	state = (int)0;
																	HX_STACK_LINE(2338)
																	{
																...
																HX_STACK_LINE(2343)
																{
																	...
																	HX_STACK_LINE(2343)
																	{
																		...
																		if (((::zpp_nape::geom::ZPP_Vec2_obj::zpp_pool == null()))){
																			HX_STACK_LINE(2343)
																			::zpp_nape::geom::ZPP_Vec2 _g32 = ::zpp_nape::geom::ZPP_Vec2_obj::__new();		HX_STACK_VAR(_g32,"_g32");
																			HX_STACK_LINE(2343)
																			ret = _g32;
																		}
																		else{
																...
																if ((two)){
																	...
																	HX_STACK_LINE(2366)
																	::zpp_nape::geom::ZPP_Vec2 _g34;		HX_STACK_VAR(_g34,"_g34");
																	HX_STACK_LINE(2366)
																	{
																		HX_STACK_LINE(2366)
																		bool immutable = false;		HX_STACK_VAR(immutable,"immutable");
																		...
																		HX_STACK_LINE(2366)
																		{
																			...
																			if (((::zpp_nape::geom::ZPP_Vec2_obj::zpp_pool == null()))){
																				HX_STACK_LINE(2366)
																				::zpp_nape::geom::ZPP_Vec2 _g33 = ::zpp_nape::geom::ZPP_Vec2_obj::__new();		HX_STACK_VAR(_g33,"_g33");
																				HX_STACK_LINE(2366)
																				ret = _g33;
																			}
																			else{
																	...
																	HX_STACK_LINE(2366)
																	::zpp_nape::geom::ZPP_Collide_obj::flowpoly->add(_g34);
																}
															}
														}
													}
												...
												HX_STACK_LINE(2381)
												{
													...
													if ((inte->__get(vind))){
														...
														if ((ins->__get(vind2))){
															...
															HX_STACK_LINE(2423)
															if (((_g35 < ::nape::Config_obj::epsilon))){
																HX_STACK_LINE(2424)
																state = (int)0;
																HX_STACK_LINE(2425)
																{
															...
															HX_STACK_LINE(2430)
															{
																...
																HX_STACK_LINE(2430)
																{
																	...
																	if (((::zpp_nape::geom::ZPP_Vec2_obj::zpp_pool == null()))){
																		HX_STACK_LINE(2430)
																		::zpp_nape::geom::ZPP_Vec2 _g36 = ::zpp_nape::geom::ZPP_Vec2_obj::__new();		HX_STACK_VAR(_g36,"_g36");
																		HX_STACK_LINE(2430)
																		ret = _g36;
																	}
																	else{
															...
															HX_STACK_LINE(2443)
															{
																...
																if ((((D * D) < ::nape::Config_obj::epsilon))){
																	...
																	if (((D < (int)0))){
																		...
																		HX_STACK_LINE(2462)
																		Float _g37 = t1 = (Float(-(B)) / Float((((int)2 * A))));		HX_STACK_VAR(_g37,"_g37");
																		HX_STACK_LINE(2462)
																		t0 = _g37;
																	}
																	HX_STACK_LINE(2463)
																	...
																	HX_STACK_LINE(2466)
																	Float _g38 = ::Math_obj::sqrt(D);		HX_STACK_VAR(_g38,"_g38");
																	HX_STACK_LINE(2466)
																	D = _g38;
																	HX_STACK_LINE(2467)
																	A = (Float((int)1) / Float((((int)2 * A))));
															...
															if (((bool((t0 < ((int)1 - ::nape::Config_obj::epsilon))) && bool((t1 > ::nape::Config_obj::epsilon))))){
																...
																struct _Function_16_1{
																	inline static bool Block( Float &cx,Float &cy,::zpp_nape::geom::ZPP_Vec2 &fst_vert){
																		HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Collide.hx",2489,0x9b695611)
																		{
																			HX_STACK_LINE(2489)
																			...
																			HX_STACK_LINE(2489)
																			return (_g39 < ::nape::Config_obj::epsilon);
																		}
																		return null();
																	}
																};
																...
																HX_STACK_LINE(2496)
																{
																	...
																	HX_STACK_LINE(2496)
																	{
																		...
																		if (((::zpp_nape::geom::ZPP_Vec2_obj::zpp_pool == null()))){
																			HX_STACK_LINE(2496)
																			::zpp_nape::geom::ZPP_Vec2 _g40 = ::zpp_nape::geom::ZPP_Vec2_obj::__new();		HX_STACK_VAR(_g40,"_g40");
																			HX_STACK_LINE(2496)
																			ret = _g40;
																		}
																		else{
																...
																if ((two)){
																	...
																	HX_STACK_LINE(2519)
																	::zpp_nape::geom::ZPP_Vec2 _g42;		HX_STACK_VAR(_g42,"_g42");
																	HX_STACK_LINE(2519)
																	{
																		HX_STACK_LINE(2519)
																		bool immutable = false;		HX_STACK_VAR(immutable,"immutable");
																		...
																		HX_STACK_LINE(2519)
																		{
																			...
																			if (((::zpp_nape::geom::ZPP_Vec2_obj::zpp_pool == null()))){
																				HX_STACK_LINE(2519)
																				::zpp_nape::geom::ZPP_Vec2 _g41 = ::zpp_nape::geom::ZPP_Vec2_obj::__new();		HX_STACK_VAR(_g41,"_g41");
																				HX_STACK_LINE(2519)
																				ret = _g41;
																			}
																			else{
																	...
																	HX_STACK_LINE(2519)
																	::zpp_nape::geom::ZPP_Collide_obj::flowpoly->add(_g42);
																}
															}
														}
													}
							...
							if (((::zpp_nape::geom::ZPP_Collide_obj::flowpoly->head == null()))){
								...
								HX_STACK_LINE(2537)
								if (((::zpp_nape::geom::ZPP_Collide_obj::flowpoly->head->next == null()))){
									HX_STACK_LINE(2538)
									...
									while((true)){
										HX_STACK_LINE(2677)
										if ((!((!(((::zpp_nape::geom::ZPP_Collide_obj::flowsegs->head == null()))))))){
											HX_STACK_LINE(2677)
											break;
										}
										HX_STACK_LINE(2678)
										...
										HX_STACK_LINE(2708)
										{
											HX_STACK_LINE(2709)
											{
												...
												{
													HX_STACK_LINE(2719)
													Float _g43 = ::Math_obj::sqrt(d);		HX_STACK_VAR(_g43,"_g43");
													HX_STACK_LINE(2719)
													imag = (Float(1.0) / Float(_g43));
												}
												HX_STACK_LINE(2720)
												{
													HX_STACK_LINE(2721)
										...
										HX_STACK_LINE(2775)
										{
											...
											HX_STACK_LINE(2781)
											ccom = (Float(((((0.66666666666666663 * s1->circle->radius) * sin) * sin) * sin)) / Float(((theta - (cos * sin)))));
										}
										HX_STACK_LINE(2783)
										{
											HX_STACK_LINE(2784)
		...
		if (((ds > (cr * cr)))){
			...
			HX_STACK_LINE(2867)
			if (((ds < (::nape::Config_obj::epsilon * ::nape::Config_obj::epsilon)))){
				HX_STACK_LINE(2868)
				...
				if (((x1 <= -(c1->radius)))){
					...
					if (((x2 <= -(c2->radius)))){
						...
						HX_STACK_LINE(2885)
						{
							...
							HX_STACK_LINE(2891)
							y1 = (Float(((((0.66666666666666663 * c1->radius) * sin) * sin) * sin)) / Float(((theta - (cos * sin)))));
						}
						HX_STACK_LINE(2893)
						{
							HX_STACK_LINE(2894)
							...
							HX_STACK_LINE(2899)
							y2 = (Float(((((0.66666666666666663 * c2->radius) * sin) * sin) * sin)) / Float(((theta - (cos * sin)))));
						}
						HX_STACK_LINE(2901)
