					...
					HX_STACK_LINE(214)
					{
						...
						HX_STACK_LINE(217)
						{
							...
							while((true)){
								...
								{
									HX_STACK_LINE(222)
									::zpp_nape::geom::ZPP_PartitionVertex pleft;		HX_STACK_VAR(pleft,"pleft");
									HX_STACK_LINE(222)
									if (((cx_ite->next == null()))){
										HX_STACK_LINE(222)
										pleft = p->next;
									...
									HX_STACK_LINE(235)
									{
										...
										while((true)){
											...
											HX_STACK_LINE(239)
											{
												...
												if (((qdiag == p))){
													HX_STACK_LINE(241)
													::zpp_nape::geom::ZPP_PartitionVertex qleft;		HX_STACK_VAR(qleft,"qleft");
													HX_STACK_LINE(241)
													if (((cx_ite1->next == null()))){
														HX_STACK_LINE(241)
														qleft = q->next;
													}
													else{
														HX_STACK_LINE(241)
														qleft = cx_ite1->next->elt;
													}
													HX_STACK_LINE(242)
													bool _g = ::zpp_nape::geom::ZPP_Convex_obj::isinner(qleft,q,qright);		HX_STACK_VAR(_g,"_g");
													HX_STACK_LINE(242)
													removable = _g;
													HX_STACK_LINE(243)
													break;
									...
									if ((removable)){
										HX_STACK_LINE(252)
										::zpp_nape::util::ZNPNode_ZPP_PartitionVertex _g1 = p->diagonals->erase(ppre);		HX_STACK_VAR(_g1,"_g1");
										HX_STACK_LINE(252)
										cx_ite = _g1;
										HX_STACK_LINE(253)
