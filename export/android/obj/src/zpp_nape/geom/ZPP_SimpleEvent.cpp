...
Void ZPP_SimpleEvent_obj::free( ){
{
		...
		this->vertex = null();
		HX_STACK_LINE(432)
		::zpp_nape::geom::ZPP_SimpleSeg _g = this->segment2 = null();		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(432)
		this->segment = _g;
		HX_STACK_LINE(433)
		this->node = null();
...
bool ZPP_SimpleEvent_obj::less_xy( ::zpp_nape::geom::ZPP_SimpleEvent a,::zpp_nape::geom::ZPP_SimpleEvent b){
	HX_STACK_FRAME("zpp_nape.geom.ZPP_SimpleEvent","less_xy",0x1f0bac0b,"zpp_nape.geom.ZPP_SimpleEvent.less_xy","zpp_nape/geom/Simple.hx",395,0x62f156db)
	HX_STACK_ARG(a,"a")
	HX_STACK_ARG(b,"b")
	HX_STACK_LINE(395)
...
::zpp_nape::geom::ZPP_SimpleEvent ZPP_SimpleEvent_obj::get( ::zpp_nape::geom::ZPP_SimpleVert v){
	...
	HX_STACK_LINE(442)
	{
		...
		if (((::zpp_nape::geom::ZPP_SimpleEvent_obj::zpp_pool == null()))){
			HX_STACK_LINE(444)
			::zpp_nape::geom::ZPP_SimpleEvent _g = ::zpp_nape::geom::ZPP_SimpleEvent_obj::__new();		HX_STACK_VAR(_g,"_g");
			HX_STACK_LINE(444)
			ret = _g;
		}
		else{
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsInt,(int)offsetof(ZPP_SimpleEvent_obj,type),HX_CSTRING("type")},
	{hx::fsObject /*::zpp_nape::geom::ZPP_SimpleVert*/ ,(int)offsetof(ZPP_SimpleEvent_obj,vertex),HX_CSTRING("vertex")},
	{hx::fsObject /*::zpp_nape::geom::ZPP_SimpleSeg*/ ,(int)offsetof(ZPP_SimpleEvent_obj,segment),HX_CSTRING("segment")},
	{hx::fsObject /*::zpp_nape::geom::ZPP_SimpleSeg*/ ,(int)offsetof(ZPP_SimpleEvent_obj,segment2),HX_CSTRING("segment2")},
	{hx::fsObject /*::zpp_nape::util::ZPP_Set_ZPP_SimpleEvent*/ ,(int)offsetof(ZPP_SimpleEvent_obj,node),HX_CSTRING("node")},
	{hx::fsObject /*::zpp_nape::geom::ZPP_SimpleEvent*/ ,(int)offsetof(ZPP_SimpleEvent_obj,next),HX_CSTRING("next")},
	{ hx::fsUnknown, 0, null()}
};
#endif
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("zpp_nape.geom.ZPP_SimpleEvent"), hx::TCanCast< ZPP_SimpleEvent_obj> ,sStaticFields,sMemberFields,
