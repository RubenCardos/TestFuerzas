...
::zpp_nape::geom::ZPP_SimplifyV ZPP_SimplifyV_obj::get( ::zpp_nape::geom::ZPP_GeomVert v){
	...
	HX_STACK_LINE(215)
	{
		...
		if (((::zpp_nape::geom::ZPP_SimplifyV_obj::zpp_pool == null()))){
			HX_STACK_LINE(217)
			::zpp_nape::geom::ZPP_SimplifyV _g = ::zpp_nape::geom::ZPP_SimplifyV_obj::__new();		HX_STACK_VAR(_g,"_g");
			HX_STACK_LINE(217)
			ret = _g;
		}
		else{
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsFloat,(int)offsetof(ZPP_SimplifyV_obj,x),HX_CSTRING("x")},
	{hx::fsFloat,(int)offsetof(ZPP_SimplifyV_obj,y),HX_CSTRING("y")},
	{hx::fsObject /*::zpp_nape::geom::ZPP_SimplifyV*/ ,(int)offsetof(ZPP_SimplifyV_obj,next),HX_CSTRING("next")},
	{hx::fsObject /*::zpp_nape::geom::ZPP_SimplifyV*/ ,(int)offsetof(ZPP_SimplifyV_obj,prev),HX_CSTRING("prev")},
	{hx::fsBool,(int)offsetof(ZPP_SimplifyV_obj,flag),HX_CSTRING("flag")},
	{hx::fsBool,(int)offsetof(ZPP_SimplifyV_obj,forced),HX_CSTRING("forced")},
	{ hx::fsUnknown, 0, null()}
};
#endif
