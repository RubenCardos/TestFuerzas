...
bool ZPP_Triangular_obj::lt( ::zpp_nape::geom::ZPP_PartitionVertex p,::zpp_nape::geom::ZPP_PartitionVertex q){
	HX_STACK_FRAME("zpp_nape.geom.ZPP_Triangular","lt",0xe312b489,"zpp_nape.geom.ZPP_Triangular.lt","zpp_nape/geom/Triangular.hx",616,0x53295a96)
	HX_STACK_ARG(p,"p")
	HX_STACK_ARG(q,"q")
	HX_STACK_LINE(616)
...
bool ZPP_Triangular_obj::delaunay( ::zpp_nape::geom::ZPP_PartitionVertex A,::zpp_nape::geom::ZPP_PartitionVertex B,::zpp_nape::geom::ZPP_PartitionVertex C,::zpp_nape::geom::ZPP_PartitionVertex D){
	...
	struct _Function_1_1{
		inline static bool Block( Float &vx,::zpp_nape::geom::ZPP_PartitionVertex &B,Float &uy,Float &ux,::zpp_nape::geom::ZPP_PartitionVertex &A,Float &vy,::zpp_nape::geom::ZPP_PartitionVertex &C){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Triangular.hx",641,0x53295a96)
			{
				HX_STACK_LINE(642)
				{
					HX_STACK_LINE(643)
	...
	struct _Function_1_2{
		inline static bool Block( Float &vx,::zpp_nape::geom::ZPP_PartitionVertex &B,Float &uy,::zpp_nape::geom::ZPP_PartitionVertex &D,Float &ux,Float &vy,::zpp_nape::geom::ZPP_PartitionVertex &C){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Triangular.hx",651,0x53295a96)
			{
				HX_STACK_LINE(652)
				{
					HX_STACK_LINE(653)
	...
	struct _Function_1_3{
		inline static bool Block( Float &vx,Float &uy,::zpp_nape::geom::ZPP_PartitionVertex &D,Float &ux,::zpp_nape::geom::ZPP_PartitionVertex &A,Float &vy,::zpp_nape::geom::ZPP_PartitionVertex &C){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Triangular.hx",661,0x53295a96)
			{
				HX_STACK_LINE(662)
				{
					HX_STACK_LINE(663)
	...
	struct _Function_1_4{
		inline static bool Block( Float &vx,::zpp_nape::geom::ZPP_PartitionVertex &B,Float &uy,::zpp_nape::geom::ZPP_PartitionVertex &D,Float &ux,::zpp_nape::geom::ZPP_PartitionVertex &A,Float &vy){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Triangular.hx",671,0x53295a96)
			{
				HX_STACK_LINE(672)
				{
					HX_STACK_LINE(673)
	...
	HX_STACK_LINE(641)
	if (((  ((!(((  ((!(((  ((!(_Function_1_1::Block(vx,B,uy,ux,A,vy,C)))) ? bool(_Function_1_2::Block(vx,B,uy,D,ux,vy,C)) : bool(true) ))))) ? bool(_Function_1_3::Block(vx,uy,D,ux,A,vy,C)) : bool(true) ))))) ? bool(_Function_1_4::Block(vx,B,uy,D,ux,A,vy)) : bool(true) ))){
		HX_STACK_LINE(682)
		return true;
	}
	HX_STACK_LINE(684)
...
Void ZPP_Triangular_obj::optimise( ::zpp_nape::geom::ZPP_PartitionedPoly P){
{
		...
		if (((::zpp_nape::geom::ZPP_Triangular_obj::edgeSet == null()))){
			HX_STACK_LINE(708)
			{
				...
				if (((::zpp_nape::util::ZPP_Set_ZPP_PartitionPair_obj::zpp_pool == null()))){
					...
					HX_STACK_LINE(710)
					::zpp_nape::geom::ZPP_Triangular_obj::edgeSet = _g;
				}
				else{
					HX_STACK_LINE(716)
		...
		HX_STACK_LINE(729)
		{
			...
			if (((::zpp_nape::geom::ZPP_PartitionPair_obj::zpp_pool == null()))){
				HX_STACK_LINE(731)
				::zpp_nape::geom::ZPP_PartitionPair _g1 = ::zpp_nape::geom::ZPP_PartitionPair_obj::__new();		HX_STACK_VAR(_g1,"_g1");
				HX_STACK_LINE(731)
				edgeStack = _g1;
			}
			else{
						...
						HX_STACK_LINE(757)
						{
							...
							while((true)){
								...
								HX_STACK_LINE(761)
								{
									...
									HX_STACK_LINE(769)
									::zpp_nape::geom::ZPP_PartitionVertex q1;		HX_STACK_VAR(q1,"q1");
									HX_STACK_LINE(769)
									if (((cx_ite->next == null()))){
										HX_STACK_LINE(769)
										q1 = p->prev;
									...
									if ((!(::zpp_nape::geom::ZPP_Triangular_obj::delaunay(p,q0,q,q1)))){
										HX_STACK_LINE(771)
										::zpp_nape::geom::ZPP_PartitionPair edge;		HX_STACK_VAR(edge,"edge");
										HX_STACK_LINE(771)
										{
											HX_STACK_LINE(771)
											...
											HX_STACK_LINE(771)
											{
												...
												if (((::zpp_nape::geom::ZPP_PartitionPair_obj::zpp_pool == null()))){
													HX_STACK_LINE(771)
													::zpp_nape::geom::ZPP_PartitionPair _g2 = ::zpp_nape::geom::ZPP_PartitionPair_obj::__new();		HX_STACK_VAR(_g2,"_g2");
													HX_STACK_LINE(771)
													ret = _g2;
												}
												else{
										...
										edgeStack->add(edge);
										HX_STACK_LINE(773)
										::zpp_nape::util::ZPP_Set_ZPP_PartitionPair _g3 = ::zpp_nape::geom::ZPP_Triangular_obj::edgeSet->insert(edge);		HX_STACK_VAR(_g3,"_g3");
										HX_STACK_LINE(773)
										edge->node = _g3;
									}
									HX_STACK_LINE(775)
		...
		while((true)){
			...
			HX_STACK_LINE(851)
			{
				...
				{
					HX_STACK_LINE(861)
					::zpp_nape::geom::ZPP_PartitionVertex _g4 = o->b = null();		HX_STACK_VAR(_g4,"_g4");
					HX_STACK_LINE(861)
					o->a = _g4;
					HX_STACK_LINE(861)
					o->node = null();
		...
		HX_STACK_LINE(869)
		{
			...
			{
				HX_STACK_LINE(879)
				::zpp_nape::geom::ZPP_PartitionVertex _g5 = o->b = null();		HX_STACK_VAR(_g5,"_g5");
				HX_STACK_LINE(879)
				o->a = _g5;
				HX_STACK_LINE(879)
				o->node = null();
...
::zpp_nape::geom::ZPP_PartitionedPoly ZPP_Triangular_obj::triangulate( ::zpp_nape::geom::ZPP_PartitionedPoly P){
	...
	if (((::zpp_nape::geom::ZPP_Triangular_obj::queue == null()))){
		HX_STACK_LINE(908)
		::zpp_nape::util::ZNPList_ZPP_PartitionVertex _g = ::zpp_nape::util::ZNPList_ZPP_PartitionVertex_obj::__new();		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(908)
		::zpp_nape::geom::ZPP_Triangular_obj::queue = _g;
	}
	HX_STACK_LINE(909)
	...
	if (((::zpp_nape::geom::ZPP_Triangular_obj::stack == null()))){
		...
		HX_STACK_LINE(925)
		::zpp_nape::geom::ZPP_Triangular_obj::stack = _g1;
	}
	HX_STACK_LINE(926)
	::zpp_nape::geom::ZPP_PartitionVertex _g2 = ::zpp_nape::geom::ZPP_Triangular_obj::queue->pop_unsafe();		HX_STACK_VAR(_g2,"_g2");
	HX_STACK_LINE(926)
	::zpp_nape::geom::ZPP_Triangular_obj::stack->add(_g2);
	HX_STACK_LINE(927)
