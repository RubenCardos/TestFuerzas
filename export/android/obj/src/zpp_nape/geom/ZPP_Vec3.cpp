...
{
		HX_STACK_FRAME("zpp_nape.geom.ZPP_Vec3","validate",0x754a9a8f,"zpp_nape.geom.ZPP_Vec3.validate","zpp_nape/geom/Vec3.hx",184,0x8339fc0e)
		HX_STACK_THIS(this)
		HX_STACK_LINE(184)
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::nape::geom::Vec3*/ ,(int)offsetof(ZPP_Vec3_obj,outer),HX_CSTRING("outer")},
	{hx::fsFloat,(int)offsetof(ZPP_Vec3_obj,x),HX_CSTRING("x")},
	{hx::fsFloat,(int)offsetof(ZPP_Vec3_obj,y),HX_CSTRING("y")},
	{hx::fsFloat,(int)offsetof(ZPP_Vec3_obj,z),HX_CSTRING("z")},
	{hx::fsBool,(int)offsetof(ZPP_Vec3_obj,immutable),HX_CSTRING("immutable")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(ZPP_Vec3_obj,_validate),HX_CSTRING("_validate")},
	{ hx::fsUnknown, 0, null()}
};
#endif
