...
bool ZPP_Compound_obj::compounds_adder( ::nape::phys::Compound x){
	HX_STACK_FRAME("zpp_nape.phys.ZPP_Compound","compounds_adder",0x36126614,"zpp_nape.phys.ZPP_Compound.compounds_adder","zpp_nape/phys/Compound.hx",289,0x2d1c4718)
	HX_STACK_THIS(this)
	HX_STACK_ARG(x,"x")
	HX_STACK_LINE(289)
	if (((x->zpp_inner->compound != hx::ObjectPtr<OBJ_>(this)))){
