...
HX_STACK_THIS(this)
{
	...
	this->gverts = _g1;
	HX_STACK_LINE(1831)
	::zpp_nape::util::ZNPList_ZPP_Edge _g2 = ::zpp_nape::util::ZNPList_ZPP_Edge_obj::__new();		HX_STACK_VAR(_g2,"_g2");
	HX_STACK_LINE(1831)
	this->edges = _g2;
	HX_STACK_LINE(1832)
	this->edgeCnt = (int)0;
...
{
		HX_STACK_FRAME("zpp_nape.shape.ZPP_Polygon","gverts_pa_validate",0xf5b83087,"zpp_nape.shape.ZPP_Polygon.gverts_pa_validate","zpp_nape/shape/Polygon.hx",197,0x571b0a14)
		HX_STACK_THIS(this)
		HX_STACK_LINE(197)
		if ((this->zip_gverts)){
			HX_STACK_LINE(197)
...
Void ZPP_Polygon_obj::lverts_post_adder( ::nape::geom::Vec2 x){
{
		...
		HX_STACK_LINE(220)
		::zpp_nape::geom::ZPP_Vec2 vec;		HX_STACK_VAR(vec,"vec");
		HX_STACK_LINE(220)
		{
			HX_STACK_LINE(220)
			...
			if (((this->lverts->next->next->next == null()))){
				...
				HX_STACK_LINE(225)
				{
					...
					if (((::zpp_nape::shape::ZPP_Edge_obj::zpp_pool == null()))){
						HX_STACK_LINE(227)
						::zpp_nape::shape::ZPP_Edge _g1 = ::zpp_nape::shape::ZPP_Edge_obj::__new();		HX_STACK_VAR(_g1,"_g1");
						HX_STACK_LINE(227)
						ed = _g1;
					}
					else{
				...
				HX_STACK_LINE(245)
				{
					...
					if (((::zpp_nape::shape::ZPP_Edge_obj::zpp_pool == null()))){
						HX_STACK_LINE(247)
						::zpp_nape::shape::ZPP_Edge _g2 = ::zpp_nape::shape::ZPP_Edge_obj::__new();		HX_STACK_VAR(_g2,"_g2");
						HX_STACK_LINE(247)
						ed1 = _g2;
					}
					else{
				...
				HX_STACK_LINE(268)
				{
					...
					if (((::zpp_nape::shape::ZPP_Edge_obj::zpp_pool == null()))){
						HX_STACK_LINE(270)
						::zpp_nape::shape::ZPP_Edge _g3 = ::zpp_nape::shape::ZPP_Edge_obj::__new();		HX_STACK_VAR(_g3,"_g3");
						HX_STACK_LINE(270)
						ed = _g3;
					}
					else{
...
{
		HX_STACK_FRAME("zpp_nape.shape.ZPP_Polygon","lverts_subber",0xcfa82191,"zpp_nape.shape.ZPP_Polygon.lverts_subber","zpp_nape/shape/Polygon.hx",293,0x571b0a14)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_LINE(293)
...
Void ZPP_Polygon_obj::getlverts( ){
{
		...
		HX_STACK_LINE(318)
		::zpp_nape::util::ZPP_MixVec2List _g = ::zpp_nape::util::ZPP_MixVec2List_obj::get(this->lverts,null());		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(318)
		this->wrap_lverts = _g;
		HX_STACK_LINE(319)
...
Void ZPP_Polygon_obj::getgverts( ){
{
		...
		::zpp_nape::shape::ZPP_Polygon me = hx::ObjectPtr<OBJ_>(this);		HX_STACK_VAR(me,"me");
		HX_STACK_LINE(330)
		::zpp_nape::util::ZPP_MixVec2List _g = ::zpp_nape::util::ZPP_MixVec2List_obj::get(this->gverts,true);		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(330)
		this->wrap_gverts = _g;
		HX_STACK_LINE(331)
...
Void ZPP_Polygon_obj::getedges( ){
{
		...
		::zpp_nape::shape::ZPP_Polygon me = hx::ObjectPtr<OBJ_>(this);		HX_STACK_VAR(me,"me");
		HX_STACK_LINE(336)
		::nape::shape::EdgeList _g = ::zpp_nape::util::ZPP_EdgeList_obj::get(this->edges,true);		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(336)
		this->wrap_edges = _g;
		HX_STACK_LINE(337)
...
::nape::shape::ValidationResult ZPP_Polygon_obj::valid( ){
	HX_STACK_FRAME("zpp_nape.shape.ZPP_Polygon","valid",0xe0094415,"zpp_nape.shape.ZPP_Polygon.valid","zpp_nape/shape/Polygon.hx",370,0x571b0a14)
	HX_STACK_THIS(this)
	HX_STACK_LINE(370)
	if ((this->zip_valid)){
		HX_STACK_LINE(371)
		...
		if (((this->lverts->length < (int)3))){
			...
			HX_STACK_LINE(373)
			{
				...
				HX_STACK_LINE(373)
				_g1 = ::zpp_nape::util::ZPP_Flags_obj::ValidationResult_DEGENERATE;
			}
			HX_STACK_LINE(373)
			return this->validation = _g1;
		}
		else{
			HX_STACK_LINE(375)
			this->validate_lverts();
			...
			if (((this->area < ::nape::Config_obj::epsilon))){
				...
				if (((bool(pos) && bool(neg)))){
					...
					if ((!(cont))){
						...
						HX_STACK_LINE(694)
						return this->validation = _g7;
					}
					else{
						HX_STACK_LINE(695)
						::nape::shape::ValidationResult _g9;		HX_STACK_VAR(_g9,"_g9");
						HX_STACK_LINE(695)
						{
							HX_STACK_LINE(695)
							if (((::zpp_nape::util::ZPP_Flags_obj::ValidationResult_VALID == null()))){
								...
								::zpp_nape::util::ZPP_Flags_obj::internal = true;
								HX_STACK_LINE(695)
								::nape::shape::ValidationResult _g8 = ::nape::shape::ValidationResult_obj::__new();		HX_STACK_VAR(_g8,"_g8");
								HX_STACK_LINE(695)
								::zpp_nape::util::ZPP_Flags_obj::ValidationResult_VALID = _g8;
								HX_STACK_LINE(695)
								::zpp_nape::util::ZPP_Flags_obj::internal = false;
							}
							HX_STACK_LINE(695)
							_g9 = ::zpp_nape::util::ZPP_Flags_obj::ValidationResult_VALID;
						}
						HX_STACK_LINE(695)
						return this->validation = _g9;
					}
				}
			}
		}
...
{
		HX_STACK_FRAME("zpp_nape.shape.ZPP_Polygon","validate_lverts",0x1feb06d8,"zpp_nape.shape.ZPP_Polygon.validate_lverts","zpp_nape/shape/Polygon.hx",703,0x571b0a14)
		HX_STACK_THIS(this)
		HX_STACK_LINE(703)
		if ((this->zip_lverts)){
			HX_STACK_LINE(704)
...
Void ZPP_Polygon_obj::cleanup_lvert( ::zpp_nape::geom::ZPP_Vec2 x){
{
		...
		HX_STACK_LINE(731)
		::zpp_nape::geom::ZPP_Vec2 rem;		HX_STACK_VAR(rem,"rem");
		HX_STACK_LINE(731)
		if (((ite == null()))){
			HX_STACK_LINE(731)
			rem = this->gverts->next;
		}
		else{
			HX_STACK_LINE(731)
			rem = ite->next;
		...
		if (((this->edgeCnt == (int)2))){
			...
			HX_STACK_LINE(769)
			::zpp_nape::shape::ZPP_Edge _g = this->edges->pop_unsafe();		HX_STACK_VAR(_g,"_g");
			HX_STACK_LINE(769)
			rem1 = _g;
			HX_STACK_LINE(770)
			{
			...
			if (((this->edgeCnt != (int)0))){
				HX_STACK_LINE(790)
				::zpp_nape::shape::ZPP_Edge rem1;		HX_STACK_VAR(rem1,"rem1");
				HX_STACK_LINE(790)
				if (((ite2 == null()))){
					HX_STACK_LINE(790)
					rem1 = this->edges->head->elt;
				}
				else{
					HX_STACK_LINE(790)
					rem1 = ite2->next->elt;
...
{
		HX_STACK_FRAME("zpp_nape.shape.ZPP_Polygon","splice_collinear",0x6723fbe9,"zpp_nape.shape.ZPP_Polygon.splice_collinear","zpp_nape/shape/Polygon.hx",816,0x571b0a14)
		HX_STACK_THIS(this)
		HX_STACK_LINE(816)
		if ((this->zip_sanitation)){
			HX_STACK_LINE(817)
...
Void ZPP_Polygon_obj::splice_collinear_real( ){
{
		...
		while((true)){
			...
			HX_STACK_LINE(828)
			::zpp_nape::geom::ZPP_Vec2 nxt;		HX_STACK_VAR(nxt,"nxt");
			HX_STACK_LINE(828)
			if (((cur->next == null()))){
				HX_STACK_LINE(828)
				nxt = this->lverts->next;
			}
			else{
				HX_STACK_LINE(828)
				nxt = cur->next;
			...
			HX_STACK_LINE(831)
			if (((_g < (::nape::Config_obj::epsilon * ::nape::Config_obj::epsilon)))){
				HX_STACK_LINE(832)
				this->cleanup_lvert(cur);
				HX_STACK_LINE(833)
				::zpp_nape::geom::ZPP_Vec2 _g1 = this->lverts->erase(pre);		HX_STACK_VAR(_g1,"_g1");
				HX_STACK_LINE(833)
				cur = _g1;
			}
			else{
		...
		while((true)){
			...
			while((true)){
				...
				HX_STACK_LINE(846)
				::zpp_nape::geom::ZPP_Vec2 cur1;		HX_STACK_VAR(cur1,"cur1");
				HX_STACK_LINE(846)
				if (((pre1->next == null()))){
					HX_STACK_LINE(846)
					cur1 = this->lverts->next;
				}
				else{
					HX_STACK_LINE(846)
					cur1 = pre1->next;
...
{
		HX_STACK_FRAME("zpp_nape.shape.ZPP_Polygon","validate_laxi",0xdf5b8a48,"zpp_nape.shape.ZPP_Polygon.validate_laxi","zpp_nape/shape/Polygon.hx",890,0x571b0a14)
		HX_STACK_THIS(this)
		HX_STACK_LINE(890)
		if ((this->zip_laxi)){
			HX_STACK_LINE(891)
...
{
		HX_STACK_FRAME("zpp_nape.shape.ZPP_Polygon","validate_gverts",0x202238fd,"zpp_nape.shape.ZPP_Polygon.validate_gverts","zpp_nape/shape/Polygon.hx",1056,0x571b0a14)
		HX_STACK_THIS(this)
		HX_STACK_LINE(1056)
		if ((this->zip_gverts)){
			HX_STACK_LINE(1057)
...
{
		HX_STACK_FRAME("zpp_nape.shape.ZPP_Polygon","validate_gaxi",0xdc0d792d,"zpp_nape.shape.ZPP_Polygon.validate_gaxi","zpp_nape/shape/Polygon.hx",1082,0x571b0a14)
		HX_STACK_THIS(this)
		HX_STACK_LINE(1082)
		if ((this->zip_gaxi)){
			HX_STACK_LINE(1083)
...
Void ZPP_Polygon_obj::__validate_sweepRadius( ){
{
		...
		HX_STACK_LINE(1333)
		Float _g = ::Math_obj::sqrt(maxRadius);		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(1333)
		this->sweepRadius = _g;
		HX_STACK_LINE(1334)
...
{
		HX_STACK_FRAME("zpp_nape.shape.ZPP_Polygon","__validate_area_inertia",0x7eb6a9ca,"zpp_nape.shape.ZPP_Polygon.__validate_area_inertia","zpp_nape/shape/Polygon.hx",1337,0x571b0a14)
		HX_STACK_THIS(this)
		HX_STACK_LINE(1337)
...
{
		HX_STACK_FRAME("zpp_nape.shape.ZPP_Polygon","__validate_localCOM",0xeb39fd58,"zpp_nape.shape.ZPP_Polygon.__validate_localCOM","zpp_nape/shape/Polygon.hx",1625,0x571b0a14)
		HX_STACK_THIS(this)
		HX_STACK_LINE(1625)
		if (((this->lverts->next->next == null()))){
			HX_STACK_LINE(1626)
...
{
		HX_STACK_FRAME("zpp_nape.shape.ZPP_Polygon","localCOM_validate",0xe322ee38,"zpp_nape.shape.ZPP_Polygon.localCOM_validate","zpp_nape/shape/Polygon.hx",1772,0x571b0a14)
		HX_STACK_THIS(this)
		HX_STACK_LINE(1772)
			...
			if (((ret->zpp_inner == null()))){
				...
				struct _Function_3_1{
					inline static bool Block( ::nape::geom::Vec2 &ret,Float &y){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/shape/Polygon.hx",1821,0x571b0a14)
						{
							HX_STACK_LINE(1821)
...
::zpp_nape::shape::ZPP_Polygon ZPP_Polygon_obj::__copy( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(1927)
	::nape::geom::Vec2List _g;		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(1927)
	{
		HX_STACK_LINE(1927)
		::nape::shape::Polygon _this = this->outer_zn;		HX_STACK_VAR(_this,"_this");
		HX_STACK_LINE(1927)
		...
		HX_STACK_LINE(1927)
		_g = _this->zpp_inner_zn->wrap_lverts;
	}
	HX_STACK_LINE(1927)
	::zpp_nape::shape::ZPP_Polygon ret = ::nape::shape::Polygon_obj::__new(_g,null(),null())->zpp_inner_zn;		HX_STACK_VAR(ret,"ret");
	HX_STACK_LINE(1928)
	return ret;
}
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::nape::shape::Polygon*/ ,(int)offsetof(ZPP_Polygon_obj,outer_zn),HX_CSTRING("outer_zn")},
	{hx::fsObject /*::zpp_nape::geom::ZPP_Vec2*/ ,(int)offsetof(ZPP_Polygon_obj,lverts),HX_CSTRING("lverts")},
	{hx::fsObject /*::nape::geom::Vec2List*/ ,(int)offsetof(ZPP_Polygon_obj,wrap_lverts),HX_CSTRING("wrap_lverts")},
	{hx::fsObject /*::zpp_nape::geom::ZPP_Vec2*/ ,(int)offsetof(ZPP_Polygon_obj,gverts),HX_CSTRING("gverts")},
	{hx::fsObject /*::nape::geom::Vec2List*/ ,(int)offsetof(ZPP_Polygon_obj,wrap_gverts),HX_CSTRING("wrap_gverts")},
	{hx::fsObject /*::zpp_nape::util::ZNPList_ZPP_Edge*/ ,(int)offsetof(ZPP_Polygon_obj,edges),HX_CSTRING("edges")},
	{hx::fsObject /*::nape::shape::EdgeList*/ ,(int)offsetof(ZPP_Polygon_obj,wrap_edges),HX_CSTRING("wrap_edges")},
	{hx::fsInt,(int)offsetof(ZPP_Polygon_obj,edgeCnt),HX_CSTRING("edgeCnt")},
	{hx::fsBool,(int)offsetof(ZPP_Polygon_obj,reverse_flag),HX_CSTRING("reverse_flag")},
	{hx::fsBool,(int)offsetof(ZPP_Polygon_obj,zip_lverts),HX_CSTRING("zip_lverts")},
	{hx::fsBool,(int)offsetof(ZPP_Polygon_obj,zip_laxi),HX_CSTRING("zip_laxi")},
	{hx::fsBool,(int)offsetof(ZPP_Polygon_obj,zip_gverts),HX_CSTRING("zip_gverts")},
	{hx::fsBool,(int)offsetof(ZPP_Polygon_obj,zip_gaxi),HX_CSTRING("zip_gaxi")},
	{hx::fsBool,(int)offsetof(ZPP_Polygon_obj,zip_valid),HX_CSTRING("zip_valid")},
	{hx::fsObject /*::nape::shape::ValidationResult*/ ,(int)offsetof(ZPP_Polygon_obj,validation),HX_CSTRING("validation")},
	{hx::fsBool,(int)offsetof(ZPP_Polygon_obj,zip_sanitation),HX_CSTRING("zip_sanitation")},
	{ hx::fsUnknown, 0, null()}
};
#endif
