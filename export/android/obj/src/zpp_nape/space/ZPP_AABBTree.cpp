...
Void ZPP_AABBTree_obj::insertLeaf( ::zpp_nape::space::ZPP_AABBNode leaf){
{
		...
		if (((this->root == null()))){
			...
			while((true)){
					...
					if (((child1->child1 == null()))){
						struct _Function_5_1{
							inline static Float Block( ){
								HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/space/DynAABBPhase.hx",421,0x55500cf1)
								{
									HX_STACK_LINE(421)
									::zpp_nape::geom::ZPP_AABB _this = ::zpp_nape::space::ZPP_AABBTree_obj::tmpaabb;		HX_STACK_VAR(_this,"_this");
									HX_STACK_LINE(421)
						...
						HX_STACK_LINE(421)
						cost1 = (_Function_5_1::Block() + icost);
					}
					else{
						HX_STACK_LINE(421)
				...
				HX_STACK_LINE(421)
				{
					...
					if (((child2->child1 == null()))){
						...
						HX_STACK_LINE(421)
						cost2 = (_Function_5_1::Block() + icost);
					}
					else{
						HX_STACK_LINE(421)
						Float oarea;		HX_STACK_VAR(oarea,"oarea");
			...
			while((true)){
				...
				HX_STACK_LINE(421)
				::zpp_nape::space::ZPP_AABBNode _g2;		HX_STACK_VAR(_g2,"_g2");
				HX_STACK_LINE(421)
				if (((bool((node->child1 == null())) || bool((node->height < (int)2))))){
					HX_STACK_LINE(421)
					_g2 = node;
				}
				else{
				...
				HX_STACK_LINE(421)
				node->height = ((int)1 + _Function_3_1::Block(child1,child2));
				HX_STACK_LINE(421)
				{
					HX_STACK_LINE(421)
					::zpp_nape::geom::ZPP_AABB _this = node->aabb;		HX_STACK_VAR(_this,"_this");
...
{
		HX_STACK_FRAME("zpp_nape.space.ZPP_AABBTree","inlined_insertLeaf",0xd4373b6d,"zpp_nape.space.ZPP_AABBTree.inlined_insertLeaf","zpp_nape/space/DynAABBPhase.hx",426,0x55500cf1)
		HX_STACK_THIS(this)
		HX_STACK_ARG(leaf,"leaf")
		HX_STACK_LINE(426)
		if (((this->root == null()))){
			...
			while((true)){
				...
				HX_STACK_LINE(441)
				{
					...
					if (((child1->child1 == null()))){
						struct _Function_5_1{
							inline static Float Block( ){
								HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/space/DynAABBPhase.hx",443,0x55500cf1)
								{
									HX_STACK_LINE(443)
									::zpp_nape::geom::ZPP_AABB _this = ::zpp_nape::space::ZPP_AABBTree_obj::tmpaabb;		HX_STACK_VAR(_this,"_this");
									HX_STACK_LINE(443)
				...
				HX_STACK_LINE(450)
				{
					...
					if (((child2->child1 == null()))){
						struct _Function_5_1{
							inline static Float Block( ){
								HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/space/DynAABBPhase.hx",452,0x55500cf1)
								{
									HX_STACK_LINE(452)
									::zpp_nape::geom::ZPP_AABB _this = ::zpp_nape::space::ZPP_AABBTree_obj::tmpaabb;		HX_STACK_VAR(_this,"_this");
									HX_STACK_LINE(452)
			...
			while((true)){
				...
				if (((bool((node->child1 == null())) || bool((node->height < (int)2))))){
					...
					if (((balance > (int)1))){
						...
						if (((f->height > g->height))){
							...
							struct _Function_6_1{
								inline static int Block( ::zpp_nape::space::ZPP_AABBNode &g,::zpp_nape::space::ZPP_AABBNode &b){
									HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/space/DynAABBPhase.hx",502,0x55500cf1)
									{
										HX_STACK_LINE(502)
										int x = b->height;		HX_STACK_VAR(x,"x");
										HX_STACK_LINE(502)
				...
				struct _Function_3_1{
					inline static int Block( ::zpp_nape::space::ZPP_AABBNode &child1,::zpp_nape::space::ZPP_AABBNode &child2){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/space/DynAABBPhase.hx",505,0x55500cf1)
						{
							HX_STACK_LINE(506)
							int x = child1->height;		HX_STACK_VAR(x,"x");
							HX_STACK_LINE(507)
		...
		if (((leaf == this->root))){
			...
			if (((gparent != null()))){
				...
				while((true)){
					...
					if (((bool((node->child1 == null())) || bool((node->height < (int)2))))){
						...
						if (((balance > (int)1))){
							...
							if (((f->height > g->height))){
								...
								struct _Function_7_1{
									inline static int Block( ::zpp_nape::space::ZPP_AABBNode &g,::zpp_nape::space::ZPP_AABBNode &b){
										HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/space/DynAABBPhase.hx",516,0x55500cf1)
										{
											HX_STACK_LINE(516)
											int x = b->height;		HX_STACK_VAR(x,"x");
											HX_STACK_LINE(516)
							...
							if (((balance < (int)-1))){
								...
								if (((f->height > g->height))){
									...
									HX_STACK_LINE(516)
									node->height = ((int)1 + _Function_8_1::Block(c,g));
									...
									HX_STACK_LINE(516)
									b->height = ((int)1 + _Function_8_2::Block(node,f));
								}
								else{
									HX_STACK_LINE(516)
									b->child2 = g;
									...
									HX_STACK_LINE(516)
									node->height = ((int)1 + _Function_8_1::Block(c,f));
									struct _Function_8_2{
										inline static int Block( ::zpp_nape::space::ZPP_AABBNode &g,::zpp_nape::space::ZPP_AABBNode &node){
											HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/space/DynAABBPhase.hx",516,0x55500cf1)
											{
									...
									HX_STACK_LINE(516)
									b->height = ((int)1 + _Function_8_2::Block(g,node));
								}
								HX_STACK_LINE(516)
								_g3 = b;
							}
					...
					HX_STACK_LINE(516)
					node->height = ((int)1 + _Function_4_1::Block(child1,child2));
					HX_STACK_LINE(516)
					node = node->parent;
				}
			}
...
{
		HX_STACK_FRAME("zpp_nape.space.ZPP_AABBTree","inlined_removeLeaf",0x6b6b75f8,"zpp_nape.space.ZPP_AABBTree.inlined_removeLeaf","zpp_nape/space/DynAABBPhase.hx",521,0x55500cf1)
		HX_STACK_THIS(this)
		HX_STACK_ARG(leaf,"leaf")
		HX_STACK_LINE(521)
		if (((leaf == this->root))){
			...
			if (((gparent != null()))){
				...
				while((true)){
					...
					if (((bool((node->child1 == null())) || bool((node->height < (int)2))))){
						...
						if (((balance > (int)1))){
							...
							if (((f->height > g->height))){
								...
								struct _Function_7_1{
									inline static int Block( ::zpp_nape::space::ZPP_AABBNode &g,::zpp_nape::space::ZPP_AABBNode &b){
										HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/space/DynAABBPhase.hx",552,0x55500cf1)
										{
											HX_STACK_LINE(552)
											int x = b->height;		HX_STACK_VAR(x,"x");
											HX_STACK_LINE(552)
					...
					struct _Function_4_1{
						inline static int Block( ::zpp_nape::space::ZPP_AABBNode &child1,::zpp_nape::space::ZPP_AABBNode &child2){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/space/DynAABBPhase.hx",556,0x55500cf1)
							{
								HX_STACK_LINE(557)
								int x = child1->height;		HX_STACK_VAR(x,"x");
								HX_STACK_LINE(558)
...
::zpp_nape::space::ZPP_AABBNode ZPP_AABBTree_obj::balance( ::zpp_nape::space::ZPP_AABBNode a){
	HX_STACK_FRAME("zpp_nape.space.ZPP_AABBTree","balance",0x0a7660fa,"zpp_nape.space.ZPP_AABBTree.balance","zpp_nape/space/DynAABBPhase.hx",590,0x55500cf1)
	HX_STACK_THIS(this)
	HX_STACK_ARG(a,"a")
	HX_STACK_LINE(590)
	if (((bool((a->child1 == null())) || bool((a->height < (int)2))))){
		...
		if (((balance > (int)1))){
			...
			if (((f->height > g->height))){
				...
				struct _Function_4_1{
					inline static int Block( ::zpp_nape::space::ZPP_AABBNode &g,::zpp_nape::space::ZPP_AABBNode &b){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/space/DynAABBPhase.hx",612,0x55500cf1)
						{
							HX_STACK_LINE(613)
							int x = b->height;		HX_STACK_VAR(x,"x");
							HX_STACK_LINE(614)
				...
				struct _Function_4_2{
					inline static int Block( ::zpp_nape::space::ZPP_AABBNode &f,::zpp_nape::space::ZPP_AABBNode &a){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/space/DynAABBPhase.hx",617,0x55500cf1)
						{
							HX_STACK_LINE(618)
				...
				struct _Function_4_1{
					inline static int Block( ::zpp_nape::space::ZPP_AABBNode &b,::zpp_nape::space::ZPP_AABBNode &f){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/space/DynAABBPhase.hx",629,0x55500cf1)
						{
							HX_STACK_LINE(630)
							int x = b->height;		HX_STACK_VAR(x,"x");
							HX_STACK_LINE(631)
				...
				struct _Function_4_2{
					inline static int Block( ::zpp_nape::space::ZPP_AABBNode &g,::zpp_nape::space::ZPP_AABBNode &a){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/space/DynAABBPhase.hx",634,0x55500cf1)
						{
							HX_STACK_LINE(635)
							int x = a->height;		HX_STACK_VAR(x,"x");
							HX_STACK_LINE(636)
			...
			if (((balance < (int)-1))){
				...
				if (((f->height > g->height))){
					...
					struct _Function_5_1{
						inline static int Block( ::zpp_nape::space::ZPP_AABBNode &c,::zpp_nape::space::ZPP_AABBNode &g){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/space/DynAABBPhase.hx",659,0x55500cf1)
							{
								HX_STACK_LINE(660)
								int x = c->height;		HX_STACK_VAR(x,"x");
								HX_STACK_LINE(661)
					...
					struct _Function_5_2{
						inline static int Block( ::zpp_nape::space::ZPP_AABBNode &f,::zpp_nape::space::ZPP_AABBNode &a){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/space/DynAABBPhase.hx",664,0x55500cf1)
							{
								HX_STACK_LINE(665)
								int x = a->height;		HX_STACK_VAR(x,"x");
								HX_STACK_LINE(666)
					...
					struct _Function_5_1{
						inline static int Block( ::zpp_nape::space::ZPP_AABBNode &c,::zpp_nape::space::ZPP_AABBNode &f){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/space/DynAABBPhase.hx",676,0x55500cf1)
							{
								HX_STACK_LINE(677)
								int x = c->height;		HX_STACK_VAR(x,"x");
								HX_STACK_LINE(678)
					...
					struct _Function_5_2{
						inline static int Block( ::zpp_nape::space::ZPP_AABBNode &g,::zpp_nape::space::ZPP_AABBNode &a){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/space/DynAABBPhase.hx",681,0x55500cf1)
							{
								HX_STACK_LINE(682)
								int x = a->height;		HX_STACK_VAR(x,"x");
								HX_STACK_LINE(683)
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::zpp_nape::space::ZPP_AABBNode*/ ,(int)offsetof(ZPP_AABBTree_obj,root),HX_CSTRING("root")},
	{ hx::fsUnknown, 0, null()}
};
#endif
