							...
							HX_STACK_LINE(2914)
							{
								...
								HX_STACK_LINE(2914)
								{
									...
									HX_STACK_LINE(2914)
									{
										...
										if (((::zpp_nape::util::ZNPNode_ZPP_AABBNode_obj::zpp_pool == null()))){
											HX_STACK_LINE(2914)
											::zpp_nape::util::ZNPNode_ZPP_AABBNode _g5 = ::zpp_nape::util::ZNPNode_ZPP_AABBNode_obj::__new();		HX_STACK_VAR(_g5,"_g5");
											HX_STACK_LINE(2914)
											ret = _g5;
										}
										else{
								...
								HX_STACK_LINE(2914)
								bool _g6 = _this->modified = true;		HX_STACK_VAR(_g6,"_g6");
								HX_STACK_LINE(2914)
								_this->pushmod = _g6;
								HX_STACK_LINE(2914)
								(_this->length)++;
							...
							HX_STACK_LINE(2939)
							{
								...
								HX_STACK_LINE(2939)
								{
									...
									HX_STACK_LINE(2939)
									{
										...
										if (((::zpp_nape::util::ZNPNode_ZPP_AABBNode_obj::zpp_pool == null()))){
											HX_STACK_LINE(2939)
											::zpp_nape::util::ZNPNode_ZPP_AABBNode _g7 = ::zpp_nape::util::ZNPNode_ZPP_AABBNode_obj::__new();		HX_STACK_VAR(_g7,"_g7");
											HX_STACK_LINE(2939)
											ret = _g7;
										}
										else{
								...
								HX_STACK_LINE(2939)
								bool _g8 = _this->modified = true;		HX_STACK_VAR(_g8,"_g8");
								HX_STACK_LINE(2939)
								_this->pushmod = _g8;
								HX_STACK_LINE(2939)
								(_this->length)++;
