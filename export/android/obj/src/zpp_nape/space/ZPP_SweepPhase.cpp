...
Void ZPP_SweepPhase_obj::__insert( ::zpp_nape::shape::ZPP_Shape shape){
{
		...
		HX_STACK_LINE(238)
		{
			...
			if (((::zpp_nape::space::ZPP_SweepData_obj::zpp_pool == null()))){
				HX_STACK_LINE(240)
				::zpp_nape::space::ZPP_SweepData _g = ::zpp_nape::space::ZPP_SweepData_obj::__new();		HX_STACK_VAR(_g,"_g");
				HX_STACK_LINE(240)
				dat = _g;
			}
			else{
...
{
		HX_STACK_FRAME("zpp_nape.space.ZPP_SweepPhase","__sync",0xa167a14c,"zpp_nape.space.ZPP_SweepPhase.__sync","zpp_nape/space/SweepPhase.hx",305,0x6f338844)
		HX_STACK_THIS(this)
		HX_STACK_ARG(shape,"shape")
		HX_STACK_LINE(305)
...
Void ZPP_SweepPhase_obj::sync_broadphase( ){
{
		...
		if (((this->list != null()))){
			...
			while((true)){
				...
				while((true)){
					HX_STACK_LINE(309)
					if ((!(((bool((b->prev != null())) && bool((b->prev->aabb->minx > a->aabb->minx))))))){
						HX_STACK_LINE(309)
						break;
					}
					HX_STACK_LINE(309)
...
{
		HX_STACK_FRAME("zpp_nape.space.ZPP_SweepPhase","broadphase",0x06699e0a,"zpp_nape.space.ZPP_SweepPhase.broadphase","zpp_nape/space/SweepPhase.hx",346,0x6f338844)
		HX_STACK_THIS(this)
		HX_STACK_ARG(space,"space")
				...
				while((true)){
					...
					struct _Function_4_1{
						inline static bool Block( ::zpp_nape::shape::ZPP_Shape &s2,::zpp_nape::shape::ZPP_Shape &s1){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/space/SweepPhase.hx",370,0x6f338844)
							{
								HX_STACK_LINE(370)
...
::nape::shape::ShapeList ZPP_SweepPhase_obj::shapesUnderPoint( Float x,Float y,::zpp_nape::dynamics::ZPP_InteractionFilter filter,::nape::shape::ShapeList output){
	...
	while((true)){
		HX_STACK_LINE(395)
		if ((!(((bool((a != null())) && bool((a->aabb->minx > x))))))){
			HX_STACK_LINE(395)
			break;
		}
		HX_STACK_LINE(395)
		...
		if (((bool((bool((a->aabb->maxx >= x)) && bool((a->aabb->miny <= y)))) && bool((a->aabb->maxy >= y))))){
			...
			struct _Function_3_1{
				inline static bool Block( ::zpp_nape::dynamics::ZPP_InteractionFilter &filter,::zpp_nape::shape::ZPP_Shape &shape){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/space/SweepPhase.hx",399,0x6f338844)
					{
						HX_STACK_LINE(399)
	...
	while((true)){
		...
		if (((bool((bool((a->aabb->maxx >= x)) && bool((a->aabb->miny <= y)))) && bool((a->aabb->maxy >= y))))){
			...
			if ((!(ret->has(body)))){
				struct _Function_4_1{
					inline static bool Block( ::zpp_nape::dynamics::ZPP_InteractionFilter &filter,::zpp_nape::shape::ZPP_Shape &shape){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/space/SweepPhase.hx",440,0x6f338844)
						{
							HX_STACK_LINE(440)
							::zpp_nape::dynamics::ZPP_InteractionFilter _this = shape->filter;		HX_STACK_VAR(_this,"_this");
							HX_STACK_LINE(440)
...
::nape::shape::ShapeList ZPP_SweepPhase_obj::shapesInAABB( ::zpp_nape::geom::ZPP_AABB aabb,bool strict,bool containment,::zpp_nape::dynamics::ZPP_InteractionFilter filter,::nape::shape::ShapeList output){
	...
	while((true)){
		HX_STACK_LINE(477)
		if ((!(((bool((a != null())) && bool((a->aabb->maxx < ab->minx))))))){
			HX_STACK_LINE(477)
			break;
		}
		HX_STACK_LINE(477)
	...
	while((true)){
		HX_STACK_LINE(478)
		if ((!(((bool((a != null())) && bool((a->aabb->minx <= ab->maxx))))))){
			HX_STACK_LINE(478)
			break;
		}
		HX_STACK_LINE(479)
		...
		struct _Function_2_1{
			inline static bool Block( ::zpp_nape::dynamics::ZPP_InteractionFilter &filter,::zpp_nape::shape::ZPP_Shape &shape){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/space/SweepPhase.hx",480,0x6f338844)
				{
					HX_STACK_LINE(480)
					::zpp_nape::dynamics::ZPP_InteractionFilter _this = shape->filter;		HX_STACK_VAR(_this,"_this");
					HX_STACK_LINE(480)
		...
		if (((bool((filter == null())) || bool(_Function_2_1::Block(filter,shape))))){
			...
			if ((strict)){
				...
				if ((containment)){
					...
					struct _Function_5_1{
						inline static bool Block( ::zpp_nape::geom::ZPP_AABB &ab,::zpp_nape::space::ZPP_SweepData &a){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/space/SweepPhase.hx",486,0x6f338844)
							{
								HX_STACK_LINE(486)
					...
					if ((_Function_5_1::Block(ab,a))){
						...
						struct _Function_6_1{
							inline static bool Block( ::zpp_nape::geom::ZPP_AABB &ab,::zpp_nape::space::ZPP_SweepData &a){
								HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/space/SweepPhase.hx",487,0x6f338844)
								{
									HX_STACK_LINE(487)
				...
				struct _Function_4_1{
					inline static bool Block( ::zpp_nape::geom::ZPP_AABB &ab,::zpp_nape::space::ZPP_SweepData &a){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/space/SweepPhase.hx",492,0x6f338844)
						{
							HX_STACK_LINE(492)
							::zpp_nape::geom::ZPP_AABB x = a->aabb;		HX_STACK_VAR(x,"x");
							HX_STACK_LINE(492)
...
::nape::phys::BodyList ZPP_SweepPhase_obj::bodiesInAABB( ::zpp_nape::geom::ZPP_AABB aabb,bool strict,bool containment,::zpp_nape::dynamics::ZPP_InteractionFilter filter,::nape::phys::BodyList output){
	...
	while((true)){
		...
		struct _Function_2_1{
			inline static bool Block( ::zpp_nape::geom::ZPP_AABB &ab,::zpp_nape::space::ZPP_SweepData &a){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/space/SweepPhase.hx",510,0x6f338844)
				{
					HX_STACK_LINE(510)
					::zpp_nape::geom::ZPP_AABB _this = a->aabb;		HX_STACK_VAR(_this,"_this");
					HX_STACK_LINE(510)
		...
		if ((_Function_2_1::Block(ab,a))){
			struct _Function_3_1{
				inline static bool Block( ::zpp_nape::dynamics::ZPP_InteractionFilter &filter,::zpp_nape::shape::ZPP_Shape &shape){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/space/SweepPhase.hx",511,0x6f338844)
					{
						HX_STACK_LINE(511)
						::zpp_nape::dynamics::ZPP_InteractionFilter _this = shape->filter;		HX_STACK_VAR(_this,"_this");
						HX_STACK_LINE(511)
			...
			if (((bool((filter == null())) || bool(_Function_3_1::Block(filter,shape))))){
				...
				if ((strict)){
					...
					if ((containment)){
						...
						HX_STACK_LINE(523)
						if (((  ((!(ret->has(body)))) ? bool(::zpp_nape::geom::ZPP_Collide_obj::testCollide_safe(shape,this->aabbShape->zpp_inner)) : bool(false) ))){
							HX_STACK_LINE(524)
							ret->push(body);
						}
					}
					...
					if ((containment)){
						...
						struct _Function_6_1{
							inline static bool Block( ::zpp_nape::geom::ZPP_AABB &ab,::zpp_nape::shape::ZPP_Shape &shape){
								HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/space/SweepPhase.hx",538,0x6f338844)
								{
									HX_STACK_LINE(538)
									::zpp_nape::geom::ZPP_AABB x = shape->aabb;		HX_STACK_VAR(x,"x");
									HX_STACK_LINE(538)
						...
						HX_STACK_LINE(538)
						if (((  ((!(ret->has(body)))) ? bool(_Function_6_1::Block(ab,shape)) : bool(false) ))){
							HX_STACK_LINE(539)
							ret->push(body);
						}
					}
...
::nape::shape::ShapeList ZPP_SweepPhase_obj::shapesInCircle( Float x,Float y,Float r,bool containment,::zpp_nape::dynamics::ZPP_InteractionFilter filter,::nape::shape::ShapeList output){
	...
	while((true)){
		...
		struct _Function_2_1{
			inline static bool Block( ::zpp_nape::geom::ZPP_AABB &ab,::zpp_nape::space::ZPP_SweepData &a){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/space/SweepPhase.hx",557,0x6f338844)
				{
					HX_STACK_LINE(557)
					::zpp_nape::geom::ZPP_AABB _this = a->aabb;		HX_STACK_VAR(_this,"_this");
					HX_STACK_LINE(557)
		...
		if ((_Function_2_1::Block(ab,a))){
			...
			struct _Function_3_1{
				inline static bool Block( ::zpp_nape::dynamics::ZPP_InteractionFilter &filter,::zpp_nape::shape::ZPP_Shape &shape){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/space/SweepPhase.hx",559,0x6f338844)
					{
						HX_STACK_LINE(559)
						::zpp_nape::dynamics::ZPP_InteractionFilter _this = shape->filter;		HX_STACK_VAR(_this,"_this");
						HX_STACK_LINE(559)
...
::nape::phys::BodyList ZPP_SweepPhase_obj::bodiesInCircle( Float x,Float y,Float r,bool containment,::zpp_nape::dynamics::ZPP_InteractionFilter filter,::nape::phys::BodyList output){
	...
	while((true)){
		...
		struct _Function_2_1{
			inline static bool Block( ::zpp_nape::geom::ZPP_AABB &ab,::zpp_nape::space::ZPP_SweepData &a){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/space/SweepPhase.hx",579,0x6f338844)
				{
					HX_STACK_LINE(579)
					::zpp_nape::geom::ZPP_AABB _this = a->aabb;		HX_STACK_VAR(_this,"_this");
					HX_STACK_LINE(579)
		...
		if ((_Function_2_1::Block(ab,a))){
			...
			struct _Function_3_1{
				inline static bool Block( ::zpp_nape::dynamics::ZPP_InteractionFilter &filter,::zpp_nape::shape::ZPP_Shape &shape){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/space/SweepPhase.hx",582,0x6f338844)
					{
						HX_STACK_LINE(582)
						::zpp_nape::dynamics::ZPP_InteractionFilter _this = shape->filter;		HX_STACK_VAR(_this,"_this");
						HX_STACK_LINE(582)
			...
			if (((bool((filter == null())) || bool(_Function_3_1::Block(filter,shape))))){
				...
				if ((containment)){
					...
					HX_STACK_LINE(593)
					if (((  ((!(ret->has(body)))) ? bool(::zpp_nape::geom::ZPP_Collide_obj::testCollide_safe(shape,this->circShape->zpp_inner)) : bool(false) ))){
						HX_STACK_LINE(594)
						ret->push(body);
					}
				}
...
::nape::shape::ShapeList ZPP_SweepPhase_obj::shapesInShape( ::zpp_nape::shape::ZPP_Shape shape,bool containment,::zpp_nape::dynamics::ZPP_InteractionFilter filter,::nape::shape::ShapeList output){
	...
	while((true)){
		...
		struct _Function_2_1{
			inline static bool Block( ::zpp_nape::geom::ZPP_AABB &ab,::zpp_nape::space::ZPP_SweepData &a){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/space/SweepPhase.hx",611,0x6f338844)
				{
					HX_STACK_LINE(611)
					::zpp_nape::geom::ZPP_AABB _this = a->aabb;		HX_STACK_VAR(_this,"_this");
					HX_STACK_LINE(611)
		...
		if ((_Function_2_1::Block(ab,a))){
			...
			struct _Function_3_1{
				inline static bool Block( ::zpp_nape::dynamics::ZPP_InteractionFilter &filter,::zpp_nape::shape::ZPP_Shape &shape2){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/space/SweepPhase.hx",613,0x6f338844)
					{
						HX_STACK_LINE(613)
...
::nape::phys::BodyList ZPP_SweepPhase_obj::bodiesInShape( ::zpp_nape::shape::ZPP_Shape shape,bool containment,::zpp_nape::dynamics::ZPP_InteractionFilter filter,::nape::phys::BodyList output){
	...
	while((true)){
		...
		struct _Function_2_1{
			inline static bool Block( ::zpp_nape::geom::ZPP_AABB &ab,::zpp_nape::space::ZPP_SweepData &a){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/space/SweepPhase.hx",633,0x6f338844)
				{
					HX_STACK_LINE(633)
					::zpp_nape::geom::ZPP_AABB _this = a->aabb;		HX_STACK_VAR(_this,"_this");
					HX_STACK_LINE(633)
		...
		if ((_Function_2_1::Block(ab,a))){
			...
			struct _Function_3_1{
				inline static bool Block( ::zpp_nape::dynamics::ZPP_InteractionFilter &filter,::zpp_nape::shape::ZPP_Shape &shape2){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/space/SweepPhase.hx",636,0x6f338844)
					{
						HX_STACK_LINE(636)
						::zpp_nape::dynamics::ZPP_InteractionFilter _this = shape2->filter;		HX_STACK_VAR(_this,"_this");
						HX_STACK_LINE(636)
			...
			if (((bool((filter == null())) || bool(_Function_3_1::Block(filter,shape2))))){
				...
				if ((containment)){
					...
					HX_STACK_LINE(647)
					if (((  ((!(ret->has(body)))) ? bool(::zpp_nape::geom::ZPP_Collide_obj::testCollide_safe(shape,shape2)) : bool(false) ))){
						HX_STACK_LINE(648)
						ret->push(body);
					}
				}
...
::nape::geom::RayResult ZPP_SweepPhase_obj::rayCast( ::zpp_nape::geom::ZPP_Ray ray,bool inner,::zpp_nape::dynamics::ZPP_InteractionFilter filter){
	...
	if (((ray->dirx == (int)0))){
		...
		while((true)){
			HX_STACK_LINE(665)
			if ((!(((bool((a != null())) && bool((a->aabb->minx <= rayab->minx))))))){
				HX_STACK_LINE(665)
				break;
			}
			struct _Function_3_1{
				inline static bool Block( ::zpp_nape::geom::ZPP_AABB &rayab,::zpp_nape::space::ZPP_SweepData &a){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/space/SweepPhase.hx",666,0x6f338844)
					{
						HX_STACK_LINE(666)
						::zpp_nape::geom::ZPP_AABB _this = a->aabb;		HX_STACK_VAR(_this,"_this");
						HX_STACK_LINE(666)
			...
			if (((bool(_Function_3_1::Block(rayab,a)) && bool(((bool((filter == null())) || bool(_Function_3_2::Block(filter,a)))))))){
				...
				if (((bool((t >= (int)0)) && bool((t < mint))))){
					...
					if (((a->shape->type == ::zpp_nape::util::ZPP_Flags_obj::id_ShapeType_CIRCLE))){
						HX_STACK_LINE(669)
						result = ray->circlesect(a->shape->circle,inner,mint);
					}
					else{
						HX_STACK_LINE(669)
						result = ray->polysect(a->shape->polygon,inner,mint);
					}
					HX_STACK_LINE(670)
					if (((result != null()))){
						HX_STACK_LINE(671)
		...
		if (((ray->dirx < (int)0))){
			...
			while((true)){
				HX_STACK_LINE(685)
				if ((!(((bool((a != null())) && bool((a->aabb->minx <= rayab->maxx))))))){
					HX_STACK_LINE(685)
					break;
				}
				HX_STACK_LINE(686)
			...
			while((true)){
				...
				struct _Function_4_1{
					inline static bool Block( ::zpp_nape::geom::ZPP_AABB &rayab,::zpp_nape::space::ZPP_SweepData &a){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/space/SweepPhase.hx",691,0x6f338844)
						{
							HX_STACK_LINE(691)
							::zpp_nape::geom::ZPP_AABB _this = a->aabb;		HX_STACK_VAR(_this,"_this");
							HX_STACK_LINE(691)
			...
			while((true)){
				HX_STACK_LINE(709)
				if ((!(((bool((bool((a != null())) && bool((a->aabb->minx <= rayab->maxx)))) && bool((a->aabb->minx < (ray->originx + (ray->dirx * mint))))))))){
					HX_STACK_LINE(709)
					break;
				}
				struct _Function_4_1{
					inline static bool Block( ::zpp_nape::geom::ZPP_AABB &rayab,::zpp_nape::space::ZPP_SweepData &a){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/space/SweepPhase.hx",710,0x6f338844)
						{
							HX_STACK_LINE(710)
							::zpp_nape::geom::ZPP_AABB _this = a->aabb;		HX_STACK_VAR(_this,"_this");
							HX_STACK_LINE(710)
...
::nape::geom::RayResultList ZPP_SweepPhase_obj::rayMultiCast( ::zpp_nape::geom::ZPP_Ray ray,bool inner,::zpp_nape::dynamics::ZPP_InteractionFilter filter,::nape::geom::RayResultList output){
	...
	if (((ray->dirx == (int)0))){
		...
		while((true)){
			...
			struct _Function_3_1{
				inline static bool Block( ::zpp_nape::geom::ZPP_AABB &rayab,::zpp_nape::space::ZPP_SweepData &a){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/space/SweepPhase.hx",753,0x6f338844)
					{
						HX_STACK_LINE(753)
						::zpp_nape::geom::ZPP_AABB _this = a->aabb;		HX_STACK_VAR(_this,"_this");
						HX_STACK_LINE(753)
		...
		if (((ray->dirx < (int)0))){
			...
			while((true)){
				...
				struct _Function_4_1{
					inline static bool Block( ::zpp_nape::geom::ZPP_AABB &rayab,::zpp_nape::space::ZPP_SweepData &a){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/space/SweepPhase.hx",772,0x6f338844)
						{
							HX_STACK_LINE(772)
							::zpp_nape::geom::ZPP_AABB _this = a->aabb;		HX_STACK_VAR(_this,"_this");
							HX_STACK_LINE(772)
			...
			while((true)){
				...
				struct _Function_4_1{
					inline static bool Block( ::zpp_nape::geom::ZPP_AABB &rayab,::zpp_nape::space::ZPP_SweepData &a){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/space/SweepPhase.hx",785,0x6f338844)
						{
							HX_STACK_LINE(785)
							::zpp_nape::geom::ZPP_AABB _this = a->aabb;		HX_STACK_VAR(_this,"_this");
							HX_STACK_LINE(785)
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::zpp_nape::space::ZPP_SweepData*/ ,(int)offsetof(ZPP_SweepPhase_obj,list),HX_CSTRING("list")},
	{hx::fsObject /*::nape::phys::BodyList*/ ,(int)offsetof(ZPP_SweepPhase_obj,failed),HX_CSTRING("failed")},
	{ hx::fsUnknown, 0, null()}
};
#endif
