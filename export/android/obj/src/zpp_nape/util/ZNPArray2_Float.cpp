...
Float ZNPArray2_Float_obj::get( int x,int y){
	HX_STACK_FRAME("zpp_nape.util.ZNPArray2_Float","get",0x9ab6fbef,"zpp_nape.util.ZNPArray2_Float.get","zpp_nape/util/Array2.hx",218,0x6c3575ba)
	HX_STACK_THIS(this)
	HX_STACK_ARG(x,"x")
	HX_STACK_ARG(y,"y")
	HX_STACK_LINE(218)
...
Float ZNPArray2_Float_obj::set( int x,int y,Float obj){
	HX_STACK_FRAME("zpp_nape.util.ZNPArray2_Float","set",0x9ac016fb,"zpp_nape.util.ZNPArray2_Float.set","zpp_nape/util/Array2.hx",231,0x6c3575ba)
	HX_STACK_THIS(this)
	HX_STACK_ARG(x,"x")
	HX_STACK_ARG(y,"y")
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*Array< Float >*/ ,(int)offsetof(ZNPArray2_Float_obj,list),HX_CSTRING("list")},
	{hx::fsInt,(int)offsetof(ZNPArray2_Float_obj,width),HX_CSTRING("width")},
	{ hx::fsUnknown, 0, null()}
};
#endif
