...
::zpp_nape::geom::ZPP_GeomVert ZNPArray2_ZPP_GeomVert_obj::get( int x,int y){
	HX_STACK_FRAME("zpp_nape.util.ZNPArray2_ZPP_GeomVert","get",0xb6b79f2f,"zpp_nape.util.ZNPArray2_ZPP_GeomVert.get","zpp_nape/util/Array2.hx",278,0x6c3575ba)
	HX_STACK_THIS(this)
	HX_STACK_ARG(x,"x")
	HX_STACK_ARG(y,"y")
	HX_STACK_LINE(278)
	return this->list->__get(((y * this->width) + x)).StaticCast< ::zpp_nape::geom::ZPP_GeomVert >();
}
...
::zpp_nape::geom::ZPP_GeomVert ZNPArray2_ZPP_GeomVert_obj::set( int x,int y,::zpp_nape::geom::ZPP_GeomVert obj){
	HX_STACK_FRAME("zpp_nape.util.ZNPArray2_ZPP_GeomVert","set",0xb6c0ba3b,"zpp_nape.util.ZNPArray2_ZPP_GeomVert.set","zpp_nape/util/Array2.hx",291,0x6c3575ba)
	HX_STACK_THIS(this)
	HX_STACK_ARG(x,"x")
	HX_STACK_ARG(y,"y")
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*Array< ::Dynamic >*/ ,(int)offsetof(ZNPArray2_ZPP_GeomVert_obj,list),HX_CSTRING("list")},
	{hx::fsInt,(int)offsetof(ZNPArray2_ZPP_GeomVert_obj,width),HX_CSTRING("width")},
	{ hx::fsUnknown, 0, null()}
};
#endif
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("zpp_nape.util.ZNPArray2_ZPP_GeomVert"), hx::TCanCast< ZNPArray2_ZPP_GeomVert_obj> ,sStaticFields,sMemberFields,
