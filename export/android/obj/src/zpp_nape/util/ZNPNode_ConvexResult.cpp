...
{
HX_STACK_FRAME("zpp_nape.util.ZNPNode_ConvexResult","new",0x74146562,"zpp_nape.util.ZNPNode_ConvexResult.new","zpp_nape/util/Lists.hx",16147,0x9f4e6754)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(16181)
	this->elt = null();
...
{
		HX_STACK_FRAME("zpp_nape.util.ZNPNode_ConvexResult","alloc",0x7664fdf7,"zpp_nape.util.ZNPNode_ConvexResult.alloc","zpp_nape/util/Lists.hx",16175,0x9f4e6754)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("zpp_nape.util.ZNPNode_ConvexResult","free",0x1884696a,"zpp_nape.util.ZNPNode_ConvexResult.free","zpp_nape/util/Lists.hx",16179,0x9f4e6754)
		HX_STACK_THIS(this)
		HX_STACK_LINE(16179)
		this->elt = null();
	}
...
::nape::geom::ConvexResult ZNPNode_ConvexResult_obj::elem( ){
	HX_STACK_FRAME("zpp_nape.util.ZNPNode_ConvexResult","elem",0x17d6a54d,"zpp_nape.util.ZNPNode_ConvexResult.elem","zpp_nape/util/Lists.hx",16186,0x9f4e6754)
	HX_STACK_THIS(this)
	HX_STACK_LINE(16186)
	return this->elt;
}
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::zpp_nape::util::ZNPNode_ConvexResult*/ ,(int)offsetof(ZNPNode_ConvexResult_obj,next),HX_CSTRING("next")},
	{hx::fsObject /*::nape::geom::ConvexResult*/ ,(int)offsetof(ZNPNode_ConvexResult_obj,elt),HX_CSTRING("elt")},
	{ hx::fsUnknown, 0, null()}
};
#endif
