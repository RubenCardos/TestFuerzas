...
::zpp_nape::space::ZPP_AABBNode ZNPNode_ZPP_AABBNode_obj::elem( ){
	HX_STACK_FRAME("zpp_nape.util.ZNPNode_ZPP_AABBNode","elem",0x627a0e2a,"zpp_nape.util.ZNPNode_ZPP_AABBNode.elem","zpp_nape/util/Lists.hx",15842,0x9f4e6754)
	HX_STACK_THIS(this)
	HX_STACK_LINE(15842)
	return this->elt;
}
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::zpp_nape::util::ZNPNode_ZPP_AABBNode*/ ,(int)offsetof(ZNPNode_ZPP_AABBNode_obj,next),HX_CSTRING("next")},
	{hx::fsObject /*::zpp_nape::space::ZPP_AABBNode*/ ,(int)offsetof(ZNPNode_ZPP_AABBNode_obj,elt),HX_CSTRING("elt")},
	{ hx::fsUnknown, 0, null()}
};
#endif
