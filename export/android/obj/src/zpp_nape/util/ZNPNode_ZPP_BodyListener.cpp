...
::zpp_nape::callbacks::ZPP_BodyListener ZNPNode_ZPP_BodyListener_obj::elem( ){
	HX_STACK_FRAME("zpp_nape.util.ZNPNode_ZPP_BodyListener","elem",0xf91fd496,"zpp_nape.util.ZNPNode_ZPP_BodyListener.elem","zpp_nape/util/Lists.hx",15240,0x9f4e6754)
	HX_STACK_THIS(this)
	HX_STACK_LINE(15240)
	return this->elt;
}
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::zpp_nape::util::ZNPNode_ZPP_BodyListener*/ ,(int)offsetof(ZNPNode_ZPP_BodyListener_obj,next),HX_CSTRING("next")},
	{hx::fsObject /*::zpp_nape::callbacks::ZPP_BodyListener*/ ,(int)offsetof(ZNPNode_ZPP_BodyListener_obj,elt),HX_CSTRING("elt")},
	{ hx::fsUnknown, 0, null()}
};
#endif
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("zpp_nape.util.ZNPNode_ZPP_BodyListener"), hx::TCanCast< ZNPNode_ZPP_BodyListener_obj> ,sStaticFields,sMemberFields,
