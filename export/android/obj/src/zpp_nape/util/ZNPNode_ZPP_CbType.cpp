...
::zpp_nape::callbacks::ZPP_CbType ZNPNode_ZPP_CbType_obj::elem( ){
	HX_STACK_FRAME("zpp_nape.util.ZNPNode_ZPP_CbType","elem",0xfc6774b3,"zpp_nape.util.ZNPNode_ZPP_CbType.elem","zpp_nape/util/Lists.hx",14810,0x9f4e6754)
	HX_STACK_THIS(this)
	HX_STACK_LINE(14810)
	return this->elt;
}
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::zpp_nape::util::ZNPNode_ZPP_CbType*/ ,(int)offsetof(ZNPNode_ZPP_CbType_obj,next),HX_CSTRING("next")},
	{hx::fsObject /*::zpp_nape::callbacks::ZPP_CbType*/ ,(int)offsetof(ZNPNode_ZPP_CbType_obj,elt),HX_CSTRING("elt")},
	{ hx::fsUnknown, 0, null()}
};
#endif
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("zpp_nape.util.ZNPNode_ZPP_CbType"), hx::TCanCast< ZNPNode_ZPP_CbType_obj> ,sStaticFields,sMemberFields,
