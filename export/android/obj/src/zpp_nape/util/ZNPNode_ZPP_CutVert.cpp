...
::zpp_nape::geom::ZPP_CutVert ZNPNode_ZPP_CutVert_obj::elem( ){
	HX_STACK_FRAME("zpp_nape.util.ZNPNode_ZPP_CutVert","elem",0x95b0841b,"zpp_nape.util.ZNPNode_ZPP_CutVert.elem","zpp_nape/util/Lists.hx",15412,0x9f4e6754)
	HX_STACK_THIS(this)
	HX_STACK_LINE(15412)
	return this->elt;
}
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::zpp_nape::util::ZNPNode_ZPP_CutVert*/ ,(int)offsetof(ZNPNode_ZPP_CutVert_obj,next),HX_CSTRING("next")},
	{hx::fsObject /*::zpp_nape::geom::ZPP_CutVert*/ ,(int)offsetof(ZNPNode_ZPP_CutVert_obj,elt),HX_CSTRING("elt")},
	{ hx::fsUnknown, 0, null()}
};
#endif
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("zpp_nape.util.ZNPNode_ZPP_CutVert"), hx::TCanCast< ZNPNode_ZPP_CutVert_obj> ,sStaticFields,sMemberFields,
