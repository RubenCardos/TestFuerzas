...
::zpp_nape::geom::ZPP_GeomVert ZNPNode_ZPP_GeomVert_obj::elem( ){
	HX_STACK_FRAME("zpp_nape.util.ZNPNode_ZPP_GeomVert","elem",0xd89d215f,"zpp_nape.util.ZNPNode_ZPP_GeomVert.elem","zpp_nape/util/Lists.hx",15584,0x9f4e6754)
	HX_STACK_THIS(this)
	HX_STACK_LINE(15584)
	return this->elt;
}
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::zpp_nape::util::ZNPNode_ZPP_GeomVert*/ ,(int)offsetof(ZNPNode_ZPP_GeomVert_obj,next),HX_CSTRING("next")},
	{hx::fsObject /*::zpp_nape::geom::ZPP_GeomVert*/ ,(int)offsetof(ZNPNode_ZPP_GeomVert_obj,elt),HX_CSTRING("elt")},
	{ hx::fsUnknown, 0, null()}
};
#endif
