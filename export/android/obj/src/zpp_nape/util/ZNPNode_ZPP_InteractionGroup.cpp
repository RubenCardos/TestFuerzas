...
{
HX_STACK_FRAME("zpp_nape.util.ZNPNode_ZPP_InteractionGroup","new",0xac752f10,"zpp_nape.util.ZNPNode_ZPP_InteractionGroup.new","zpp_nape/util/Lists.hx",15889,0x9f4e6754)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(15923)
	this->elt = null();
...
{
		HX_STACK_FRAME("zpp_nape.util.ZNPNode_ZPP_InteractionGroup","alloc",0x1fce0f25,"zpp_nape.util.ZNPNode_ZPP_InteractionGroup.alloc","zpp_nape/util/Lists.hx",15917,0x9f4e6754)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("zpp_nape.util.ZNPNode_ZPP_InteractionGroup","free",0x34d417fc,"zpp_nape.util.ZNPNode_ZPP_InteractionGroup.free","zpp_nape/util/Lists.hx",15921,0x9f4e6754)
		HX_STACK_THIS(this)
		HX_STACK_LINE(15921)
		this->elt = null();
	}
...
::zpp_nape::dynamics::ZPP_InteractionGroup ZNPNode_ZPP_InteractionGroup_obj::elem( ){
	HX_STACK_FRAME("zpp_nape.util.ZNPNode_ZPP_InteractionGroup","elem",0x342653df,"zpp_nape.util.ZNPNode_ZPP_InteractionGroup.elem","zpp_nape/util/Lists.hx",15928,0x9f4e6754)
	HX_STACK_THIS(this)
	HX_STACK_LINE(15928)
	return this->elt;
}
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::zpp_nape::util::ZNPNode_ZPP_InteractionGroup*/ ,(int)offsetof(ZNPNode_ZPP_InteractionGroup_obj,next),HX_CSTRING("next")},
	{hx::fsObject /*::zpp_nape::dynamics::ZPP_InteractionGroup*/ ,(int)offsetof(ZNPNode_ZPP_InteractionGroup_obj,elt),HX_CSTRING("elt")},
	{ hx::fsUnknown, 0, null()}
};
#endif
