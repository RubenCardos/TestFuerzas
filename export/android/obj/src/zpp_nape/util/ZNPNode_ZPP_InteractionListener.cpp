...
::zpp_nape::callbacks::ZPP_InteractionListener ZNPNode_ZPP_InteractionListener_obj::elem( ){
	HX_STACK_FRAME("zpp_nape.util.ZNPNode_ZPP_InteractionListener","elem",0x1a4ccda8,"zpp_nape.util.ZNPNode_ZPP_InteractionListener.elem","zpp_nape/util/Lists.hx",15111,0x9f4e6754)
	HX_STACK_THIS(this)
	HX_STACK_LINE(15111)
	return this->elt;
}
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::zpp_nape::util::ZNPNode_ZPP_InteractionListener*/ ,(int)offsetof(ZNPNode_ZPP_InteractionListener_obj,next),HX_CSTRING("next")},
	{hx::fsObject /*::zpp_nape::callbacks::ZPP_InteractionListener*/ ,(int)offsetof(ZNPNode_ZPP_InteractionListener_obj,elt),HX_CSTRING("elt")},
	{ hx::fsUnknown, 0, null()}
};
#endif
