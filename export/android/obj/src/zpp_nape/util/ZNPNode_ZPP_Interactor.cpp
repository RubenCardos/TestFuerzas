...
::zpp_nape::phys::ZPP_Interactor ZNPNode_ZPP_Interactor_obj::elem( ){
	HX_STACK_FRAME("zpp_nape.util.ZNPNode_ZPP_Interactor","elem",0x2dc8d6d3,"zpp_nape.util.ZNPNode_ZPP_Interactor.elem","zpp_nape/util/Lists.hx",15197,0x9f4e6754)
	HX_STACK_THIS(this)
	HX_STACK_LINE(15197)
	return this->elt;
}
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::zpp_nape::util::ZNPNode_ZPP_Interactor*/ ,(int)offsetof(ZNPNode_ZPP_Interactor_obj,next),HX_CSTRING("next")},
	{hx::fsObject /*::zpp_nape::phys::ZPP_Interactor*/ ,(int)offsetof(ZNPNode_ZPP_Interactor_obj,elt),HX_CSTRING("elt")},
	{ hx::fsUnknown, 0, null()}
};
#endif
