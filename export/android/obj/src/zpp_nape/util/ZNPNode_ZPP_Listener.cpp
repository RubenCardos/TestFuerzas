...
{
HX_STACK_FRAME("zpp_nape.util.ZNPNode_ZPP_Listener","new",0x303423f7,"zpp_nape.util.ZNPNode_ZPP_Listener.new","zpp_nape/util/Lists.hx",16061,0x9f4e6754)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(16095)
	this->elt = null();
...
{
		HX_STACK_FRAME("zpp_nape.util.ZNPNode_ZPP_Listener","alloc",0x48e14bcc,"zpp_nape.util.ZNPNode_ZPP_Listener.alloc","zpp_nape/util/Lists.hx",16089,0x9f4e6754)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("zpp_nape.util.ZNPNode_ZPP_Listener","free",0xf82b6d35,"zpp_nape.util.ZNPNode_ZPP_Listener.free","zpp_nape/util/Lists.hx",16093,0x9f4e6754)
		HX_STACK_THIS(this)
		HX_STACK_LINE(16093)
		this->elt = null();
	}
...
::zpp_nape::callbacks::ZPP_Listener ZNPNode_ZPP_Listener_obj::elem( ){
	HX_STACK_FRAME("zpp_nape.util.ZNPNode_ZPP_Listener","elem",0xf77da918,"zpp_nape.util.ZNPNode_ZPP_Listener.elem","zpp_nape/util/Lists.hx",16100,0x9f4e6754)
	HX_STACK_THIS(this)
	HX_STACK_LINE(16100)
	return this->elt;
}
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::zpp_nape::util::ZNPNode_ZPP_Listener*/ ,(int)offsetof(ZNPNode_ZPP_Listener_obj,next),HX_CSTRING("next")},
	{hx::fsObject /*::zpp_nape::callbacks::ZPP_Listener*/ ,(int)offsetof(ZNPNode_ZPP_Listener_obj,elt),HX_CSTRING("elt")},
	{ hx::fsUnknown, 0, null()}
};
#endif
