...
::zpp_nape::geom::ZPP_SimpleEvent ZNPNode_ZPP_SimpleEvent_obj::elem( ){
	HX_STACK_FRAME("zpp_nape.util.ZNPNode_ZPP_SimpleEvent","elem",0x6ea07146,"zpp_nape.util.ZNPNode_ZPP_SimpleEvent.elem","zpp_nape/util/Lists.hx",15670,0x9f4e6754)
	HX_STACK_THIS(this)
	HX_STACK_LINE(15670)
	return this->elt;
}
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::zpp_nape::util::ZNPNode_ZPP_SimpleEvent*/ ,(int)offsetof(ZNPNode_ZPP_SimpleEvent_obj,next),HX_CSTRING("next")},
	{hx::fsObject /*::zpp_nape::geom::ZPP_SimpleEvent*/ ,(int)offsetof(ZNPNode_ZPP_SimpleEvent_obj,elt),HX_CSTRING("elt")},
	{ hx::fsUnknown, 0, null()}
};
#endif
