...
{
HX_STACK_FRAME("zpp_nape.util.ZNPNode_ZPP_SimpleVert","new",0x66910346,"zpp_nape.util.ZNPNode_ZPP_SimpleVert.new","zpp_nape/util/Lists.hx",15588,0x9f4e6754)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(15622)
	this->elt = null();
...
{
		HX_STACK_FRAME("zpp_nape.util.ZNPNode_ZPP_SimpleVert","alloc",0x77afdcdb,"zpp_nape.util.ZNPNode_ZPP_SimpleVert.alloc","zpp_nape/util/Lists.hx",15616,0x9f4e6754)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("zpp_nape.util.ZNPNode_ZPP_SimpleVert","free",0x5311f306,"zpp_nape.util.ZNPNode_ZPP_SimpleVert.free","zpp_nape/util/Lists.hx",15620,0x9f4e6754)
		HX_STACK_THIS(this)
		HX_STACK_LINE(15620)
		this->elt = null();
	}
...
::zpp_nape::geom::ZPP_SimpleVert ZNPNode_ZPP_SimpleVert_obj::elem( ){
	HX_STACK_FRAME("zpp_nape.util.ZNPNode_ZPP_SimpleVert","elem",0x52642ee9,"zpp_nape.util.ZNPNode_ZPP_SimpleVert.elem","zpp_nape/util/Lists.hx",15627,0x9f4e6754)
	HX_STACK_THIS(this)
	HX_STACK_LINE(15627)
	return this->elt;
}
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::zpp_nape::util::ZNPNode_ZPP_SimpleVert*/ ,(int)offsetof(ZNPNode_ZPP_SimpleVert_obj,next),HX_CSTRING("next")},
	{hx::fsObject /*::zpp_nape::geom::ZPP_SimpleVert*/ ,(int)offsetof(ZNPNode_ZPP_SimpleVert_obj,elt),HX_CSTRING("elt")},
	{ hx::fsUnknown, 0, null()}
};
#endif
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("zpp_nape.util.ZNPNode_ZPP_SimpleVert"), hx::TCanCast< ZNPNode_ZPP_SimpleVert_obj> ,sStaticFields,sMemberFields,
