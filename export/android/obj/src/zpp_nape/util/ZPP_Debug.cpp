...
HX_STACK_ARG(height,"height")
{
	...
	this->viewport = _g1;
	HX_STACK_LINE(198)
	::zpp_nape::geom::ZPP_AABB _g3;		HX_STACK_VAR(_g3,"_g3");
	HX_STACK_LINE(198)
	{
		HX_STACK_LINE(198)
		::zpp_nape::geom::ZPP_AABB ret;		HX_STACK_VAR(ret,"ret");
		HX_STACK_LINE(198)
		{
			...
			if (((::zpp_nape::geom::ZPP_AABB_obj::zpp_pool == null()))){
				HX_STACK_LINE(198)
				::zpp_nape::geom::ZPP_AABB _g2 = ::zpp_nape::geom::ZPP_AABB_obj::__new();		HX_STACK_VAR(_g2,"_g2");
				HX_STACK_LINE(198)
				ret = _g2;
			}
			else{
	...
	this->iport = _g3;
	HX_STACK_LINE(199)
	::zpp_nape::geom::ZPP_AABB _g4 = ::zpp_nape::geom::ZPP_AABB_obj::__new();		HX_STACK_VAR(_g4,"_g4");
	HX_STACK_LINE(199)
	this->tmpab = _g4;
}
;
...
Void ZPP_Debug_obj::xform_invalidate( ){
{
		...
		struct _Function_1_1{
			inline static Float Block( hx::ObjectPtr< ::zpp_nape::util::ZPP_Debug_obj > __this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/util/Debug.hx",202,0xeecbde16)
				{
					HX_STACK_LINE(203)
					...
					HX_STACK_LINE(203)
					{
						...
						HX_STACK_LINE(203)
						x = ((_this->zpp_inner->a * _this->zpp_inner->d) - (_this->zpp_inner->b * _this->zpp_inner->c));
					}
					HX_STACK_LINE(204)
		...
		HX_STACK_LINE(202)
		Float _g = ::Math_obj::sqrt(_Function_1_1::Block(this));		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(202)
		this->xdet = _g;
		HX_STACK_LINE(206)
			...
			if (((ret->zpp_inner == null()))){
				...
				struct _Function_3_1{
					inline static bool Block( ::nape::geom::Vec2 &ret,Float &y){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/util/Debug.hx",208,0xeecbde16)
						{
							HX_STACK_LINE(208)
				...
				HX_STACK_LINE(208)
				if ((!(((  (((_g4 == x))) ? bool(_Function_3_1::Block(ret,y)) : bool(false) ))))){
					HX_STACK_LINE(208)
					{
						HX_STACK_LINE(208)
						ret->zpp_inner->x = x;
		...
		HX_STACK_LINE(252)
		::nape::geom::Vec2 _g9 = qmat->transform(q,null(),null());		HX_STACK_VAR(_g9,"_g9");
		HX_STACK_LINE(252)
		v = _g9;
		HX_STACK_LINE(253)
		{
		...
		HX_STACK_LINE(256)
		::nape::geom::Vec2 _g11 = qmat->transform(q,null(),null());		HX_STACK_VAR(_g11,"_g11");
		HX_STACK_LINE(256)
		v = _g11;
		HX_STACK_LINE(257)
		{
		...
		HX_STACK_LINE(260)
		::nape::geom::Vec2 _g13 = qmat->transform(q,null(),null());		HX_STACK_VAR(_g13,"_g13");
		HX_STACK_LINE(260)
		v = _g13;
		HX_STACK_LINE(261)
		{
...
bool ZPP_Debug_obj::cull( ::zpp_nape::geom::ZPP_AABB aabb){
	HX_STACK_FRAME("zpp_nape.util.ZPP_Debug","cull",0x3dc079dd,"zpp_nape.util.ZPP_Debug.cull","zpp_nape/util/Debug.hx",271,0xeecbde16)
	HX_STACK_THIS(this)
	HX_STACK_ARG(aabb,"aabb")
	HX_STACK_LINE(271)
	if ((this->xnull)){
		HX_STACK_LINE(271)
		::zpp_nape::geom::ZPP_AABB x = this->viewport;		HX_STACK_VAR(x,"x");
		HX_STACK_LINE(271)
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::nape::util::Debug*/ ,(int)offsetof(ZPP_Debug_obj,outer),HX_CSTRING("outer")},
	{hx::fsBool,(int)offsetof(ZPP_Debug_obj,isbmp),HX_CSTRING("isbmp")},
	{hx::fsObject /*::zpp_nape::util::ZPP_ShapeDebug*/ ,(int)offsetof(ZPP_Debug_obj,d_shape),HX_CSTRING("d_shape")},
	{hx::fsFloat,(int)offsetof(ZPP_Debug_obj,bg_r),HX_CSTRING("bg_r")},
	{hx::fsFloat,(int)offsetof(ZPP_Debug_obj,bg_g),HX_CSTRING("bg_g")},
	{hx::fsFloat,(int)offsetof(ZPP_Debug_obj,bg_b),HX_CSTRING("bg_b")},
	{hx::fsInt,(int)offsetof(ZPP_Debug_obj,bg_col),HX_CSTRING("bg_col")},
	{hx::fsObject /*::zpp_nape::geom::ZPP_Mat23*/ ,(int)offsetof(ZPP_Debug_obj,xform),HX_CSTRING("xform")},
	{hx::fsBool,(int)offsetof(ZPP_Debug_obj,xnull),HX_CSTRING("xnull")},
	{hx::fsFloat,(int)offsetof(ZPP_Debug_obj,xdet),HX_CSTRING("xdet")},
	{hx::fsInt,(int)offsetof(ZPP_Debug_obj,width),HX_CSTRING("width")},
	{hx::fsInt,(int)offsetof(ZPP_Debug_obj,height),HX_CSTRING("height")},
	{hx::fsObject /*::zpp_nape::geom::ZPP_AABB*/ ,(int)offsetof(ZPP_Debug_obj,viewport),HX_CSTRING("viewport")},
	{hx::fsObject /*::zpp_nape::geom::ZPP_AABB*/ ,(int)offsetof(ZPP_Debug_obj,iport),HX_CSTRING("iport")},
	{hx::fsObject /*::zpp_nape::geom::ZPP_AABB*/ ,(int)offsetof(ZPP_Debug_obj,tmpab),HX_CSTRING("tmpab")},
	{ hx::fsUnknown, 0, null()}
};
#endif
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("zpp_nape.util.ZPP_Debug"), hx::TCanCast< ZPP_Debug_obj> ,sStaticFields,sMemberFields,
