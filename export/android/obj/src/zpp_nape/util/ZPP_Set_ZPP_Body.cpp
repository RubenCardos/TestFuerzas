...
bool ZPP_Set_ZPP_Body_obj::empty( ){
	HX_STACK_FRAME("zpp_nape.util.ZPP_Set_ZPP_Body","empty",0xa71375d3,"zpp_nape.util.ZPP_Set_ZPP_Body.empty","zpp_nape/util/RBTree.hx",284,0x3f078845)
	HX_STACK_THIS(this)
	HX_STACK_LINE(284)
...
bool ZPP_Set_ZPP_Body_obj::singular( ){
	HX_STACK_FRAME("zpp_nape.util.ZPP_Set_ZPP_Body","singular",0xd7693d51,"zpp_nape.util.ZPP_Set_ZPP_Body.singular","zpp_nape/util/RBTree.hx",287,0x3f078845)
	HX_STACK_THIS(this)
	HX_STACK_LINE(287)
...
bool ZPP_Set_ZPP_Body_obj::has( ::zpp_nape::phys::ZPP_Body obj){
	...
	HX_STACK_LINE(320)
	::zpp_nape::util::ZPP_Set_ZPP_Body _g = this->find(obj);		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(320)
	return (_g != null());
}
...
bool ZPP_Set_ZPP_Body_obj::has_weak( ::zpp_nape::phys::ZPP_Body obj){
	...
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(331)
	::zpp_nape::util::ZPP_Set_ZPP_Body _g = this->find_weak(obj);		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(331)
	return (_g != null());
}
...
::zpp_nape::phys::ZPP_Body ZPP_Set_ZPP_Body_obj::lower_bound( ::zpp_nape::phys::ZPP_Body obj){
	HX_STACK_FRAME("zpp_nape.util.ZPP_Set_ZPP_Body","lower_bound",0x4de6dc06,"zpp_nape.util.ZPP_Set_ZPP_Body.lower_bound","zpp_nape/util/RBTree.hx",343,0x3f078845)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(344)
...
::zpp_nape::phys::ZPP_Body ZPP_Set_ZPP_Body_obj::successor( ::zpp_nape::phys::ZPP_Body obj){
	...
	::zpp_nape::util::ZPP_Set_ZPP_Body _g = this->find(obj);		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(474)
	::zpp_nape::util::ZPP_Set_ZPP_Body node = this->successor_node(_g);		HX_STACK_VAR(node,"node");
	HX_STACK_LINE(475)
	if (((node == null()))){
		HX_STACK_LINE(475)
		return null();
...
::zpp_nape::phys::ZPP_Body ZPP_Set_ZPP_Body_obj::predecessor( ::zpp_nape::phys::ZPP_Body obj){
	...
	::zpp_nape::util::ZPP_Set_ZPP_Body _g = this->find(obj);		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(486)
	::zpp_nape::util::ZPP_Set_ZPP_Body node = this->predecessor_node(_g);		HX_STACK_VAR(node,"node");
	HX_STACK_LINE(487)
	if (((node == null()))){
		HX_STACK_LINE(487)
		return null();
...
Void ZPP_Set_ZPP_Body_obj::remove_node( ::zpp_nape::util::ZPP_Set_ZPP_Body cur){
{
		...
		HX_STACK_LINE(517)
		::zpp_nape::util::ZPP_Set_ZPP_Body child;		HX_STACK_VAR(child,"child");
		HX_STACK_LINE(517)
		if (((cur->prev == null()))){
			HX_STACK_LINE(517)
			child = cur->next;
		...
		HX_STACK_LINE(590)
		::zpp_nape::util::ZPP_Set_ZPP_Body _g = cur->next = null();		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(590)
		::zpp_nape::util::ZPP_Set_ZPP_Body _g1 = cur->prev = _g;		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(590)
		cur->parent = _g1;
		HX_STACK_LINE(591)
		{
...
Void ZPP_Set_ZPP_Body_obj::clear( ){
{
		...
		if (((this->parent == null()))){
			...
			while((true)){
				...
				HX_STACK_LINE(610)
				::zpp_nape::util::ZPP_Set_ZPP_Body _g;		HX_STACK_VAR(_g,"_g");
				HX_STACK_LINE(610)
				if (((cur->prev != null()))){
					HX_STACK_LINE(610)
					_g = cur->prev;
...
{
		HX_STACK_FRAME("zpp_nape.util.ZPP_Set_ZPP_Body","clear_with",0x49528832,"zpp_nape.util.ZPP_Set_ZPP_Body.clear_with","zpp_nape/util/RBTree.hx",614,0x3f078845)
		HX_STACK_THIS(this)
				...
				if ((this->lt(cur->data,obj))){
					...
					if (((cur->next == null()))){
						HX_STACK_LINE(868)
						{
							...
							if (((::zpp_nape::util::ZPP_Set_ZPP_Body_obj::zpp_pool == null()))){
								HX_STACK_LINE(870)
								::zpp_nape::util::ZPP_Set_ZPP_Body _g2 = ::zpp_nape::util::ZPP_Set_ZPP_Body_obj::__new();		HX_STACK_VAR(_g2,"_g2");
								HX_STACK_LINE(870)
								x = _g2;
							}
							else{
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(ZPP_Set_ZPP_Body_obj,lt),HX_CSTRING("lt")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(ZPP_Set_ZPP_Body_obj,swapped),HX_CSTRING("swapped")},
	{hx::fsObject /*::zpp_nape::phys::ZPP_Body*/ ,(int)offsetof(ZPP_Set_ZPP_Body_obj,data),HX_CSTRING("data")},
	{hx::fsObject /*::zpp_nape::util::ZPP_Set_ZPP_Body*/ ,(int)offsetof(ZPP_Set_ZPP_Body_obj,prev),HX_CSTRING("prev")},
	{hx::fsObject /*::zpp_nape::util::ZPP_Set_ZPP_Body*/ ,(int)offsetof(ZPP_Set_ZPP_Body_obj,next),HX_CSTRING("next")},
	{hx::fsObject /*::zpp_nape::util::ZPP_Set_ZPP_Body*/ ,(int)offsetof(ZPP_Set_ZPP_Body_obj,parent),HX_CSTRING("parent")},
	{hx::fsInt,(int)offsetof(ZPP_Set_ZPP_Body_obj,colour),HX_CSTRING("colour")},
	{ hx::fsUnknown, 0, null()}
};
#endif
