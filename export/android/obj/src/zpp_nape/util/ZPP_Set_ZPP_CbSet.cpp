...
bool ZPP_Set_ZPP_CbSet_obj::empty( ){
	HX_STACK_FRAME("zpp_nape.util.ZPP_Set_ZPP_CbSet","empty",0x911b5fd0,"zpp_nape.util.ZPP_Set_ZPP_CbSet.empty","zpp_nape/util/RBTree.hx",6507,0x3f078845)
	HX_STACK_THIS(this)
	HX_STACK_LINE(6507)
...
bool ZPP_Set_ZPP_CbSet_obj::singular( ){
	HX_STACK_FRAME("zpp_nape.util.ZPP_Set_ZPP_CbSet","singular",0x55b3ef74,"zpp_nape.util.ZPP_Set_ZPP_CbSet.singular","zpp_nape/util/RBTree.hx",6510,0x3f078845)
	HX_STACK_THIS(this)
	HX_STACK_LINE(6510)
...
bool ZPP_Set_ZPP_CbSet_obj::has( ::zpp_nape::callbacks::ZPP_CbSet obj){
	...
	HX_STACK_LINE(6543)
	::zpp_nape::util::ZPP_Set_ZPP_CbSet _g = this->find(obj);		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(6543)
	return (_g != null());
}
...
bool ZPP_Set_ZPP_CbSet_obj::has_weak( ::zpp_nape::callbacks::ZPP_CbSet obj){
	...
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(6554)
	::zpp_nape::util::ZPP_Set_ZPP_CbSet _g = this->find_weak(obj);		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(6554)
	return (_g != null());
}
...
::zpp_nape::callbacks::ZPP_CbSet ZPP_Set_ZPP_CbSet_obj::lower_bound( ::zpp_nape::callbacks::ZPP_CbSet obj){
	HX_STACK_FRAME("zpp_nape.util.ZPP_Set_ZPP_CbSet","lower_bound",0x18f9e1c3,"zpp_nape.util.ZPP_Set_ZPP_CbSet.lower_bound","zpp_nape/util/RBTree.hx",6566,0x3f078845)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(6567)
...
::zpp_nape::callbacks::ZPP_CbSet ZPP_Set_ZPP_CbSet_obj::successor( ::zpp_nape::callbacks::ZPP_CbSet obj){
	...
	::zpp_nape::util::ZPP_Set_ZPP_CbSet _g = this->find(obj);		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(6697)
	::zpp_nape::util::ZPP_Set_ZPP_CbSet node = this->successor_node(_g);		HX_STACK_VAR(node,"node");
	HX_STACK_LINE(6698)
	if (((node == null()))){
		HX_STACK_LINE(6698)
		return null();
...
::zpp_nape::callbacks::ZPP_CbSet ZPP_Set_ZPP_CbSet_obj::predecessor( ::zpp_nape::callbacks::ZPP_CbSet obj){
	...
	::zpp_nape::util::ZPP_Set_ZPP_CbSet _g = this->find(obj);		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(6709)
	::zpp_nape::util::ZPP_Set_ZPP_CbSet node = this->predecessor_node(_g);		HX_STACK_VAR(node,"node");
	HX_STACK_LINE(6710)
	if (((node == null()))){
		HX_STACK_LINE(6710)
		return null();
...
Void ZPP_Set_ZPP_CbSet_obj::remove_node( ::zpp_nape::util::ZPP_Set_ZPP_CbSet cur){
{
		...
		HX_STACK_LINE(6740)
		::zpp_nape::util::ZPP_Set_ZPP_CbSet child;		HX_STACK_VAR(child,"child");
		HX_STACK_LINE(6740)
		if (((cur->prev == null()))){
			HX_STACK_LINE(6740)
			child = cur->next;
		...
		HX_STACK_LINE(6813)
		::zpp_nape::util::ZPP_Set_ZPP_CbSet _g = cur->next = null();		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(6813)
		::zpp_nape::util::ZPP_Set_ZPP_CbSet _g1 = cur->prev = _g;		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(6813)
		cur->parent = _g1;
		HX_STACK_LINE(6814)
		{
...
Void ZPP_Set_ZPP_CbSet_obj::clear( ){
{
		...
		if (((this->parent == null()))){
			...
			while((true)){
				...
				HX_STACK_LINE(6833)
				::zpp_nape::util::ZPP_Set_ZPP_CbSet _g;		HX_STACK_VAR(_g,"_g");
				HX_STACK_LINE(6833)
				if (((cur->prev != null()))){
					HX_STACK_LINE(6833)
					_g = cur->prev;
...
{
		HX_STACK_FRAME("zpp_nape.util.ZPP_Set_ZPP_CbSet","clear_with",0xf5484915,"zpp_nape.util.ZPP_Set_ZPP_CbSet.clear_with","zpp_nape/util/RBTree.hx",6837,0x3f078845)
		HX_STACK_THIS(this)
			...
			if ((this->lt(obj,cur->data))){
				...
				if (((cur->prev == null()))){
					HX_STACK_LINE(7065)
					{
						...
						if (((::zpp_nape::util::ZPP_Set_ZPP_CbSet_obj::zpp_pool == null()))){
							HX_STACK_LINE(7067)
							::zpp_nape::util::ZPP_Set_ZPP_CbSet _g1 = ::zpp_nape::util::ZPP_Set_ZPP_CbSet_obj::__new();		HX_STACK_VAR(_g1,"_g1");
							HX_STACK_LINE(7067)
							x = _g1;
						}
						else{
				...
				if ((this->lt(cur->data,obj))){
					...
					if (((cur->next == null()))){
						HX_STACK_LINE(7091)
						{
							...
							if (((::zpp_nape::util::ZPP_Set_ZPP_CbSet_obj::zpp_pool == null()))){
								HX_STACK_LINE(7093)
								::zpp_nape::util::ZPP_Set_ZPP_CbSet _g2 = ::zpp_nape::util::ZPP_Set_ZPP_CbSet_obj::__new();		HX_STACK_VAR(_g2,"_g2");
								HX_STACK_LINE(7093)
								x = _g2;
							}
							else{
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(ZPP_Set_ZPP_CbSet_obj,lt),HX_CSTRING("lt")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(ZPP_Set_ZPP_CbSet_obj,swapped),HX_CSTRING("swapped")},
	{hx::fsObject /*::zpp_nape::callbacks::ZPP_CbSet*/ ,(int)offsetof(ZPP_Set_ZPP_CbSet_obj,data),HX_CSTRING("data")},
	{hx::fsObject /*::zpp_nape::util::ZPP_Set_ZPP_CbSet*/ ,(int)offsetof(ZPP_Set_ZPP_CbSet_obj,prev),HX_CSTRING("prev")},
	{hx::fsObject /*::zpp_nape::util::ZPP_Set_ZPP_CbSet*/ ,(int)offsetof(ZPP_Set_ZPP_CbSet_obj,next),HX_CSTRING("next")},
	{hx::fsObject /*::zpp_nape::util::ZPP_Set_ZPP_CbSet*/ ,(int)offsetof(ZPP_Set_ZPP_CbSet_obj,parent),HX_CSTRING("parent")},
	{hx::fsInt,(int)offsetof(ZPP_Set_ZPP_CbSet_obj,colour),HX_CSTRING("colour")},
	{ hx::fsUnknown, 0, null()}
};
#endif
