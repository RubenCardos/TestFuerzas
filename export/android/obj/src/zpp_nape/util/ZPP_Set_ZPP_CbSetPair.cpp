...
bool ZPP_Set_ZPP_CbSetPair_obj::empty( ){
	HX_STACK_FRAME("zpp_nape.util.ZPP_Set_ZPP_CbSetPair","empty",0x02f1bc0a,"zpp_nape.util.ZPP_Set_ZPP_CbSetPair.empty","zpp_nape/util/RBTree.hx",1173,0x3f078845)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1173)
...
bool ZPP_Set_ZPP_CbSetPair_obj::singular( ){
	HX_STACK_FRAME("zpp_nape.util.ZPP_Set_ZPP_CbSetPair","singular",0x2395737a,"zpp_nape.util.ZPP_Set_ZPP_CbSetPair.singular","zpp_nape/util/RBTree.hx",1176,0x3f078845)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1176)
...
bool ZPP_Set_ZPP_CbSetPair_obj::has( ::zpp_nape::callbacks::ZPP_CbSetPair obj){
	...
	HX_STACK_LINE(1209)
	::zpp_nape::util::ZPP_Set_ZPP_CbSetPair _g = this->find(obj);		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(1209)
	return (_g != null());
}
...
bool ZPP_Set_ZPP_CbSetPair_obj::has_weak( ::zpp_nape::callbacks::ZPP_CbSetPair obj){
	...
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(1220)
	::zpp_nape::util::ZPP_Set_ZPP_CbSetPair _g = this->find_weak(obj);		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(1220)
	return (_g != null());
}
...
::zpp_nape::callbacks::ZPP_CbSetPair ZPP_Set_ZPP_CbSetPair_obj::lower_bound( ::zpp_nape::callbacks::ZPP_CbSetPair obj){
	HX_STACK_FRAME("zpp_nape.util.ZPP_Set_ZPP_CbSetPair","lower_bound",0xb1da257d,"zpp_nape.util.ZPP_Set_ZPP_CbSetPair.lower_bound","zpp_nape/util/RBTree.hx",1232,0x3f078845)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(1233)
...
::zpp_nape::callbacks::ZPP_CbSetPair ZPP_Set_ZPP_CbSetPair_obj::successor( ::zpp_nape::callbacks::ZPP_CbSetPair obj){
	...
	::zpp_nape::util::ZPP_Set_ZPP_CbSetPair _g = this->find(obj);		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(1363)
	::zpp_nape::util::ZPP_Set_ZPP_CbSetPair node = this->successor_node(_g);		HX_STACK_VAR(node,"node");
	HX_STACK_LINE(1364)
	if (((node == null()))){
		HX_STACK_LINE(1364)
		return null();
...
::zpp_nape::callbacks::ZPP_CbSetPair ZPP_Set_ZPP_CbSetPair_obj::predecessor( ::zpp_nape::callbacks::ZPP_CbSetPair obj){
	...
	::zpp_nape::util::ZPP_Set_ZPP_CbSetPair _g = this->find(obj);		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(1375)
	::zpp_nape::util::ZPP_Set_ZPP_CbSetPair node = this->predecessor_node(_g);		HX_STACK_VAR(node,"node");
	HX_STACK_LINE(1376)
	if (((node == null()))){
		HX_STACK_LINE(1376)
		return null();
...
Void ZPP_Set_ZPP_CbSetPair_obj::remove_node( ::zpp_nape::util::ZPP_Set_ZPP_CbSetPair cur){
{
		...
		HX_STACK_LINE(1406)
		::zpp_nape::util::ZPP_Set_ZPP_CbSetPair child;		HX_STACK_VAR(child,"child");
		HX_STACK_LINE(1406)
		if (((cur->prev == null()))){
			HX_STACK_LINE(1406)
			child = cur->next;
		...
		HX_STACK_LINE(1479)
		::zpp_nape::util::ZPP_Set_ZPP_CbSetPair _g = cur->next = null();		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(1479)
		::zpp_nape::util::ZPP_Set_ZPP_CbSetPair _g1 = cur->prev = _g;		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(1479)
		cur->parent = _g1;
		HX_STACK_LINE(1480)
		{
...
Void ZPP_Set_ZPP_CbSetPair_obj::clear( ){
{
		...
		if (((this->parent == null()))){
			...
			while((true)){
				...
				HX_STACK_LINE(1499)
				::zpp_nape::util::ZPP_Set_ZPP_CbSetPair _g;		HX_STACK_VAR(_g,"_g");
				HX_STACK_LINE(1499)
				if (((cur->prev != null()))){
					HX_STACK_LINE(1499)
					_g = cur->prev;
...
{
		HX_STACK_FRAME("zpp_nape.util.ZPP_Set_ZPP_CbSetPair","clear_with",0x21975a9b,"zpp_nape.util.ZPP_Set_ZPP_CbSetPair.clear_with","zpp_nape/util/RBTree.hx",1503,0x3f078845)
		HX_STACK_THIS(this)
	...
	if (((this->parent == null()))){
		HX_STACK_LINE(1706)
		{
			...
			if (((::zpp_nape::util::ZPP_Set_ZPP_CbSetPair_obj::zpp_pool == null()))){
				HX_STACK_LINE(1708)
				::zpp_nape::util::ZPP_Set_ZPP_CbSetPair _g = ::zpp_nape::util::ZPP_Set_ZPP_CbSetPair_obj::__new();		HX_STACK_VAR(_g,"_g");
				HX_STACK_LINE(1708)
				x = _g;
			}
			else{
				...
				if ((this->lt(cur->data,obj))){
					...
					if (((cur->next == null()))){
						HX_STACK_LINE(1757)
						{
							...
							if (((::zpp_nape::util::ZPP_Set_ZPP_CbSetPair_obj::zpp_pool == null()))){
								HX_STACK_LINE(1759)
								::zpp_nape::util::ZPP_Set_ZPP_CbSetPair _g2 = ::zpp_nape::util::ZPP_Set_ZPP_CbSetPair_obj::__new();		HX_STACK_VAR(_g2,"_g2");
								HX_STACK_LINE(1759)
								x = _g2;
							}
							else{
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(ZPP_Set_ZPP_CbSetPair_obj,lt),HX_CSTRING("lt")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(ZPP_Set_ZPP_CbSetPair_obj,swapped),HX_CSTRING("swapped")},
	{hx::fsObject /*::zpp_nape::callbacks::ZPP_CbSetPair*/ ,(int)offsetof(ZPP_Set_ZPP_CbSetPair_obj,data),HX_CSTRING("data")},
	{hx::fsObject /*::zpp_nape::util::ZPP_Set_ZPP_CbSetPair*/ ,(int)offsetof(ZPP_Set_ZPP_CbSetPair_obj,prev),HX_CSTRING("prev")},
	{hx::fsObject /*::zpp_nape::util::ZPP_Set_ZPP_CbSetPair*/ ,(int)offsetof(ZPP_Set_ZPP_CbSetPair_obj,next),HX_CSTRING("next")},
	{hx::fsObject /*::zpp_nape::util::ZPP_Set_ZPP_CbSetPair*/ ,(int)offsetof(ZPP_Set_ZPP_CbSetPair_obj,parent),HX_CSTRING("parent")},
	{hx::fsInt,(int)offsetof(ZPP_Set_ZPP_CbSetPair_obj,colour),HX_CSTRING("colour")},
	{ hx::fsUnknown, 0, null()}
};
#endif
