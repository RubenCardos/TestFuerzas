...
{
HX_STACK_FRAME("zpp_nape.util.ZPP_Set_ZPP_PartitionPair","new",0x0fb4ae44,"zpp_nape.util.ZPP_Set_ZPP_PartitionPair.new","zpp_nape/util/RBTree.hx",1953,0x3f078845)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(1994)
	this->colour = (int)0;
...
{
		HX_STACK_FRAME("zpp_nape.util.ZPP_Set_ZPP_PartitionPair","free",0xa923e648,"zpp_nape.util.ZPP_Set_ZPP_PartitionPair.free","zpp_nape/util/RBTree.hx",1980,0x3f078845)
		HX_STACK_THIS(this)
		HX_STACK_LINE(1981)
		this->data = null();
		HX_STACK_LINE(1982)
...
{
		HX_STACK_FRAME("zpp_nape.util.ZPP_Set_ZPP_PartitionPair","alloc",0x7152c359,"zpp_nape.util.ZPP_Set_ZPP_PartitionPair.alloc","zpp_nape/util/RBTree.hx",1987,0x3f078845)
		HX_STACK_THIS(this)
	}
return null();
}
...
bool ZPP_Set_ZPP_PartitionPair_obj::verify( ){
	HX_STACK_FRAME("zpp_nape.util.ZPP_Set_ZPP_PartitionPair","verify",0x18bb6c15,"zpp_nape.util.ZPP_Set_ZPP_PartitionPair.verify","zpp_nape/util/RBTree.hx",1996,0x3f078845)
	HX_STACK_THIS(this)
	HX_STACK_LINE(2006)
	if ((!(this->empty()))){
		HX_STACK_LINE(2007)
...
bool ZPP_Set_ZPP_PartitionPair_obj::empty( ){
	HX_STACK_FRAME("zpp_nape.util.ZPP_Set_ZPP_PartitionPair","empty",0xbf995971,"zpp_nape.util.ZPP_Set_ZPP_PartitionPair.empty","zpp_nape/util/RBTree.hx",2062,0x3f078845)
	HX_STACK_THIS(this)
	HX_STACK_LINE(2062)
...
bool ZPP_Set_ZPP_PartitionPair_obj::singular( ){
	HX_STACK_FRAME("zpp_nape.util.ZPP_Set_ZPP_PartitionPair","singular",0x93e2f073,"zpp_nape.util.ZPP_Set_ZPP_PartitionPair.singular","zpp_nape/util/RBTree.hx",2065,0x3f078845)
	HX_STACK_THIS(this)
	HX_STACK_LINE(2065)
...
int ZPP_Set_ZPP_PartitionPair_obj::size( ){
	HX_STACK_FRAME("zpp_nape.util.ZPP_Set_ZPP_PartitionPair","size",0xb1b4ea5d,"zpp_nape.util.ZPP_Set_ZPP_PartitionPair.size","zpp_nape/util/RBTree.hx",2067,0x3f078845)
	HX_STACK_THIS(this)
	HX_STACK_LINE(2068)
...
bool ZPP_Set_ZPP_PartitionPair_obj::has( ::zpp_nape::geom::ZPP_PartitionPair obj){
	HX_STACK_FRAME("zpp_nape.util.ZPP_Set_ZPP_PartitionPair","has",0x0fb01d3e,"zpp_nape.util.ZPP_Set_ZPP_PartitionPair.has","zpp_nape/util/RBTree.hx",2097,0x3f078845)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(2098)
	::zpp_nape::util::ZPP_Set_ZPP_PartitionPair _g = this->find(obj);		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(2098)
	return (_g != null());
}
...
::zpp_nape::util::ZPP_Set_ZPP_PartitionPair ZPP_Set_ZPP_PartitionPair_obj::find( ::zpp_nape::geom::ZPP_PartitionPair obj){
	HX_STACK_FRAME("zpp_nape.util.ZPP_Set_ZPP_PartitionPair","find",0xa91d19d5,"zpp_nape.util.ZPP_Set_ZPP_PartitionPair.find","zpp_nape/util/RBTree.hx",2100,0x3f078845)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(2101)
...
bool ZPP_Set_ZPP_PartitionPair_obj::has_weak( ::zpp_nape::geom::ZPP_PartitionPair obj){
	HX_STACK_FRAME("zpp_nape.util.ZPP_Set_ZPP_PartitionPair","has_weak",0x37ed9a59,"zpp_nape.util.ZPP_Set_ZPP_PartitionPair.has_weak","zpp_nape/util/RBTree.hx",2108,0x3f078845)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(2109)
	::zpp_nape::util::ZPP_Set_ZPP_PartitionPair _g = this->find_weak(obj);		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(2109)
	return (_g != null());
}
...
::zpp_nape::util::ZPP_Set_ZPP_PartitionPair ZPP_Set_ZPP_PartitionPair_obj::find_weak( ::zpp_nape::geom::ZPP_PartitionPair obj){
	HX_STACK_FRAME("zpp_nape.util.ZPP_Set_ZPP_PartitionPair","find_weak",0x45d29a62,"zpp_nape.util.ZPP_Set_ZPP_PartitionPair.find_weak","zpp_nape/util/RBTree.hx",2111,0x3f078845)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(2112)
	::zpp_nape::util::ZPP_Set_ZPP_PartitionPair cur = this->parent;		HX_STACK_VAR(cur,"cur");
...
::zpp_nape::geom::ZPP_PartitionPair ZPP_Set_ZPP_PartitionPair_obj::lower_bound( ::zpp_nape::geom::ZPP_PartitionPair obj){
	HX_STACK_FRAME("zpp_nape.util.ZPP_Set_ZPP_PartitionPair","lower_bound",0x4ab84a24,"zpp_nape.util.ZPP_Set_ZPP_PartitionPair.lower_bound","zpp_nape/util/RBTree.hx",2121,0x3f078845)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(2122)
...
::zpp_nape::geom::ZPP_PartitionPair ZPP_Set_ZPP_PartitionPair_obj::first( ){
	HX_STACK_FRAME("zpp_nape.util.ZPP_Set_ZPP_PartitionPair","first",0x505c9714,"zpp_nape.util.ZPP_Set_ZPP_PartitionPair.first","zpp_nape/util/RBTree.hx",2157,0x3f078845)
	HX_STACK_THIS(this)
	HX_STACK_LINE(2166)
	::zpp_nape::util::ZPP_Set_ZPP_PartitionPair cur = this->parent;		HX_STACK_VAR(cur,"cur");
	HX_STACK_LINE(2167)
...
::zpp_nape::geom::ZPP_PartitionPair ZPP_Set_ZPP_PartitionPair_obj::pop_front( ){
	HX_STACK_FRAME("zpp_nape.util.ZPP_Set_ZPP_PartitionPair","pop_front",0x3259211f,"zpp_nape.util.ZPP_Set_ZPP_PartitionPair.pop_front","zpp_nape/util/RBTree.hx",2170,0x3f078845)
	HX_STACK_THIS(this)
	HX_STACK_LINE(2179)
	::zpp_nape::util::ZPP_Set_ZPP_PartitionPair cur = this->parent;		HX_STACK_VAR(cur,"cur");
	HX_STACK_LINE(2180)
...
{
		HX_STACK_FRAME("zpp_nape.util.ZPP_Set_ZPP_PartitionPair","remove",0x7c0484e0,"zpp_nape.util.ZPP_Set_ZPP_PartitionPair.remove","zpp_nape/util/RBTree.hx",2185,0x3f078845)
		HX_STACK_THIS(this)
		HX_STACK_ARG(obj,"obj")
		HX_STACK_LINE(2186)
...
::zpp_nape::util::ZPP_Set_ZPP_PartitionPair ZPP_Set_ZPP_PartitionPair_obj::successor_node( ::zpp_nape::util::ZPP_Set_ZPP_PartitionPair cur){
	HX_STACK_FRAME("zpp_nape.util.ZPP_Set_ZPP_PartitionPair","successor_node",0xbeb61317,"zpp_nape.util.ZPP_Set_ZPP_PartitionPair.successor_node","zpp_nape/util/RBTree.hx",2197,0x3f078845)
	HX_STACK_THIS(this)
...
::zpp_nape::util::ZPP_Set_ZPP_PartitionPair ZPP_Set_ZPP_PartitionPair_obj::predecessor_node( ::zpp_nape::util::ZPP_Set_ZPP_PartitionPair cur){
	HX_STACK_FRAME("zpp_nape.util.ZPP_Set_ZPP_PartitionPair","predecessor_node",0x13488a14,"zpp_nape.util.ZPP_Set_ZPP_PartitionPair.predecessor_node","zpp_nape/util/RBTree.hx",2220,0x3f078845)
	HX_STACK_THIS(this)
	HX_STACK_ARG(cur,"cur")
	HX_STACK_LINE(2229)
	if (((cur->prev != null()))){
...
::zpp_nape::geom::ZPP_PartitionPair ZPP_Set_ZPP_PartitionPair_obj::successor( ::zpp_nape::geom::ZPP_PartitionPair obj){
	HX_STACK_FRAME("zpp_nape.util.ZPP_Set_ZPP_PartitionPair","successor",0xec781e8a,"zpp_nape.util.ZPP_Set_ZPP_PartitionPair.successor","zpp_nape/util/RBTree.hx",2243,0x3f078845)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(2252)
	::zpp_nape::util::ZPP_Set_ZPP_PartitionPair _g = this->find(obj);		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(2252)
	::zpp_nape::util::ZPP_Set_ZPP_PartitionPair node = this->successor_node(_g);		HX_STACK_VAR(node,"node");
	HX_STACK_LINE(2253)
	if (((node == null()))){
		HX_STACK_LINE(2253)
		return null();
...
::zpp_nape::geom::ZPP_PartitionPair ZPP_Set_ZPP_PartitionPair_obj::predecessor( ::zpp_nape::geom::ZPP_PartitionPair obj){
	HX_STACK_FRAME("zpp_nape.util.ZPP_Set_ZPP_PartitionPair","predecessor",0xba9308ad,"zpp_nape.util.ZPP_Set_ZPP_PartitionPair.predecessor","zpp_nape/util/RBTree.hx",2255,0x3f078845)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(2264)
	::zpp_nape::util::ZPP_Set_ZPP_PartitionPair _g = this->find(obj);		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(2264)
	::zpp_nape::util::ZPP_Set_ZPP_PartitionPair node = this->predecessor_node(_g);		HX_STACK_VAR(node,"node");
	HX_STACK_LINE(2265)
	if (((node == null()))){
		HX_STACK_LINE(2265)
		return null();
...
{
		HX_STACK_FRAME("zpp_nape.util.ZPP_Set_ZPP_PartitionPair","remove_node",0x1d28f501,"zpp_nape.util.ZPP_Set_ZPP_PartitionPair.remove_node","zpp_nape/util/RBTree.hx",2267,0x3f078845)
		HX_STACK_THIS(this)
		HX_STACK_ARG(cur,"cur")
		HX_STACK_LINE(2276)
		...
		HX_STACK_LINE(2295)
		::zpp_nape::util::ZPP_Set_ZPP_PartitionPair child;		HX_STACK_VAR(child,"child");
		HX_STACK_LINE(2295)
		if (((cur->prev == null()))){
			HX_STACK_LINE(2295)
			child = cur->next;
		...
		HX_STACK_LINE(2368)
		::zpp_nape::util::ZPP_Set_ZPP_PartitionPair _g = cur->next = null();		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(2368)
		::zpp_nape::util::ZPP_Set_ZPP_PartitionPair _g1 = cur->prev = _g;		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(2368)
		cur->parent = _g1;
		HX_STACK_LINE(2369)
		{
...
{
		HX_STACK_FRAME("zpp_nape.util.ZPP_Set_ZPP_PartitionPair","clear",0x981a9071,"zpp_nape.util.ZPP_Set_ZPP_PartitionPair.clear","zpp_nape/util/RBTree.hx",2388,0x3f078845)
		HX_STACK_THIS(this)
		HX_STACK_LINE(2388)
		if (((this->parent == null()))){
			HX_STACK_LINE(2388)
			...
			while((true)){
				...
				HX_STACK_LINE(2388)
				::zpp_nape::util::ZPP_Set_ZPP_PartitionPair _g;		HX_STACK_VAR(_g,"_g");
				HX_STACK_LINE(2388)
				if (((cur->prev != null()))){
					HX_STACK_LINE(2388)
					_g = cur->prev;
...
{
		HX_STACK_FRAME("zpp_nape.util.ZPP_Set_ZPP_PartitionPair","clear_with",0x5df8c7d4,"zpp_nape.util.ZPP_Set_ZPP_PartitionPair.clear_with","zpp_nape/util/RBTree.hx",2392,0x3f078845)
		HX_STACK_THIS(this)
...
::zpp_nape::util::ZPP_Set_ZPP_PartitionPair ZPP_Set_ZPP_PartitionPair_obj::clear_node( ::zpp_nape::util::ZPP_Set_ZPP_PartitionPair node,Dynamic lambda){
	HX_STACK_FRAME("zpp_nape.util.ZPP_Set_ZPP_PartitionPair","clear_node",0x580a5bd0,"zpp_nape.util.ZPP_Set_ZPP_PartitionPair.clear_node","zpp_nape/util/RBTree.hx",2400,0x3f078845)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("zpp_nape.util.ZPP_Set_ZPP_PartitionPair","__fix_neg_red",0x383eb2bc,"zpp_nape.util.ZPP_Set_ZPP_PartitionPair.__fix_neg_red","zpp_nape/util/RBTree.hx",2435,0x3f078845)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("zpp_nape.util.ZPP_Set_ZPP_PartitionPair","__fix_dbl_red",0x4656e09a,"zpp_nape.util.ZPP_Set_ZPP_PartitionPair.__fix_dbl_red","zpp_nape/util/RBTree.hx",2503,0x3f078845)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_LINE(2503)
		while((true)){
...
bool ZPP_Set_ZPP_PartitionPair_obj::try_insert_bool( ::zpp_nape::geom::ZPP_PartitionPair obj){
	HX_STACK_FRAME("zpp_nape.util.ZPP_Set_ZPP_PartitionPair","try_insert_bool",0x2514b5d0,"zpp_nape.util.ZPP_Set_ZPP_PartitionPair.try_insert_bool","zpp_nape/util/RBTree.hx",2591,0x3f078845)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(2592)
	...
	if (((this->parent == null()))){
		HX_STACK_LINE(2595)
		{
			...
			if (((::zpp_nape::util::ZPP_Set_ZPP_PartitionPair_obj::zpp_pool == null()))){
				HX_STACK_LINE(2597)
				::zpp_nape::util::ZPP_Set_ZPP_PartitionPair _g = ::zpp_nape::util::ZPP_Set_ZPP_PartitionPair_obj::__new();		HX_STACK_VAR(_g,"_g");
				HX_STACK_LINE(2597)
				x = _g;
			}
			else{
			...
			if ((this->lt(obj,cur->data))){
				...
				if (((cur->prev == null()))){
					HX_STACK_LINE(2620)
					{
						...
						if (((::zpp_nape::util::ZPP_Set_ZPP_PartitionPair_obj::zpp_pool == null()))){
							HX_STACK_LINE(2622)
							::zpp_nape::util::ZPP_Set_ZPP_PartitionPair _g1 = ::zpp_nape::util::ZPP_Set_ZPP_PartitionPair_obj::__new();		HX_STACK_VAR(_g1,"_g1");
							HX_STACK_LINE(2622)
							x = _g1;
						}
						else{
				...
				if ((this->lt(cur->data,obj))){
					...
					if (((cur->next == null()))){
						HX_STACK_LINE(2646)
						{
							...
							if (((::zpp_nape::util::ZPP_Set_ZPP_PartitionPair_obj::zpp_pool == null()))){
								HX_STACK_LINE(2648)
								::zpp_nape::util::ZPP_Set_ZPP_PartitionPair _g2 = ::zpp_nape::util::ZPP_Set_ZPP_PartitionPair_obj::__new();		HX_STACK_VAR(_g2,"_g2");
								HX_STACK_LINE(2648)
								x = _g2;
							}
							else{
...
::zpp_nape::util::ZPP_Set_ZPP_PartitionPair ZPP_Set_ZPP_PartitionPair_obj::try_insert( ::zpp_nape::geom::ZPP_PartitionPair obj){
	HX_STACK_FRAME("zpp_nape.util.ZPP_Set_ZPP_PartitionPair","try_insert",0x407dbf99,"zpp_nape.util.ZPP_Set_ZPP_PartitionPair.try_insert","zpp_nape/util/RBTree.hx",2683,0x3f078845)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(2684)
	::zpp_nape::util::ZPP_Set_ZPP_PartitionPair x = null();		HX_STACK_VAR(x,"x");
...
::zpp_nape::util::ZPP_Set_ZPP_PartitionPair ZPP_Set_ZPP_PartitionPair_obj::insert( ::zpp_nape::geom::ZPP_PartitionPair obj){
	HX_STACK_FRAME("zpp_nape.util.ZPP_Set_ZPP_PartitionPair","insert",0x15592bd5,"zpp_nape.util.ZPP_Set_ZPP_PartitionPair.insert","zpp_nape/util/RBTree.hx",2775,0x3f078845)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(2784)
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(ZPP_Set_ZPP_PartitionPair_obj,lt),HX_CSTRING("lt")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(ZPP_Set_ZPP_PartitionPair_obj,swapped),HX_CSTRING("swapped")},
	{hx::fsObject /*::zpp_nape::geom::ZPP_PartitionPair*/ ,(int)offsetof(ZPP_Set_ZPP_PartitionPair_obj,data),HX_CSTRING("data")},
	{hx::fsObject /*::zpp_nape::util::ZPP_Set_ZPP_PartitionPair*/ ,(int)offsetof(ZPP_Set_ZPP_PartitionPair_obj,prev),HX_CSTRING("prev")},
	{hx::fsObject /*::zpp_nape::util::ZPP_Set_ZPP_PartitionPair*/ ,(int)offsetof(ZPP_Set_ZPP_PartitionPair_obj,next),HX_CSTRING("next")},
	{hx::fsObject /*::zpp_nape::util::ZPP_Set_ZPP_PartitionPair*/ ,(int)offsetof(ZPP_Set_ZPP_PartitionPair_obj,parent),HX_CSTRING("parent")},
	{hx::fsInt,(int)offsetof(ZPP_Set_ZPP_PartitionPair_obj,colour),HX_CSTRING("colour")},
	{ hx::fsUnknown, 0, null()}
};
#endif
