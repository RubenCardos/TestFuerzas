...
bool ZPP_Set_ZPP_SimpleSeg_obj::empty( ){
	HX_STACK_FRAME("zpp_nape.util.ZPP_Set_ZPP_SimpleSeg","empty",0x15ee4f10,"zpp_nape.util.ZPP_Set_ZPP_SimpleSeg.empty","zpp_nape/util/RBTree.hx",4729,0x3f078845)
	HX_STACK_THIS(this)
	HX_STACK_LINE(4729)
...
bool ZPP_Set_ZPP_SimpleSeg_obj::singular( ){
	HX_STACK_FRAME("zpp_nape.util.ZPP_Set_ZPP_SimpleSeg","singular",0x446e0834,"zpp_nape.util.ZPP_Set_ZPP_SimpleSeg.singular","zpp_nape/util/RBTree.hx",4732,0x3f078845)
	HX_STACK_THIS(this)
	HX_STACK_LINE(4732)
...
bool ZPP_Set_ZPP_SimpleSeg_obj::has( ::zpp_nape::geom::ZPP_SimpleSeg obj){
	...
	HX_STACK_LINE(4765)
	::zpp_nape::util::ZPP_Set_ZPP_SimpleSeg _g = this->find(obj);		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(4765)
	return (_g != null());
}
...
bool ZPP_Set_ZPP_SimpleSeg_obj::has_weak( ::zpp_nape::geom::ZPP_SimpleSeg obj){
	...
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(4776)
	::zpp_nape::util::ZPP_Set_ZPP_SimpleSeg _g = this->find_weak(obj);		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(4776)
	return (_g != null());
}
...
::zpp_nape::geom::ZPP_SimpleSeg ZPP_Set_ZPP_SimpleSeg_obj::lower_bound( ::zpp_nape::geom::ZPP_SimpleSeg obj){
	HX_STACK_FRAME("zpp_nape.util.ZPP_Set_ZPP_SimpleSeg","lower_bound",0xf687c103,"zpp_nape.util.ZPP_Set_ZPP_SimpleSeg.lower_bound","zpp_nape/util/RBTree.hx",4788,0x3f078845)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(4789)
...
::zpp_nape::geom::ZPP_SimpleSeg ZPP_Set_ZPP_SimpleSeg_obj::successor( ::zpp_nape::geom::ZPP_SimpleSeg obj){
	...
	::zpp_nape::util::ZPP_Set_ZPP_SimpleSeg _g = this->find(obj);		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(4919)
	::zpp_nape::util::ZPP_Set_ZPP_SimpleSeg node = this->successor_node(_g);		HX_STACK_VAR(node,"node");
	HX_STACK_LINE(4920)
	if (((node == null()))){
		HX_STACK_LINE(4920)
		return null();
...
::zpp_nape::geom::ZPP_SimpleSeg ZPP_Set_ZPP_SimpleSeg_obj::predecessor( ::zpp_nape::geom::ZPP_SimpleSeg obj){
	...
	::zpp_nape::util::ZPP_Set_ZPP_SimpleSeg _g = this->find(obj);		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(4931)
	::zpp_nape::util::ZPP_Set_ZPP_SimpleSeg node = this->predecessor_node(_g);		HX_STACK_VAR(node,"node");
	HX_STACK_LINE(4932)
	if (((node == null()))){
		HX_STACK_LINE(4932)
		return null();
...
Void ZPP_Set_ZPP_SimpleSeg_obj::remove_node( ::zpp_nape::util::ZPP_Set_ZPP_SimpleSeg cur){
{
		...
		HX_STACK_LINE(4962)
		::zpp_nape::util::ZPP_Set_ZPP_SimpleSeg child;		HX_STACK_VAR(child,"child");
		HX_STACK_LINE(4962)
		if (((cur->prev == null()))){
			HX_STACK_LINE(4962)
			child = cur->next;
		...
		HX_STACK_LINE(5035)
		::zpp_nape::util::ZPP_Set_ZPP_SimpleSeg _g = cur->next = null();		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(5035)
		::zpp_nape::util::ZPP_Set_ZPP_SimpleSeg _g1 = cur->prev = _g;		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(5035)
		cur->parent = _g1;
		HX_STACK_LINE(5036)
		{
...
Void ZPP_Set_ZPP_SimpleSeg_obj::clear( ){
{
		...
		if (((this->parent == null()))){
			...
			while((true)){
				...
				HX_STACK_LINE(5055)
				::zpp_nape::util::ZPP_Set_ZPP_SimpleSeg _g;		HX_STACK_VAR(_g,"_g");
				HX_STACK_LINE(5055)
				if (((cur->prev != null()))){
					HX_STACK_LINE(5055)
					_g = cur->prev;
...
{
		HX_STACK_FRAME("zpp_nape.util.ZPP_Set_ZPP_SimpleSeg","clear_with",0x994a11d5,"zpp_nape.util.ZPP_Set_ZPP_SimpleSeg.clear_with","zpp_nape/util/RBTree.hx",5059,0x3f078845)
		HX_STACK_THIS(this)
			...
			if ((this->lt(obj,cur->data))){
				...
				if (((cur->prev == null()))){
					HX_STACK_LINE(5287)
					{
						...
						if (((::zpp_nape::util::ZPP_Set_ZPP_SimpleSeg_obj::zpp_pool == null()))){
							HX_STACK_LINE(5289)
							::zpp_nape::util::ZPP_Set_ZPP_SimpleSeg _g1 = ::zpp_nape::util::ZPP_Set_ZPP_SimpleSeg_obj::__new();		HX_STACK_VAR(_g1,"_g1");
							HX_STACK_LINE(5289)
							x = _g1;
						}
						else{
				...
				if ((this->lt(cur->data,obj))){
					...
					if (((cur->next == null()))){
						HX_STACK_LINE(5313)
						{
							...
							if (((::zpp_nape::util::ZPP_Set_ZPP_SimpleSeg_obj::zpp_pool == null()))){
								HX_STACK_LINE(5315)
								::zpp_nape::util::ZPP_Set_ZPP_SimpleSeg _g2 = ::zpp_nape::util::ZPP_Set_ZPP_SimpleSeg_obj::__new();		HX_STACK_VAR(_g2,"_g2");
								HX_STACK_LINE(5315)
								x = _g2;
							}
							else{
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(ZPP_Set_ZPP_SimpleSeg_obj,lt),HX_CSTRING("lt")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(ZPP_Set_ZPP_SimpleSeg_obj,swapped),HX_CSTRING("swapped")},
	{hx::fsObject /*::zpp_nape::geom::ZPP_SimpleSeg*/ ,(int)offsetof(ZPP_Set_ZPP_SimpleSeg_obj,data),HX_CSTRING("data")},
	{hx::fsObject /*::zpp_nape::util::ZPP_Set_ZPP_SimpleSeg*/ ,(int)offsetof(ZPP_Set_ZPP_SimpleSeg_obj,prev),HX_CSTRING("prev")},
	{hx::fsObject /*::zpp_nape::util::ZPP_Set_ZPP_SimpleSeg*/ ,(int)offsetof(ZPP_Set_ZPP_SimpleSeg_obj,next),HX_CSTRING("next")},
	{hx::fsObject /*::zpp_nape::util::ZPP_Set_ZPP_SimpleSeg*/ ,(int)offsetof(ZPP_Set_ZPP_SimpleSeg_obj,parent),HX_CSTRING("parent")},
	{hx::fsInt,(int)offsetof(ZPP_Set_ZPP_SimpleSeg_obj,colour),HX_CSTRING("colour")},
	{ hx::fsUnknown, 0, null()}
};
#endif
