...
bool ZPP_Set_ZPP_SimpleVert_obj::empty( ){
	HX_STACK_FRAME("zpp_nape.util.ZPP_Set_ZPP_SimpleVert","empty",0x94ab7974,"zpp_nape.util.ZPP_Set_ZPP_SimpleVert.empty","zpp_nape/util/RBTree.hx",3840,0x3f078845)
	HX_STACK_THIS(this)
	HX_STACK_LINE(3840)
...
bool ZPP_Set_ZPP_SimpleVert_obj::singular( ){
	HX_STACK_FRAME("zpp_nape.util.ZPP_Set_ZPP_SimpleVert","singular",0xdee07450,"zpp_nape.util.ZPP_Set_ZPP_SimpleVert.singular","zpp_nape/util/RBTree.hx",3843,0x3f078845)
	HX_STACK_THIS(this)
	HX_STACK_LINE(3843)
...
bool ZPP_Set_ZPP_SimpleVert_obj::has( ::zpp_nape::geom::ZPP_SimpleVert obj){
	...
	HX_STACK_LINE(3876)
	::zpp_nape::util::ZPP_Set_ZPP_SimpleVert _g = this->find(obj);		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(3876)
	return (_g != null());
}
...
bool ZPP_Set_ZPP_SimpleVert_obj::has_weak( ::zpp_nape::geom::ZPP_SimpleVert obj){
	...
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(3887)
	::zpp_nape::util::ZPP_Set_ZPP_SimpleVert _g = this->find_weak(obj);		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(3887)
	return (_g != null());
}
...
::zpp_nape::geom::ZPP_SimpleVert ZPP_Set_ZPP_SimpleVert_obj::lower_bound( ::zpp_nape::geom::ZPP_SimpleVert obj){
	HX_STACK_FRAME("zpp_nape.util.ZPP_Set_ZPP_SimpleVert","lower_bound",0x64e2ce67,"zpp_nape.util.ZPP_Set_ZPP_SimpleVert.lower_bound","zpp_nape/util/RBTree.hx",3899,0x3f078845)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(3900)
...
::zpp_nape::geom::ZPP_SimpleVert ZPP_Set_ZPP_SimpleVert_obj::successor( ::zpp_nape::geom::ZPP_SimpleVert obj){
	...
	::zpp_nape::util::ZPP_Set_ZPP_SimpleVert _g = this->find(obj);		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(4030)
	::zpp_nape::util::ZPP_Set_ZPP_SimpleVert node = this->successor_node(_g);		HX_STACK_VAR(node,"node");
	HX_STACK_LINE(4031)
	if (((node == null()))){
		HX_STACK_LINE(4031)
		return null();
...
::zpp_nape::geom::ZPP_SimpleVert ZPP_Set_ZPP_SimpleVert_obj::predecessor( ::zpp_nape::geom::ZPP_SimpleVert obj){
	...
	::zpp_nape::util::ZPP_Set_ZPP_SimpleVert _g = this->find(obj);		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(4042)
	::zpp_nape::util::ZPP_Set_ZPP_SimpleVert node = this->predecessor_node(_g);		HX_STACK_VAR(node,"node");
	HX_STACK_LINE(4043)
	if (((node == null()))){
		HX_STACK_LINE(4043)
		return null();
...
Void ZPP_Set_ZPP_SimpleVert_obj::remove_node( ::zpp_nape::util::ZPP_Set_ZPP_SimpleVert cur){
{
		...
		HX_STACK_LINE(4073)
		::zpp_nape::util::ZPP_Set_ZPP_SimpleVert child;		HX_STACK_VAR(child,"child");
		HX_STACK_LINE(4073)
		if (((cur->prev == null()))){
			HX_STACK_LINE(4073)
			child = cur->next;
		...
		HX_STACK_LINE(4146)
		::zpp_nape::util::ZPP_Set_ZPP_SimpleVert _g = cur->next = null();		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(4146)
		::zpp_nape::util::ZPP_Set_ZPP_SimpleVert _g1 = cur->prev = _g;		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(4146)
		cur->parent = _g1;
		HX_STACK_LINE(4147)
		{
...
Void ZPP_Set_ZPP_SimpleVert_obj::clear( ){
{
		...
		if (((this->parent == null()))){
			...
			while((true)){
				...
				HX_STACK_LINE(4166)
				::zpp_nape::util::ZPP_Set_ZPP_SimpleVert _g;		HX_STACK_VAR(_g,"_g");
				HX_STACK_LINE(4166)
				if (((cur->prev != null()))){
					HX_STACK_LINE(4166)
					_g = cur->prev;
...
{
		HX_STACK_FRAME("zpp_nape.util.ZPP_Set_ZPP_SimpleVert","clear_with",0x8644bcf1,"zpp_nape.util.ZPP_Set_ZPP_SimpleVert.clear_with","zpp_nape/util/RBTree.hx",4170,0x3f078845)
		HX_STACK_THIS(this)
	...
	if (((this->parent == null()))){
		HX_STACK_LINE(4373)
		{
			...
			if (((::zpp_nape::util::ZPP_Set_ZPP_SimpleVert_obj::zpp_pool == null()))){
				HX_STACK_LINE(4375)
				::zpp_nape::util::ZPP_Set_ZPP_SimpleVert _g = ::zpp_nape::util::ZPP_Set_ZPP_SimpleVert_obj::__new();		HX_STACK_VAR(_g,"_g");
				HX_STACK_LINE(4375)
				x = _g;
			}
			else{
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(ZPP_Set_ZPP_SimpleVert_obj,lt),HX_CSTRING("lt")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(ZPP_Set_ZPP_SimpleVert_obj,swapped),HX_CSTRING("swapped")},
	{hx::fsObject /*::zpp_nape::geom::ZPP_SimpleVert*/ ,(int)offsetof(ZPP_Set_ZPP_SimpleVert_obj,data),HX_CSTRING("data")},
	{hx::fsObject /*::zpp_nape::util::ZPP_Set_ZPP_SimpleVert*/ ,(int)offsetof(ZPP_Set_ZPP_SimpleVert_obj,prev),HX_CSTRING("prev")},
	{hx::fsObject /*::zpp_nape::util::ZPP_Set_ZPP_SimpleVert*/ ,(int)offsetof(ZPP_Set_ZPP_SimpleVert_obj,next),HX_CSTRING("next")},
	{hx::fsObject /*::zpp_nape::util::ZPP_Set_ZPP_SimpleVert*/ ,(int)offsetof(ZPP_Set_ZPP_SimpleVert_obj,parent),HX_CSTRING("parent")},
	{hx::fsInt,(int)offsetof(ZPP_Set_ZPP_SimpleVert_obj,colour),HX_CSTRING("colour")},
	{ hx::fsUnknown, 0, null()}
};
#endif
