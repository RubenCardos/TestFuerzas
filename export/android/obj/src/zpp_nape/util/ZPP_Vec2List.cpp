...
HX_STACK_THIS(this)
{
	...
	this->outer = null();
	HX_STACK_LINE(16924)
	::zpp_nape::util::ZNPList_ZPP_Vec2 _g = ::zpp_nape::util::ZNPList_ZPP_Vec2_obj::__new();		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(16924)
	this->inner = _g;
	HX_STACK_LINE(16925)
...
{
		HX_STACK_FRAME("zpp_nape.util.ZPP_Vec2List","validate",0xf0123e38,"zpp_nape.util.ZPP_Vec2List.validate","zpp_nape/util/Lists.hx",16909,0x9f4e6754)
		HX_STACK_THIS(this)
		HX_STACK_LINE(16909)
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::nape::geom::Vec2List*/ ,(int)offsetof(ZPP_Vec2List_obj,outer),HX_CSTRING("outer")},
	{hx::fsObject /*::zpp_nape::util::ZNPList_ZPP_Vec2*/ ,(int)offsetof(ZPP_Vec2List_obj,inner),HX_CSTRING("inner")},
	{hx::fsBool,(int)offsetof(ZPP_Vec2List_obj,immutable),HX_CSTRING("immutable")},
	{hx::fsBool,(int)offsetof(ZPP_Vec2List_obj,_invalidated),HX_CSTRING("_invalidated")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(ZPP_Vec2List_obj,_invalidate),HX_CSTRING("_invalidate")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(ZPP_Vec2List_obj,_validate),HX_CSTRING("_validate")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(ZPP_Vec2List_obj,_modifiable),HX_CSTRING("_modifiable")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(ZPP_Vec2List_obj,adder),HX_CSTRING("adder")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(ZPP_Vec2List_obj,post_adder),HX_CSTRING("post_adder")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(ZPP_Vec2List_obj,subber),HX_CSTRING("subber")},
	{hx::fsBool,(int)offsetof(ZPP_Vec2List_obj,dontremove),HX_CSTRING("dontremove")},
	{hx::fsBool,(int)offsetof(ZPP_Vec2List_obj,reverse_flag),HX_CSTRING("reverse_flag")},
	{hx::fsInt,(int)offsetof(ZPP_Vec2List_obj,at_index),HX_CSTRING("at_index")},
	{hx::fsObject /*::zpp_nape::util::ZNPNode_ZPP_Vec2*/ ,(int)offsetof(ZPP_Vec2List_obj,at_ite),HX_CSTRING("at_ite")},
	{hx::fsObject /*::zpp_nape::util::ZNPNode_ZPP_Vec2*/ ,(int)offsetof(ZPP_Vec2List_obj,push_ite),HX_CSTRING("push_ite")},
	{hx::fsBool,(int)offsetof(ZPP_Vec2List_obj,zip_length),HX_CSTRING("zip_length")},
	{hx::fsInt,(int)offsetof(ZPP_Vec2List_obj,user_length),HX_CSTRING("user_length")},
	{ hx::fsUnknown, 0, null()}
};
#endif
